...
if TYPE_CHECKING:
    from dalaran_draft.catalog import DatasetEntry


def test_index_ranges(complex_dataset: DatasetEntry) -> None:
    df = complex_dataset.get_index_ranges().sort("dalaran_segment_id")
    df_schema = df.schema()
...
├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
│ ┌─────────────────────┬───────────────────────┬───────────────────────┐ │
│ │ dalaran_segment_id    ┆ timeline:start        ┆ timeline:end          │ │
│ │ ---                 ┆ ---                   ┆ ---                   │ │
...
def test_index_ranges_dataset_view(complex_dataset: DatasetEntry) -> None:
    ...
    df = view.get_index_ranges().sort("dalaran_segment_id")
    df_schema = df.schema()
    for batch in df.collect():
        assert batch.schema.equals(df_schema, check_metadata=True)
