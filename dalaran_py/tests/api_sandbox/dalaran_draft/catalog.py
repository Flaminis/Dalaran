...
from dalaran import catalog as _catalog
...
if TYPE_CHECKING:
    ...
    from dalaran.catalog import RegistrationHandle

    from dalaran_bindings import IndexValuesLike  # noqa: TID251
...
class DatasetEntry(Entry):
    ...
    def segment_table(
        self, join_meta: TableEntry | datafusion.DataFrame | None = None, join_key: str = "dalaran_segment_id"
    ...
    def reader(
        ...
        *,
        ...
        using_index_values : dict[str, IndexValuesLike] | datafusion.DataFrame | None
            ...
            If a DataFrame is provided, it must have 'dalaran_segment_id' and index columns.
        fill_latest_at : bool
    ...
    def filter_segments(self, segment_ids: datafusion.DataFrame | Sequence[str]) -> DatasetView:
        ...
        Takes either a DataFusion DataFrame with a column named 'dalaran_segment_id'
