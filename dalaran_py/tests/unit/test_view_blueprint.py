...
from dalaran.blueprint.archetypes.view_blueprint import ViewBlueprint
from dalaran.blueprint.components.view_class import ViewClass, ViewClassBatch
from dalaran.blueprint.components.view_origin import ViewOrigin, ViewOriginBatch
...
if TYPE_CHECKING:
    ...
    from dalaran.datatypes.entity_path import EntityPathLike
