"""Tests for the query-shaping helpers `_build_query_indices` and `_read_groups` in `dalaran.experimental.dataloader._utils`."""
...
import pytest
from dalaran.experimental.dataloader import Field
from dalaran.experimental.dataloader._decoders import ImageDecoder, NumericDecoder, VideoFrameDecoder
from dalaran.experimental.dataloader._sample_index import SampleIndex, SegmentMetadata
from dalaran.experimental.dataloader._utils import Target, _build_query_indices, _read_groups
