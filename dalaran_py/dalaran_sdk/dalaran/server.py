...
from dalaran_bindings import _ServerInternal
...
class Server:
    """
    A Dalaran server instance.

    This class allows you to start and manage a Dalaran server programmatically.
    ...
    def __init__(
        ...
        *,
        ...
        """
        Create a new Dalaran server instance and start it.
        ...
        if host == "0.0.0.0" and addr != "0.0.0.0":  # noqa: S104
            ...
            _send_warning_or_raise(
                "The `addr` parameter is deprecated in Dalaran 0.29, and has been renamed to `host`.",
