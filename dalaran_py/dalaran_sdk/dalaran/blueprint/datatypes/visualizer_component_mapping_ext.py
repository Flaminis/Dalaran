...
class VisualizerComponentMappingExt:
    """Extension for [VisualizerComponentMapping][dalaran.blueprint.datatypes.VisualizerComponentMapping]."""

    @staticmethod
    def native_to_pa_array_override(data: VisualizerComponentMappingArrayLike, data_type: pa.DataType) -> pa.Array:
        from dalaran.blueprint.datatypes import ComponentSourceKindBatch
        from dalaran.datatypes import Utf8Batch
