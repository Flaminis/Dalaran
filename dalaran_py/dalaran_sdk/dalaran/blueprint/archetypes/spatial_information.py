...
class SpatialInformation(Archetype):
    ...
    **Archetype**: Configures spatial view properties.
    ...
    NAME: ClassVar[str] = "dalaran.blueprint.archetypes.SpatialInformation"
    ...
    def __init__(
        ...
        *,
        ...
        axes:
            ...
            When this property is unset, a 3D view first uses [`archetypes.ViewCoordinates`][dalaran.archetypes.ViewCoordinates] logged at its origin entity or the closest ancestor.
            If none is found, it uses the camera orientation from the closest ancestor [`archetypes.Pinhole`][dalaran.archetypes.Pinhole].
