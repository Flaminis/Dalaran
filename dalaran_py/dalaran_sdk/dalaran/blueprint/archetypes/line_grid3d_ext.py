...
class LineGrid3DExt:
    """Extension for [LineGrid3D][dalaran.blueprint.archetypes.LineGrid3D]."""
    ...
    def __init__(
        ...
        *,
        ...
        plane:
            ...
            Defaults to whatever plane is determined as the plane at zero units up/down as defined by [`components.ViewCoordinates`][dalaran.components.ViewCoordinates] if present.
        stroke_width:
