...
class TableBlueprint(Archetype):
    ...
    **Archetype**: Blueprint for configuring the styling of a table.
    ...
    NAME: ClassVar[str] = "dalaran.blueprint.archetypes.TableBlueprint"
    ...
    def __init__(
        ...
        *,
        ...
        segment_preview_column:
            ...
            meaning that the regular structure of [`archetypes.ViewportBlueprint`][dalaran.blueprint.archetypes.ViewportBlueprint], and [`archetypes.ViewBlueprint`][dalaran.blueprint.archetypes.ViewBlueprint] structure applies.
