...
class Eye3DKind(Enum):
    """
    **Component**: The kind of the 3D eye to view a scene in a [`views.Spatial3DView`][dalaran.blueprint.views.Spatial3DView].
...
class Eye3DKindBatch(BaseBatch[Eye3DKindArrayLike], ComponentBatchMixin):
    ...
    _COMPONENT_TYPE: str = "dalaran.blueprint.components.Eye3DKind"
