...
class View:
    ...
    - [dalaran.blueprint.BarChartView][]
    - [dalaran.blueprint.Spatial2DView][]
    - [dalaran.blueprint.Spatial3DView][]
    - [dalaran.blueprint.TensorView][]
    - [dalaran.blueprint.TextDocumentView][]
    - [dalaran.blueprint.TextLogView][]
    - [dalaran.blueprint.TimeSeriesView][]

    These are ergonomic helpers on top of [dalaran.blueprint.archetypes.ViewBlueprint][].
    """
    ...
    def __init__(
        ...
        *,
        ...
        contents
            ...
            or a list of multiple expressions. See [dalaran.blueprint.archetypes.ViewContents][].
        visible:
...
class Container:
    ...
    - [dalaran.blueprint.Horizontal][]
    - [dalaran.blueprint.Vertical][]
    - [dalaran.blueprint.Grid][]
    - [dalaran.blueprint.Tabs][]

    These are ergonomic helpers on top of [dalaran.blueprint.archetypes.ContainerBlueprint][].
    """
...
class Panel:
    ...
    - [TopPanel][dalaran.blueprint.TopPanel]
    - [BlueprintPanel][dalaran.blueprint.BlueprintPanel]
    - [SelectionPanel][dalaran.blueprint.SelectionPanel]
    - [TimePanel][dalaran.blueprint.TimePanel]

    These are ergonomic helpers on top of [dalaran.blueprint.archetypes.PanelBlueprint][].
    """
...
class Blueprint:
    ...
    def __init__(
        ...
        *parts: BlueprintPart,
        ...
        Each [BlueprintPart][dalaran.blueprint.BlueprintPart] can be one of the following:

        - [ContainerLike][dalaran.blueprint.ContainerLike]
        - [BlueprintPanel][dalaran.blueprint.BlueprintPanel]
        - [SelectionPanel][dalaran.blueprint.SelectionPanel]
        - [TimePanel][dalaran.blueprint.TimePanel]
    ...
    def connect_grpc(
        ...
        *,
        ...
        """
        Connect to a remote Dalaran Viewer on the given URL and send this blueprint.
    ...
    def spawn(
        ...
        *,
        ...
        """
        Spawn a Dalaran viewer with this blueprint.
        ...
        self.connect_grpc(application_id=application_id, url=f"dalaran+http://127.0.0.1:{port}/proxy")
...
def create_in_memory_blueprint(*, application_id: str, blueprint: BlueprintLike) -> MemoryRecording:
    """Internal dalaran helper to convert a `BlueprintLike` into a stream that can be sent to the viewer."""
