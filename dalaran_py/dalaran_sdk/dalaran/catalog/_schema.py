...
if TYPE_CHECKING:
    ...
    from dalaran._baseclasses import Archetype
...
class Schema:
    ...
    def index_columns(self) -> Sequence[IndexColumnDescriptor]:
        ...
        They generally correspond to Dalaran timelines.
        """
    ...
    def columns_for(
        ...
        *,
        ...
        archetype:
            ...
            archetype name (e.g., `"dalaran.archetypes.Points3D"`), a short name
            (e.g., `"Points3D"`), or an Archetype class (e.g., `dl.Points3D`).
        component_type:
