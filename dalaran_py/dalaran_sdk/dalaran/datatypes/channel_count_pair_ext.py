...
if TYPE_CHECKING:
    from dalaran.datatypes.uint16 import UInt16
    from dalaran.datatypes.uint64 import UInt64
...
class ChannelCountPairExt:
    """Extension for [ChannelCountPair][dalaran.datatypes.ChannelCountPair]."""
