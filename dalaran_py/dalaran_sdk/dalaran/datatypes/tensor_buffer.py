...
class TensorBuffer(TensorBufferExt):
    """
    **Datatype**: The underlying storage for [`archetypes.Tensor`][dalaran.archetypes.Tensor].
...
class TensorBufferBatch(BaseBatch[TensorBufferArrayLike]):
    ...
    def _native_to_pa_array(data: TensorBufferArrayLike, data_type: pa.DataType) -> pa.Array:
        raise NotImplementedError(
            "Arrow serialization of TensorBuffer not implemented: We lack codegen for arrow-serialization of unions containing lists. Can't handle type dalaran.datatypes.TensorBuffer#U8"
