...
class ColorModel(ColorModelExt, Enum):
    """
    **Datatype**: Specified what color components are present in an [`archetypes.Image`][dalaran.archetypes.Image].

    This combined with [`datatypes.ChannelDatatype`][dalaran.datatypes.ChannelDatatype] determines the pixel format of an image.
    """
