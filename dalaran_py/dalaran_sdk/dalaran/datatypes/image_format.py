...
class ImageFormat(ImageFormatExt):
    """**Datatype**: The metadata describing the contents of a [`components.ImageBuffer`][dalaran.components.ImageBuffer]."""
    ...
    def __init__(
        ...
        *,
        ...
        pixel_format:
            ...
            If specified, this takes precedence over both [`datatypes.ColorModel`][dalaran.datatypes.ColorModel] and [`datatypes.ChannelDatatype`][dalaran.datatypes.ChannelDatatype] (which are ignored).
        color_model:
            L, RGB, RGBA, …

            Also requires a [`datatypes.ChannelDatatype`][dalaran.datatypes.ChannelDatatype] to fully specify the pixel format.
        channel_datatype:
            The data type of each channel (e.g. the red channel) of the image data (U8, F16, …).

            Also requires a [`datatypes.ColorModel`][dalaran.datatypes.ColorModel] to fully specify the pixel format.
...
class ImageFormatBatch(BaseBatch[ImageFormatArrayLike]):
    ...
    def _native_to_pa_array(data: ImageFormatArrayLike, data_type: pa.DataType) -> pa.Array:
        from dalaran.datatypes import ChannelDatatypeBatch, ColorModelBatch, PixelFormatBatch
