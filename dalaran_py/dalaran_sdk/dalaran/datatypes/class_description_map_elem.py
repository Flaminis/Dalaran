...
class ClassDescriptionMapElem(ClassDescriptionMapElemExt):
    """
    **Datatype**: A helper type for mapping [`datatypes.ClassId`][dalaran.datatypes.ClassId]s to class descriptions.

    This is internal to [`components.AnnotationContext`][dalaran.components.AnnotationContext].
    ...
    def __init__(self: Any, class_id: datatypes.ClassIdLike, class_description: datatypes.ClassDescriptionLike) -> None:
        ...
        ----------
        class_id:
            The key: the [`components.ClassId`][dalaran.components.ClassId].
        class_description:
