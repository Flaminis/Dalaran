...
from dalaran._validators import flat_np_uint64_array_from_array_like
...
class TorchTensorLike(Protocol):
    """Describes what is need from a Torch Tensor to be loggable to Dalaran."""
...
if TYPE_CHECKING:
    ...
    """Type helper for a tensor-like object that can be logged to Dalaran."""
else:
    TensorLike = Any
...
class TensorDataExt:
    """Extension for [TensorData][dalaran.datatypes.TensorData]."""
