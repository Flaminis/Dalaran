...
from dalaran_bindings import ComponentDescriptor
...
class DescribedComponentBatch:
    ...
    def as_arrow_array(self) -> pa.Array:
        ...
        Part of the [`dalaran.ComponentBatchLike`][] logging interface.
        """
...
class ComponentBatchLike(Protocol):
    """Describes interface for objects that can be converted to batch of dalaran Components."""
...
class Archetype(AsComponents):
    ...
    def archetype(cls) -> str:
        # Make sure to not include a leading "dalaran_sdk.",
        # to support both `import dalaran_sdk.dalaran` and `import dalaran`.
        module = cls.__module__.removeprefix("dalaran_sdk.")
...
class BaseBatch(Generic[T]):
    ...
    def __init__(self, data: T | None, strict: bool | None = None) -> None:
        ...
        strict:
            ...
            defaults to the value of the `dalaran.strict` global setting.
...
class ComponentColumn:
    ...
    to use with the [`send_columns`][dalaran.send_columns] API.
    """
...
class ComponentColumnList(Iterable[ComponentColumn]):
    """
    A collection of [`ComponentColumn`][dalaran.ComponentColumn]s.
