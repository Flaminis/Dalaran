...
def log(
    ...
    *extra: AsComponents | Iterable[DescribedComponentBatch],
    ...
    that implements the [`dalaran.AsComponents`][] interface, or a collection of `ComponentBatchLike`
    objects.
    ...
    *extra:
    ...
    static:
        ...
        Additional timelines set by [`dalaran.set_time`][] will also be included.
    ...
    if hasattr(entity, "as_component_batches"):
        ...
        raise TypeError(
            f"Expected an object implementing dalaran.AsComponents or an iterable of dalaran.DescribedComponentBatch, "
...
def _log_components(
    ...
    *,
    ...
    recording:
        ...
        also: [`dalaran.init`][], [`dalaran.set_global_data_recording`][].
