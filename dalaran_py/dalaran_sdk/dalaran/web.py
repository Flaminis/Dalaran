...
def _packaged_assets_archive_path() -> str | None:
    ...
    They instead ship the assets as `dalaran_sdk/web_viewer.zip`,
...
def serve_web_viewer(*, web_port: int | None = None, open_browser: bool = True, connect_to: str | None = None) -> None:
    ...
    You can pass this function the URL returned from [`dalaran.serve_grpc`][] and  [`dalaran.RecordingStream.serve_grpc`][]
