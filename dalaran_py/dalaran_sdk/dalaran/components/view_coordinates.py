...
class ViewCoordinates(ViewCoordinatesExt, datatypes.ViewCoordinates, ComponentMixin):
    ...
    **Component**: An orientation convention for a camera or 3D view.
    ...
    On [`archetypes.Pinhole`][dalaran.archetypes.Pinhole], this component controls the camera orientation and projection direction.
    ...
    A logged [`archetypes.ViewCoordinates`][dalaran.archetypes.ViewCoordinates] provides the default for [SpatialInformation](https://dalaran.dev/docs/reference/types/views/spatial3d_view).
...
class ViewCoordinatesBatch(datatypes.ViewCoordinatesBatch, ComponentBatchMixin):
    _COMPONENT_TYPE: str = "dalaran.components.ViewCoordinates"
