...
class TransformRelation(Enum):
    ...
    E.g. a translation of (0, 1, 0) with this [`components.TransformRelation`][dalaran.components.TransformRelation] logged at `parent/child` means
...
class TransformRelationBatch(BaseBatch[TransformRelationArrayLike], ComponentBatchMixin):
    ...
    _COMPONENT_TYPE: str = "dalaran.components.TransformRelation"
