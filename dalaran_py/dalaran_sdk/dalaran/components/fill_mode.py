...
class FillMode(Enum):
    ...
    * An [`archetypes.Ellipsoids3D`][dalaran.archetypes.Ellipsoids3D] will draw three axis-aligned ellipses that are cross-sections
      of each ellipsoid, each of which displays two out of three of the sizes of the ellipsoid.
    * For [`archetypes.Boxes3D`][dalaran.archetypes.Boxes3D], it is the edges of the box, identical to [`components.FillMode.DenseWireframe`][dalaran.components.FillMode.DenseWireframe].
    """
    ...
    * An [`archetypes.Ellipsoids3D`][dalaran.archetypes.Ellipsoids3D] will draw a wireframe triangle mesh that approximates each
      ellipsoid.
    * For [`archetypes.Boxes3D`][dalaran.archetypes.Boxes3D], it is the edges of the box, identical to [`components.FillMode.MajorWireframe`][dalaran.components.FillMode.MajorWireframe].
    """
...
class FillModeBatch(BaseBatch[FillModeArrayLike], ComponentBatchMixin):
    ...
    _COMPONENT_TYPE: str = "dalaran.components.FillMode"
