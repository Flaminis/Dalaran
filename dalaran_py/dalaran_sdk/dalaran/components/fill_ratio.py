...
class FillRatio(datatypes.Float32, ComponentMixin):
    ...
    **Component**: How much a primitive fills out the available space.
    ...
    Used for instance to scale the points of the point cloud created from [`archetypes.DepthImage`][dalaran.archetypes.DepthImage] projection in 3D views.
...
class FillRatioBatch(datatypes.Float32Batch, ComponentBatchMixin):
    _COMPONENT_TYPE: str = "dalaran.components.FillRatio"
