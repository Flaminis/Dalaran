...
class VideoCodec(Enum):
    """
    **Component**: The codec used to encode video stored in [`components.VideoSample`][dalaran.components.VideoSample].
    ...
    [`components.VideoSample`][dalaran.components.VideoSample]s using this codec should be formatted according the "Low overhead bitstream format",
    ...
    [`components.VideoSample`][dalaran.components.VideoSample]s using this codec should be formatted according to Annex B specification.
...
class VideoCodecBatch(BaseBatch[VideoCodecArrayLike], ComponentBatchMixin):
    ...
    _COMPONENT_TYPE: str = "dalaran.components.VideoCodec"
