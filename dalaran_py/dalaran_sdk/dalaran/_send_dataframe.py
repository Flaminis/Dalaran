...
# The following constants mirror the Dalaran Arrow metadata keys (see `dl_sorbet::metadata`). They are
# kept here for backwards compatibility; the dataframe → chunk interpretation now lives in Rust.
SORBET_INDEX_NAME = b"dalaran:index_name"
SORBET_ENTITY_PATH = b"dalaran:entity_path"
SORBET_ARCHETYPE_NAME = b"dalaran:archetype"
SORBET_COMPONENT = b"dalaran:component"
SORBET_COMPONENT_TYPE = b"dalaran:component_type"
SORBET_IS_TABLE_INDEX = b"dalaran:is_table_index"
DALARAN_KIND = b"dalaran:kind"
DALARAN_KIND_CONTROL = b"control"
DALARAN_KIND_INDEX = b"index"
