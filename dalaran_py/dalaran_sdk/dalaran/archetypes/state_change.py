...
class StateChange(Archetype, VisualizableArchetype):
    ...
    **Archetype**: A state change, representing a transition of an entity into a new state.
    ...
    state changes over time. Each logged [`archetypes.StateChange`][dalaran.archetypes.StateChange] marks a new state
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.StateChange"
