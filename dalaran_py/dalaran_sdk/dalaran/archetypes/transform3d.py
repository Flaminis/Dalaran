...
class Transform3D(Transform3DExt, Archetype):
    ...
    **Archetype**: A transform between two 3D spaces, i.e. a pose.
    ...
    For transforms that affect only a single entity and do not propagate along the entity tree refer to [`archetypes.InstancePoses3D`][dalaran.archetypes.InstancePoses3D].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Transform3D"
