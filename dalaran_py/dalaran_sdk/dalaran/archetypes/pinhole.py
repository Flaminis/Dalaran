...
class Pinhole(PinholeExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: Camera perspective projection (a.k.a. intrinsics).
    ...
    If [`archetypes.Transform3D`][dalaran.archetypes.Transform3D] is logged for the same child/parent relationship (e.g. for the camera extrinsics), it takes precedence over [`archetypes.Pinhole`][dalaran.archetypes.Pinhole].

    If you use named transform frames via the `child_frame` and `parent_frame` fields, you don't have to use [`archetypes.CoordinateFrame`][dalaran.archetypes.CoordinateFrame]
    as it is the case with other visualizations: for any entity with an [`archetypes.Pinhole`][dalaran.archetypes.Pinhole] the viewer will always visualize it
    directly without needing a [`archetypes.CoordinateFrame`][dalaran.archetypes.CoordinateFrame] to refer to the pinhole's child/parent frame.
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Pinhole"
    ...
    def from_fields(
        ...
        *,
        ...
        camera_xyz:
            ...
            All common values are available as constants on the [`components.ViewCoordinates`][dalaran.components.ViewCoordinates] class.
