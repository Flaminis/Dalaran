...
class McapMessage(Archetype):
    ...
    **Archetype**: The binary payload of a single MCAP message, without metadata.
    ...
    See [`archetypes.McapChannel`][dalaran.archetypes.McapChannel] for channel definitions that specify message encoding,
    [`archetypes.McapSchema`][dalaran.archetypes.McapSchema] for data structure definitions, and the
    [MCAP specification](https://mcap.dev/) for complete format details.

    ⚠️ **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**
    """

    NAME: ClassVar[str] = "dalaran.archetypes.McapMessage"
