...
class SeriesPoints(SeriesPointsExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: Define the style properties for one or more point series (scatter plot) in a chart.
    ...
    The underlying data needs to be logged to the same entity-path using [`archetypes.Scalars`][dalaran.archetypes.Scalars].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.SeriesPoints"
