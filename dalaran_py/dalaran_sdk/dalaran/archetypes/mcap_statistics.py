...
class McapStatistics(Archetype):
    ...
    **Archetype**: Recording-level statistics about an MCAP file.
    ...
    See also [`archetypes.McapChannel`][dalaran.archetypes.McapChannel] for individual channel definitions,
    [`archetypes.McapMessage`][dalaran.archetypes.McapMessage] for message content, [`archetypes.McapSchema`][dalaran.archetypes.McapSchema] for schema definitions,
    and the [MCAP specification](https://mcap.dev/) for complete format details.

    ⚠️ **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**
    """

    NAME: ClassVar[str] = "dalaran.archetypes.McapStatistics"
