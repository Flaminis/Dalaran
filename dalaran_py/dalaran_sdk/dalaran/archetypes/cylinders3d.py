...
class Cylinders3D(Cylinders3DExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: 3D cylinders with flat caps.
    ...
    For points whose radii are for visualization purposes, use [`archetypes.Points3D`][dalaran.archetypes.Points3D] instead.

    Orienting and placing cylinders forms a separate transform that is applied prior to [`archetypes.InstancePoses3D`][dalaran.archetypes.InstancePoses3D] and [`archetypes.Transform3D`][dalaran.archetypes.Transform3D].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Cylinders3D"
