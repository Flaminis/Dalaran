...
if TYPE_CHECKING:
    from dalaran.datatypes.range1d import Range1DLike
...
class DepthImageExt:
    """Extension for [DepthImage][dalaran.archetypes.DepthImage]."""
    ...
    def compress(self: Any, compress_level: int = 6) -> EncodedDepthImage | DepthImage:
        ...
        as these are the only single-channel types the Dalaran Viewer can decode
