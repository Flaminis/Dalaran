...
class DepthImage(DepthImageExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: A depth image, i.e. as captured by a depth camera.
    ...
    Each pixel corresponds to a depth value in units specified by [`components.DepthMeter`][dalaran.components.DepthMeter].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.DepthImage"
