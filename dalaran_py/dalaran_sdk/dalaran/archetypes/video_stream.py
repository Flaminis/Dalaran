...
class VideoStream(Archetype, VisualizableArchetype):
    ...
    **Archetype**: Video stream consisting of raw video chunks.
    ...
    For logging video containers like mp4, refer to [`archetypes.AssetVideo`][dalaran.archetypes.AssetVideo] and [`archetypes.VideoFrameReference`][dalaran.archetypes.VideoFrameReference].
    ...
    TODO(#10422): [`archetypes.VideoFrameReference`][dalaran.archetypes.VideoFrameReference] does not yet work with [`archetypes.VideoStream`][dalaran.archetypes.VideoStream].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.VideoStream"
    ...
    def __init__(
        ...
        *,
        ...
        sample:
            ...
            Unless your stream consists entirely of key-frames (in which case you should consider [`archetypes.EncodedImage`][dalaran.archetypes.EncodedImage])
            ...
            See [`components.VideoCodec`][dalaran.components.VideoCodec] for codec specific requirements.
        is_keyframe:
            Whether the corresponding [`components.VideoSample`][dalaran.components.VideoSample] contains a keyframe.

            A keyframe (also known as a sync sample or IDR) is a frame from which a decoder can
            start decoding the stream with no prior decoder state. See [`components.IsKeyframe`][dalaran.components.IsKeyframe]
            and [`components.VideoCodec`][dalaran.components.VideoCodec] for the codec-specific definition.
