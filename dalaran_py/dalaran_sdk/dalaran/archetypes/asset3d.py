...
class Asset3D(Asset3DExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: A prepacked 3D asset (`.gltf`, `.glb`, `.obj`, `.stl`, etc.).
    ...
    See also [`archetypes.Mesh3D`][dalaran.archetypes.Mesh3D].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Asset3D"
    ...
    def from_fields(
        ...
        *,
        ...
        albedo_factor:
            ...
            it will be overwritten by actual `albedo_factor` of [`archetypes.Asset3D`][dalaran.archetypes.Asset3D] (if specified).
