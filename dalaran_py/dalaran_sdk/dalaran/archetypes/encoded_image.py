...
class EncodedImage(EncodedImageExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: An image encoded as e.g. a JPEG or PNG.
    ...
    Dalaran also supports uncompressed images with the [`archetypes.Image`][dalaran.archetypes.Image].
    For images that refer to video frames see [`archetypes.VideoFrameReference`][dalaran.archetypes.VideoFrameReference].

    To compress an image, use [`dalaran.Image.compress`][].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.EncodedImage"
