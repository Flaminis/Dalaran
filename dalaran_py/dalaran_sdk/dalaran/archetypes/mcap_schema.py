...
class McapSchema(Archetype):
    ...
    **Archetype**: A schema definition that describes the structure of messages in an MCAP file.
    ...
    See also [`archetypes.McapChannel`][dalaran.archetypes.McapChannel] for channels that reference these schemas,
    [`archetypes.McapMessage`][dalaran.archetypes.McapMessage] for the messages that conform to these schemas, and the
    [MCAP specification](https://mcap.dev/) for complete format details.

    ⚠️ **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**
    """

    NAME: ClassVar[str] = "dalaran.archetypes.McapSchema"
