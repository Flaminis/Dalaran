...
class VideoFrameReference(VideoFrameReferenceExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: References a single video frame.
    ...
    Used to display individual video frames from a [`archetypes.AssetVideo`][dalaran.archetypes.AssetVideo].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.VideoFrameReference"
