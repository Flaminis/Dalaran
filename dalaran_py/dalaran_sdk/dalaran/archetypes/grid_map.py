...
class GridMap(Archetype):
    ...
    **Archetype**: A 2D grid map stored as raster data in an image buffer, with a cell size in scene units and pose.
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.GridMap"
    ...
    def __init__(
        ...
        *,
        ...
        translation:
            ...
            Together with [`components.RotationAxisAngle`][dalaran.components.RotationAxisAngle] or [`components.RotationQuat`][dalaran.components.RotationQuat], this defines the pose of the
        ...
        rotation_axis_angle:
            ...
            Together with [`components.Translation3D`][dalaran.components.Translation3D], this defines the pose of the
            lower-left image corner relative to the map's parent coordinate frame.

            Note: either this or [`components.RotationQuat`][dalaran.components.RotationQuat] can be set to specify the grid map's rotation, but not both.
            If both this and [`components.RotationQuat`][dalaran.components.RotationQuat] are set, this is ignored in favor of the quaternion.
        quaternion:
        ...
        colormap:
            ...
            If not set, the grid map is shown using the underlying [`components.ImageFormat`][dalaran.components.ImageFormat]
            interpretation.
