...
from dalaran.components import Scale3D, TransformRelation, TransformRelationLike
...
class Transform3DExt:
    """Extension for [Transform3D][dalaran.archetypes.Transform3D]."""
    ...
    def __init__(
        ...
        *,
        ...
        from_parent:
            ...
            Deprecated in favor of `relation=dalaran.TransformRelation.ChildFromParent`.
        ...
        child_frame:
            ...
            ⚠ This currently also affects the child frame of [`archetypes.Pinhole`][dalaran.archetypes.Pinhole].
            ⚠ This currently is also used as the frame id of [`archetypes.InstancePoses3D`][dalaran.archetypes.InstancePoses3D].

            If not specified, this is set to the implicit transform frame of the current entity path.
            This means that if a [`archetypes.Transform3D`][dalaran.archetypes.Transform3D] is set on an entity called `/my/entity/path` then this will default to `tf#/my/entity/path`.

            To set the frame an entity is part of see [`archetypes.CoordinateFrame`][dalaran.archetypes.CoordinateFrame].
        parent_frame:
            The parent frame this transform transforms into.

            ⚠ This currently also affects the parent frame of [`archetypes.Pinhole`][dalaran.archetypes.Pinhole].

            If not specified, this is set to the implicit transform frame of the current entity path's parent.
            This means that if a [`archetypes.Transform3D`][dalaran.archetypes.Transform3D] is set on an entity called `/my/entity/path` then this will default to `tf#/my/entity`.
        ...
        with catch_and_log_exceptions(context=self.__class__.__name__):
            ...
            if from_parent is not None:
                ...
                warnings.warn(
                    message=(
                        "`from_parent` is deprecated as an argument to `Transform3D`; prefer `relation=dalaran.TransformRelation.ChildFromParent` instead"
                    ),
