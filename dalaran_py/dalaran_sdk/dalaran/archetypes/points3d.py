...
class Points3D(Points3DExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: A 3D point cloud with positions and optional colors, radii, labels, etc.
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Points3D"
    ...
    def from_fields(
        ...
        *,
        ...
        point_shading:
            ...
            If not set, points are rendered with [`components.PointShading.Gradient`][dalaran.components.PointShading.Gradient] by default.
        class_ids:
            Optional class Ids for the points.

            The [`components.ClassId`][dalaran.components.ClassId] provides colors and labels if not specified explicitly.
        keypoint_ids:
            Optional keypoint IDs for the points, identifying them within a class.

            If keypoint IDs are passed in but no [`components.ClassId`][dalaran.components.ClassId]s were specified, the [`components.ClassId`][dalaran.components.ClassId] will
            default to 0.
