...
class InstancePoses3D(Archetype):
    ...
    **Archetype**: One or more transforms applied on the current entity's transform frame.
    ...
    Unlike [`archetypes.Transform3D`][dalaran.archetypes.Transform3D], it is *not* propagated in the transform hierarchy.
    If [`archetypes.CoordinateFrame`][dalaran.archetypes.CoordinateFrame] is specified, it acts relative to that coordinate frame,
    ...
    Some visualizers like the mesh visualizer used for [`archetypes.Mesh3D`][dalaran.archetypes.Mesh3D],
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.InstancePoses3D"
