...
class Capsules3D(Capsules3DExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: 3D capsules; cylinders with hemispherical caps.
    ...
    Orienting and placing capsules forms a separate transform that is applied prior to [`archetypes.InstancePoses3D`][dalaran.archetypes.InstancePoses3D] and [`archetypes.Transform3D`][dalaran.archetypes.Transform3D].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Capsules3D"
