...
class AssetVideo(AssetVideoExt, Archetype):
    ...
    **Archetype**: A video binary.
    ...
    In order to display a video, you also need to log a [`archetypes.VideoFrameReference`][dalaran.archetypes.VideoFrameReference] for each frame.
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.AssetVideo"
