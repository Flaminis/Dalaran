...
class Boxes3D(Boxes3DExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: 3D boxes with half-extents and optional center, rotations, colors etc.
    ...
    Orienting and placing boxes forms a separate transform that is applied prior to [`archetypes.InstancePoses3D`][dalaran.archetypes.InstancePoses3D] and [`archetypes.Transform3D`][dalaran.archetypes.Transform3D].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Boxes3D"
    ...
    def from_fields(
        ...
        *,
        ...
        class_ids:
            Optional [`components.ClassId`][dalaran.components.ClassId]s for the boxes.
