...
class VoxelGridMap(Archetype, VisualizableArchetype):
    ...
    **Archetype**: A sparse 3D voxel grid map with grid indices and voxel dimensions.
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.VoxelGridMap"
    ...
    def __init__(
        ...
        *,
        ...
        rotation_axis_angle:
            ...
            Together with [`components.Translation3D`][dalaran.components.Translation3D], this defines the pose of the grid relative to the
            map's parent coordinate frame.

            Note: either this or [`components.RotationQuat`][dalaran.components.RotationQuat] can be set to specify the grid's rotation, but not both.
