...
class VideoFrameReferenceExt:
    """Extension for [VideoFrameReference][dalaran.archetypes.VideoFrameReference]."""
    ...
    def __init__(
        ...
        *,
        ...
        video_reference:
            Optional reference to an entity with a [`archetypes.AssetVideo`][dalaran.archetypes.AssetVideo].
