...
class Scalars(Archetype):
    ...
    **Archetype**: One or more double-precision scalar values, e.g. for use for time-series plots.
    ...
    is referenced by [`archetypes.SeriesLines`][dalaran.archetypes.SeriesLines] or [`archetypes.SeriesPoints`][dalaran.archetypes.SeriesPoints]. You can do
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Scalars"
