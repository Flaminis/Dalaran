...
class Ellipsoids3D(Ellipsoids3DExt, Archetype, VisualizableArchetype):
    ...
    **Archetype**: 3D ellipsoids or spheres.
    ...
    For points whose radii are for the sake of visualization, use [`archetypes.Points3D`][dalaran.archetypes.Points3D] instead.
    ...
    Orienting and placing ellipsoids/spheres forms a separate transform that is applied prior to [`archetypes.InstancePoses3D`][dalaran.archetypes.InstancePoses3D] and [`archetypes.Transform3D`][dalaran.archetypes.Transform3D].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.Ellipsoids3D"
