...
class StateConfiguration(Archetype, VisualizableArchetype):
    ...
    **Archetype**: Define the style and mapping for state values in a state timeline view.
    ...
    The underlying data needs to be logged to the same entity path using [`archetypes.StateChange`][dalaran.archetypes.StateChange].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.StateConfiguration"
