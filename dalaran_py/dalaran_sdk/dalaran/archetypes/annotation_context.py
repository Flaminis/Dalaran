...
class AnnotationContext(Archetype):
    ...
    **Archetype**: The annotation context provides additional information on how to display entities.
    ...
    Entities can use [`components.ClassId`][dalaran.components.ClassId]s and [`components.KeypointId`][dalaran.components.KeypointId]s to provide annotations, and
    the labels and colors will be looked up in the appropriate
    annotation context. We use the *first* annotation context we find in the
    path-hierarchy when searching up through the ancestors of a given entity
    path.

    See also [`datatypes.ClassDescription`][dalaran.datatypes.ClassDescription].
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.AnnotationContext"
