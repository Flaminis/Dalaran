...
class GraphEdges(Archetype, VisualizableArchetype):
    ...
    **Archetype**: A list of edges in a graph.
    ...
    NAME: ClassVar[str] = "dalaran.archetypes.GraphEdges"
    ...
    def __init__(
        ...
        graph_type:
            ...
            If no [`components.GraphType`][dalaran.components.GraphType] is provided, the graph is assumed to be undirected.
