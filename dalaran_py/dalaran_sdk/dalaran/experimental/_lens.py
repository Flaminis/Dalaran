...
from dalaran._baseclasses import ComponentDescriptor
from dalaran_bindings import DeriveLensInternal, MutateLensInternal
...
class DeriveLens:
    ...
    def to_component(
        ...
        *,
        ...
        selector:
            A [`Selector`][dalaran.experimental.Selector] or selector query string to apply to the
            input column.
        cast_to:
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the component added.
    ...
    def to_timeline(
        ...
        timeline_type:
            ...
            or `"timestamp_ns"`.
        selector:
            A [`Selector`][dalaran.experimental.Selector] or selector query string to extract time
            values (must produce `Int64` arrays).

        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the time column added.
    ...
    def to_packed_component(
        ...
        *fields:
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the packed component added.
    ...
    def to_translation(self, x: str, y: str, z: str) -> DeriveLens:
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the translation added.

        """
        from dalaran.archetypes import Transform3D
    ...
    def to_quaternion(self, x: str, y: str, z: str, w: str) -> DeriveLens:  # noqa: PLR0917
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the quaternion added.
    ...
    def to_scale(self, x: str, y: str, z: str) -> DeriveLens:
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the scale added.
    ...
    def to_rotation_axis_angle(self, axis_x: str, axis_y: str, axis_z: str, angle: str) -> DeriveLens:  # noqa: PLR0917
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the rotation added.
    ...
    def to_scalars(self, *fields: str) -> DeriveLens:
        ...
        *fields:
        ...
        Returns
        -------
        A new [`DeriveLens`][dalaran.experimental.DeriveLens] with the scalars added.

        """
        from dalaran.archetypes import Scalars
...
class MutateLens:
    ...
    def __init__(
        ...
        *,
        ...
        selector:
            A [`Selector`][dalaran.experimental.Selector] or selector query string to apply.
        keep_row_ids:
