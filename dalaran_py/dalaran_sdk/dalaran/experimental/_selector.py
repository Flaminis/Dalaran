...
from dalaran_bindings import SelectorInternal
...
class Selector:
    ...
    def pipe(self, func: Callable[[pa.Array], pa.Array | None] | Selector) -> Selector:
        ...
        func:
            ...
            or `None`, or another [`Selector`][dalaran.experimental.Selector] to chain.

        Returns
        -------
        A new [`Selector`][dalaran.experimental.Selector] with the transformation applied.
