...
if TYPE_CHECKING:
    ...
    from dalaran.catalog import ContentFilter, IndexValuesLike, Schema
    from dalaran_bindings import ChunkStoreInternal
...
class ChunkStore:
    ...
    [`ChunkStore.from_chunks`][dalaran.experimental.ChunkStore.from_chunks], or
    fully materialize an [`IndexedReader`][dalaran.experimental.IndexedReader]
    ...
    def schema(self) -> Schema:
        ...
        from dalaran.catalog import Schema
    ...
    def reader(
        ...
        *,
        ...
        from dalaran.catalog._content_filter import ContentFilter
