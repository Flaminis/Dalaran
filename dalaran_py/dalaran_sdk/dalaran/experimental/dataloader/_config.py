...
class Field:
    ...
    decode
        A [`ColumnDecoder`][dalaran.experimental.dataloader.ColumnDecoder]
        that turns the Arrow column into a tensor.
    select
        Optional jq-like [`Selector`][dalaran.experimental.Selector] applied
    ...
    window
        ...
        [`FixedRateSampling`][dalaran.experimental.dataloader.FixedRateSampling]
