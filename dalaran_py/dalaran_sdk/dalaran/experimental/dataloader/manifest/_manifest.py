...
class Manifest:
    ...
    A manifest is created by generating one from a source with [`Manifest.generate`][dalaran.experimental.dataloader.Manifest.generate],
    or by loading an existing one with [`Manifest.from_parquet`][dalaran.experimental.dataloader.Manifest.from_parquet].
    Persist it with [`Manifest.write_parquet`][dalaran.experimental.dataloader.Manifest.write_parquet]; a manifest is always
    ...
    def generate(
        ...
        *,
        ...
        [`shuffle`][dalaran.experimental.dataloader.Manifest.shuffle] on the result —
        it re-orders cheaply without re-scanning. Persist with
        [`write_parquet`][dalaran.experimental.dataloader.Manifest.write_parquet].

        See [`DalaranIterableDataset`][dalaran.experimental.dataloader.DalaranIterableDataset] for
    ...
    def shuffle(
        ...
        *,
        ...
        Scan once with [`generate`][dalaran.experimental.dataloader.Manifest.generate],
        ...
        strategy
            ...
            to apply, e.g. [`BlockShuffle`][dalaran.experimental.dataloader.BlockShuffle] (the
            default), [`SampleShuffle`][dalaran.experimental.dataloader.SampleShuffle], or
            [`NoShuffle`][dalaran.experimental.dataloader.NoShuffle]. It fixes both the
            fetch order and the emission buffer, so passing the same strategy object
            here and to [`DalaranIterableDataset`][dalaran.experimental.dataloader.DalaranIterableDataset]
