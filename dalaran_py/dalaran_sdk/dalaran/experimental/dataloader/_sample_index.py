...
class SampleIndex:
    ...
    ns_per_sample
        For [`FixedRateSampling`][dalaran.experimental.dataloader.FixedRateSampling]: nanoseconds between grid points.
    ...
    def build(
        ...
        *,
        ...
        """
        Build a [`SampleIndex`][dalaran.experimental.dataloader.SampleIndex] from lightweight metadata queries.
        ...
        timeline_sampling
            ...
            Pass [`FixedRateSampling`][dalaran.experimental.dataloader.FixedRateSampling] for a regular grid.
...
def _find_range_columns(ranges_table: pa.Table, index: str) -> tuple[str, str]:
    ...
    """
    candidates = [n for n in ranges_table.column_names if n != "dalaran_segment_id" and index in n]
...
def _build_integer(ctx: _RangesCtx) -> SampleIndex:
    ...
    seg_col = ctx.ranges_table.column("dalaran_segment_id").to_pylist()
