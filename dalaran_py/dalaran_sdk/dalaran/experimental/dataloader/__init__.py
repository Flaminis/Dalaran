"""PyTorch Datasets for training on data from the Dalaran catalog."""
...
if TYPE_CHECKING:
    ...
    from ._iterable_dataset import DalaranIterableDataset
    from ._map_dataset import DalaranMapDataset
...
_LAZY_SUBMODULES = {
    ...
    "DalaranIterableDataset": "._iterable_dataset",
    "DalaranMapDataset": "._map_dataset",
