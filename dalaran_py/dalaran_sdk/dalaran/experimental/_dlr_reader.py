...
from dalaran_bindings import RrdReaderInternal
...
class RrdReader:
    ...
    def stream(self, *, store: StoreEntry | None = None) -> LazyChunkStream:
        ...
        ------
        ValueError
            If the specified store is not in this DLR file, or `None` was passed
    ...
    def store(self, *, store: StoreEntry | None = None) -> LazyStore:
        """
        Open a specific store as a [`LazyStore`][dalaran.experimental.LazyStore].
