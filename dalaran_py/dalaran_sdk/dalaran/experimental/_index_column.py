...
class IndexColumn:
    ...
    Construct one with [`timestamp`][dalaran.experimental.IndexColumn.timestamp],
    [`duration`][dalaran.experimental.IndexColumn.duration], or
    [`sequence`][dalaran.experimental.IndexColumn.sequence] — the timeline kind is
