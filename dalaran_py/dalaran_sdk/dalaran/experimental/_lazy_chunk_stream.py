...
from dalaran_bindings import LazyChunkStreamInternal
...
if TYPE_CHECKING:
    ...
    from dalaran_bindings import ChunkInternal, ComponentDescriptor
...
def _normalize_components(
    ...
    from dalaran_bindings import ComponentDescriptor as CD
