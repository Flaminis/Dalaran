...
from dalaran_bindings import ParquetReaderInternal
...
class ParquetReader:
    ...
    [`Chunk`][dalaran.experimental.Chunk]s of struct/scalar components. To map those
    struct fields into Dalaran archetypes (translation, rotation, scalars, …), apply
    lenses to the resulting `.stream()` — see
    [`DeriveLens`][dalaran.experimental.DeriveLens]:
