...
from dalaran_bindings import McapReaderInternal
...
if TYPE_CHECKING:
    ...
    from dalaran_bindings.dalaran_bindings import _McapInfoInternal
...
class McapReader:
    ...
    # TODO(ab): this API is a reflection of the current state of the MCAP reader and mirrors `dalaran mcap convert`. It's
    ...
    def __init__(
        ...
        *,
        ...
        decoders:
            ...
            [`McapReader.available_decoders`][dalaran.experimental.McapReader.available_decoders]
            to enumerate them.
        include_topic_regex:
