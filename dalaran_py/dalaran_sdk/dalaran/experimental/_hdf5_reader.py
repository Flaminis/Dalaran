...
from dalaran_bindings import Hdf5ReaderInternal
...
class Hdf5Reader:
    ...
    Each HDF5 group is mapped to a Dalaran entity, and the group's leaf datasets
    ...
    def stream(
        ...
        *,
        ...
        - A 3-D-or-higher dataset `[N, d1, …, dk]` becomes a column of `N` rows, each
          ...
          in the emitted data; recover it via [`datasets`][dalaran.experimental.Hdf5Reader.datasets].
        ...
        root_group:
            ...
            [`attributes`][dalaran.experimental.Hdf5Reader.attributes] instead.
        entity_path_prefix:
        ...
        index_column:
            ...
            [`IndexColumn`][dalaran.experimental.IndexColumn], e.g.
