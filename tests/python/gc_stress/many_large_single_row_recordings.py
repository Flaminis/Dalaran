...
Usage:
- Start a Dalaran Viewer in release mode with 2GiB of memory limit:
  `cargo r -p dalaran-cli --release --no-default-features --features native_viewer -- --memory-limit 2GiB`
