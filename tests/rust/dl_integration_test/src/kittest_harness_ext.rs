...
use dl_viewer::external::dl_chunk::{ChunkBuilder, LatestAtQuery};
use dl_viewer::external::dl_entity_db::EntityDb;
use dl_viewer::external::dl_sdk_types;
use dl_viewer::external::dl_viewer_context::{self, AppContext, ViewerContext, blueprint_timeline};
use dl_viewer::viewer_test_utils::AppTestingExt as _;
...
// Kittest harness utilities specific to the Dalaran app.
pub trait HarnessExt<'h> {
    ...
    // Runs a function with the `ViewerContext` generated by the actual Dalaran application.
    ...
    // Runs a function with the `AppContext` generated by the actual Dalaran application.
    ...
    fn add_blueprint_container(
        ...
        parent_container: Option<dl_viewer_context::ContainerId>,
    ) -> dl_viewer_context::ContainerId;
...
impl<'h> HarnessExt<'h> for egui_kittest::Harness<'h, dl_viewer::App> {
    fn clear_current_blueprint(&mut self) {
    ...
    fn init_recording(&mut self) {
        ...
        });
        {
            ...
            recording_store
                .set_recording_property(
                    ...
                    &dl_sdk_types::components::Timestamp::from(0),
                )
        ...
        app.command_sender.send_system(SystemCommand::set_selection(
            dl_viewer_context::Item::StoreId(recording_store_id.clone()),
        ));
        self.run_ok();
    }
    ...
    fn init_recording_without_blueprint(&mut self) {
        ...
        let store_info = StoreInfo::new_unversioned(
            ...
            dl_sdk::external::dl_log_types::StoreSource::Other("test".to_owned()),
        );
        let mut recording_store = EntityDb::new(recording_store_id.clone());
