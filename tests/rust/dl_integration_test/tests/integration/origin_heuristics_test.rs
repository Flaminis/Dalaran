...
use dl_viewer::external::dl_viewer_context::ViewClass as _;
...
fn make_test_image() -> dl_sdk_types::archetypes::Image {
...
fn make_test_harness<'a>() -> egui_kittest::Harness<'a, dl_viewer::App> {
    ...
    harness.log_entity("/world", |builder| {
        builder.with_archetype(
            RowId::new(),
            TimePoint::default(),
            &dl_sdk_types::archetypes::ViewCoordinates::RIGHT_HAND_Y_DOWN(),
        )
    });
    ...
    harness.log_entity("/world/camera/image", |builder| {
        builder.with_archetype(
            RowId::new(),
            TimePoint::default(),
            &dl_sdk_types::archetypes::Pinhole::from_focal_length_and_resolution(
                [128.0, 128.0],
                [256.0, 256.0],
            )
    ...
    harness.log_entity("/world/camera/image/keypoint", |builder| {
        builder.with_archetype(
            RowId::new(),
            TimePoint::default(),
            &dl_sdk_types::archetypes::Points2D::new([(10.0, 10.0), (128.0, -0.0), (50.0, -50.0)])
