...
fn make_multi_view_test_harness<'a>() -> egui_kittest::Harness<'a, dl_viewer::App> {
    ...
    harness.log_entity("points2d", |builder| {
        builder.with_archetype(
            RowId::new(),
            TimePoint::default(),
            &dl_sdk_types::archetypes::Points2D::new([(1.0, 1.0), (1.2, -0.3), (0.0, -0.3)])
    ...
    harness.log_entity("text_document", |builder| {
        builder.with_archetype(
            RowId::new(),
            TimePoint::STATIC,
            &dl_sdk_types::archetypes::TextDocument::new("Hello World!"),
        )
    });
...
fn sort_views_by_class_identifier(harness: &mut egui_kittest::Harness<'_, dl_viewer::App>) {
