...
use dl_sdk::{
    TimeCell, Timeline,
    external::{
        dl_log_types::{AbsoluteTimeRange, EntityPath},
        dl_tuid,
    },
};
use dl_viewer::{
    external::{
        dl_chunk::TimelineName, dl_entity_db::FetchStage,
        dl_viewer_context::open_url::ViewerOpenUrl,
    },
    ...
    let segment_uri = dl_uri::DatasetSegmentUri {
        ...
        fragment: dl_uri::Fragment {
            ...
            when: Some((
                ...
                TimeCell::new(dl_sdk::time::TimeType::Sequence, 10),
            )),
