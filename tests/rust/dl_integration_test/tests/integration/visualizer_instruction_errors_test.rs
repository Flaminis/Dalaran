...
use dl_viewer::external::dl_sdk_types::VisualizableArchetype as _;
use dl_viewer::external::dl_sdk_types::archetypes::{Scalars, SeriesLines, SeriesPoints};
use dl_viewer::external::dl_sdk_types::blueprint::datatypes::{
...
pub async fn series_count_exceeds_max() {
    ...
    use dl_viewer::external::dl_sdk_types::DynamicArchetype;
