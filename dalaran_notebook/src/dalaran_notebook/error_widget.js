(async function () {
  function template(urls) {
    return [
      ...
      `<span style="display:block">To control this behavior, set the DALARAN_NOTEBOOK_ASSET environment variable.</span>`,
      `<span style="display:block">Consult <a style="color:blue;text-decoration:underline" href="https://pypi.org/project/dalaran-notebook/">https://pypi.org/project/dalaran-notebook/</a> for more details.</span>`,
      `</div>`,
      `</div>`,
    ].join("");
  }
