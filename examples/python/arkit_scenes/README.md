...
This example visualizes the [ARKitScenes dataset](https://github.com/apple/ARKitScenes/) using Dalaran.
...
[`DepthImage`](https://www.dalaran.dev/docs/reference/types/archetypes/depth_image), [`Transform3D`](https://www.dalaran.dev/docs/reference/types/archetypes/transform3d),
[`Pinhole`](https://www.dalaran.dev/docs/reference/types/archetypes/pinhole), [`Mesh3D`](https://www.dalaran.dev/docs/reference/types/archetypes/mesh3d),
[`Boxes3D`](https://www.dalaran.dev/docs/reference/types/archetypes/boxes3d),
[`TextDocument`](https://www.dalaran.dev/docs/reference/types/archetypes/text_document)
...
This visualization through Dalaran highlights the dataset's potential in developing immersive AR experiences and enhancing machine learning models for real-world applications while showcasing Dalarans visualization capabilities.
...
```python
dl.log("world/camera_lowres", dl.Transform3D(transform=camera_from_world))
dl.log("world/camera_lowres", dl.Pinhole(image_from_camera=intrinsic, resolution=[w, h]))
dl.log(f"{entity_id}/rgb", dl.Image(rgb).compress(jpeg_quality=95))
dl.log(f"{entity_id}/depth", dl.DepthImage(depth, meter=1000))
```

### Ground-truth mesh
The mesh is logged as an [dl.Mesh3D archetype](https://www.dalaran.dev/docs/reference/types/archetypes/mesh3d).
...
for i, label_info in enumerate(annotation["data"]):
    dl.log(
        ...
        dl.InstancePoses3D(mat3x3=mat3x3),
        static=True,
    )
```
