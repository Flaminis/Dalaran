#!/usr/bin/env python3
"""Shows how dalaran can work with multiprocessing."""
...
@dl.shutdown_at_exit  # type: ignore[misc]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Test multi-process logging to the same Dalaran server")
    parser.parse_args()
