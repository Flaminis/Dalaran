...
description = "Convert RRD robot recordings into LeRobot v3 training datasets using the OSS Dalaran server, with video remuxing."
...
Convert robot recordings into training-ready datasets by using the OSS Dalaran server to query and transform RRD files into LeRobot v3 format.
