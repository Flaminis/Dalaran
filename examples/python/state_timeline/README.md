...
[`StateChange`](https://www.dalaran.dev/docs/reference/types/archetypes/state_change), [`StateConfiguration`](https://www.dalaran.dev/docs/reference/types/archetypes/state_configuration), [`TextDocument`](https://www.dalaran.dev/docs/reference/types/archetypes/text_document)

## Logging and visualizing with Dalaran

Discrete states are logged with the [`StateChange`](https://www.dalaran.dev/docs/reference/types/archetypes/state_change) archetype.
...
- **Custom styling**: [`StateConfiguration`](https://www.dalaran.dev/docs/reference/types/archetypes/state_configuration) maps raw state values to display labels and colors (`robot/task`).
