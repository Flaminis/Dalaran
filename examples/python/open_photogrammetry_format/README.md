...
## Used Dalaran types
[`Image`](https://www.dalaran.dev/docs/reference/types/archetypes/image), [`Points3D`](https://www.dalaran.dev/docs/reference/types/archetypes/points3d), [`Transform3D`](https://www.dalaran.dev/docs/reference/types/archetypes/transform3d), [`Pinhole`](https://www.dalaran.dev/docs/reference/types/archetypes/pinhole)
...
### Timelines
 ...
 For each processed frame, all data sent to Dalaran is associated with specific time using [`timelines`](https://www.dalaran.dev/docs/concepts/logging-and-ingestion/timelines).
...
```python
dl.log("world/cameras", dl.Transform3D(translation=calib_camera.position, mat3x3=rot))
```
...
```
The input video is logged as a sequence of [`Image`](https://www.dalaran.dev/docs/reference/types/archetypes/image) objects to the `world/cameras/image/rgb` entity.
```python
dl.log("world/cameras/image/rgb", dl.Image(np.array(img)).compress(jpeg_quality=jpeg_quality))
```

### Point clouds

Point clouds from the project are logged as [`Points3D`](https://www.dalaran.dev/docs/reference/types/archetypes/points3d) archetype to the `world/points` entity.
