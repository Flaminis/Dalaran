...
Demonstrates two ways to log the same GLB scene: converting it to raw [`Mesh3D`](https://dalaran.dev/docs/reference/types/archetypes/mesh3d) data or sending the original file as an [`Asset3D`](https://dalaran.dev/docs/reference/types/archetypes/asset3d).
...
## Used Dalaran types
[`Asset3D`](https://www.dalaran.dev/docs/reference/types/archetypes/asset3d), [`Transform3D`](https://www.dalaran.dev/docs/reference/types/archetypes/transform3d), [`Mesh3D`](https://www.dalaran.dev/docs/reference/types/archetypes/mesh3d)
...
The default code path uses `trimesh` to parse a GLB file, then logs its raw mesh data, simple material properties, and transform hierarchy to Dalaran.
...
The raw 3D mesh data is logged as [`Mesh3D`](https://www.dalaran.dev/docs/reference/types/archetypes/mesh3d) objects.
...
The [`Transform3D`](https://www.dalaran.dev/docs/reference/types/archetypes/transform3d) archetype preserves the position and orientation of each mesh in the scene hierarchy.
...
With `--asset3d`, the scene file is stored in the recording as a single [`Asset3D`](https://www.dalaran.dev/docs/reference/types/archetypes/asset3d).
