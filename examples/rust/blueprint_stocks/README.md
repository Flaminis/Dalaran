This example logs stock data to show how Dalaran blueprints can be used to present different views of the same data. Very similar to Python's `blueprint_stocks` example, but using static (not live) data.
