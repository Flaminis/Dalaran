...
The simplest example of how to use Dalaran, showing how to log a point cloud.
This is part of the [Quick Start guide](https://www.dalaran.dev/docs/getting-started/data-in/rust).
