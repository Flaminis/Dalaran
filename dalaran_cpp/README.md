...
All C++ examples can be found [directly in the Dalaran repository](https://github.com/rerun-io/rerun/tree/latest/examples/cpp).
...
* [dalaran_c](https://github.com/rerun-io/rerun/tree/latest/crates/top/rerun_c/) static libraries
...
Keep in mind that all archetypes/components/datatypes are mostly generated by the [Dalaran types builder](https://github.com/rerun-io/rerun/tree/latest/crates/build/dl_types_builder).
