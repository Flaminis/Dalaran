...
#include <dalaran/archetypes/tensor.hpp>
...
SCENARIO("Tensor archetype can be created from tensor data." TEST_TAG) {
    GIVEN("a vector of data") {
        ...
        THEN(
            ...
            dalaran::datatypes::TensorData tensor_with_dim_names_ctor_dt;
            ...
            auto tensor_with_dim_names_ctor =
                dalaran::archetypes::Tensor(tensor_with_dim_names_ctor_dt);
