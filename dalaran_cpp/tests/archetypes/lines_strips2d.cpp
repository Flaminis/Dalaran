...
#include <dalaran/archetypes/line_strips2d.hpp>
...
SCENARIO(
    ...
    GIVEN("Constructed from builder and manually") {
        auto from_builder =
            LineStrips2D({
                             dalaran::components::LineStrip2D({{0.f, 0.f}, {1.f, -1.f}}),
                             dalaran::components::LineStrip2D({{-1.f, 3.f}, {0.f, 1.5f}}),
                         })
                .with_radii({1.0, 10.0})
        ...
        from_manual.strips = dalaran::ComponentBatch::from_loggable<dalaran::components::LineStrip2D>(
                                 {
                                     dalaran::components::LineStrip2D({{0.f, 0.f}, {1.f, -1.f}}),
                                     dalaran::components::LineStrip2D({{-1.f, 3.f}, {0.f, 1.5f}}),
                                 },
        ...
        from_manual.class_ids = dalaran::ComponentBatch::from_loggable<dalaran::components::ClassId>(
                                    ...
                                    .value_or_throw();
        from_manual.draw_order = dalaran::ComponentBatch::from_loggable(
                                     dalaran::components::DrawOrder(123.0f),
