...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<components::AffixFuzzer7>::arrow_datatype() {
        static const auto datatype = arrow::list(
            arrow::field("item", Loggable<dalaran::datatypes::MixedFields>::arrow_datatype(), false)
        );
        return datatype;
    }
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::AffixFuzzer7>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<components::AffixFuzzer7>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<components::AffixFuzzer7>::fill_arrow_array_builder(
        ...
        for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
            ...
            if (element.many_optional.has_value()) {
                ...
                if (element.many_optional.value().data()) {
                    DL_RETURN_NOT_OK(
                        Loggable<dalaran::datatypes::MixedFields>::fill_arrow_array_builder(
                            value_builder,
