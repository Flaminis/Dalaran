...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::MixedFields>::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            ...
            arrow::field(
                ...
                Loggable<dalaran::datatypes::FlattenedScalar>::arrow_datatype(),
                false
            ),
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::MixedFields>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::MixedFields>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::MixedFields>::fill_arrow_array_builder(
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(
                    Loggable<dalaran::datatypes::FlattenedScalar>::fill_arrow_array_builder(
                        field_builder,
