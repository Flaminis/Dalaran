...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::MultiEnum>::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            arrow::field("value1", Loggable<dalaran::datatypes::EnumTest>::arrow_datatype(), false),
            arrow::field("value2", Loggable<dalaran::datatypes::ValuedEnum>::arrow_datatype(), true),
        });
        return datatype;
    }
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::MultiEnum>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::MultiEnum>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::MultiEnum>::fill_arrow_array_builder(
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                ...
                if (element.value2.has_value()) {
                    DL_RETURN_NOT_OK(
                        Loggable<dalaran::datatypes::ValuedEnum>::fill_arrow_array_builder(
                            field_builder,
