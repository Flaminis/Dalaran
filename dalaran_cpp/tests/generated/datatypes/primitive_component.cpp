...
namespace dalaran {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::PrimitiveComponent>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::PrimitiveComponent>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::PrimitiveComponent>::fill_arrow_array_builder(
