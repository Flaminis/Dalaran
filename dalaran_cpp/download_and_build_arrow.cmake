...
#
# Populates `dalaran_arrow_target` with the final arrow target.
# Tries to build an as small as possible version of Arrow that is compatible with the Dalaran C++ SDK.
function(download_and_build_arrow)
    ...
    if(MSVC)
        ...
        set(ARROW_CXXFLAGS "")
        set(ARROW_ASAN ${DALARAN_USE_ASAN})
    endif()
    ...
    if(DALARAN_ARROW_LINK_SHARED)
        add_library(dalaran_arrow_target SHARED IMPORTED GLOBAL)

        # For windows we need to know both the dll AND the import library.
        if(WIN32)
            set_target_properties(dalaran_arrow_target PROPERTIES IMPORTED_IMPLIB ${ARROW_DOWNLOAD_PATH}/lib/arrow.lib)
        endif()
    else()
        ...
        target_compile_definitions(dalaran_arrow_target INTERFACE ARROW_STATIC)
    ...
    add_dependencies(dalaran_arrow_target arrow_cpp)
    set_target_properties(dalaran_arrow_target PROPERTIES
