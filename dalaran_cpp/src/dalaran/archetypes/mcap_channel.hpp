...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/mcap_channel.fbs".
...
namespace dalaran::archetypes {
    ...
    struct McapChannel {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.McapChannel";

        /// `ComponentDescriptor` for the `id` field.
        static constexpr auto Descriptor_id = ComponentDescriptor(
            ArchetypeName, "McapChannel:id", Loggable<dalaran::components::ChannelId>::ComponentType
        );
        /// `ComponentDescriptor` for the `topic` field.
        static constexpr auto Descriptor_topic = ComponentDescriptor(
            ArchetypeName, "McapChannel:topic", Loggable<dalaran::components::Text>::ComponentType
        );
        ...
        static constexpr auto Descriptor_metadata = ComponentDescriptor(
            ...
            Loggable<dalaran::components::KeyValuePairs>::ComponentType
        );
      ...
      public:
        ...
        explicit McapChannel(
            dalaran::components::ChannelId _id, dalaran::components::Text _topic,
            dalaran::components::Text _message_encoding
        )
        ...
        /// Channel IDs must be unique within a single MCAP file and are used to associate
        /// messages with their corresponding channel definition.
        McapChannel with_id(const dalaran::components::ChannelId& _id) && {
        ...
        McapChannel with_many_id(const Collection<dalaran::components::ChannelId>& _id) && {
            id = ComponentBatch::from_loggable(_id, Descriptor_id).value_or_throw();
            return std::move(*this);
        }
        ...
        /// that categorize and organize different data streams.
        /// Topics are separate from Dalaran's entity paths, but they often can be mapped to them.
        McapChannel with_topic(const dalaran::components::Text& _topic) && {
        ...
        /// be used when logging a single row's worth of data.
        McapChannel with_many_topic(const Collection<dalaran::components::Text>& _topic) && {
            topic = ComponentBatch::from_loggable(_topic, Descriptor_topic).value_or_throw();
            return std::move(*this);
        }
        ...
        /// * `protobuf` - Protocol Buffers
        /// * `json` - JSON encoding
        McapChannel with_message_encoding(const dalaran::components::Text& _message_encoding) && {
            message_encoding =
        ...
        McapChannel with_many_message_encoding(
            const Collection<dalaran::components::Text>& _message_encoding
        ) && {
            message_encoding =
                ComponentBatch::from_loggable(_message_encoding, Descriptor_message_encoding)
                    .value_or_throw();
        ...
        /// This can include channel-specific configuration, description, units, coordinate frames,
        /// or any other contextual information that helps interpret the data in this channel.
        McapChannel with_metadata(const dalaran::components::KeyValuePairs& _metadata) && {
            metadata =
        ...
        /// be used when logging a single row's worth of data.
        McapChannel with_many_metadata(const Collection<dalaran::components::KeyValuePairs>& _metadata
        ) && {
            metadata =
                ComponentBatch::from_loggable(_metadata, Descriptor_metadata).value_or_throw();
            return std::move(*this);
