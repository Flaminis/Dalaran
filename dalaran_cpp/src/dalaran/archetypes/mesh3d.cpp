...
namespace dalaran::archetypes {
    Mesh3D Mesh3D::clear_fields() {
        ...
        archetype.vertex_positions =
            ComponentBatch::empty<dalaran::components::Position3D>(Descriptor_vertex_positions)
                .value_or_throw();
        archetype.triangle_indices =
            ComponentBatch::empty<dalaran::components::TriangleIndices>(Descriptor_triangle_indices)
                .value_or_throw();
        archetype.vertex_normals =
            ComponentBatch::empty<dalaran::components::Vector3D>(Descriptor_vertex_normals)
                .value_or_throw();
        archetype.vertex_colors =
            ComponentBatch::empty<dalaran::components::Color>(Descriptor_vertex_colors)
                .value_or_throw();
        archetype.vertex_texcoords =
            ComponentBatch::empty<dalaran::components::Texcoord2D>(Descriptor_vertex_texcoords)
                .value_or_throw();
        archetype.albedo_factor =
            ComponentBatch::empty<dalaran::components::AlbedoFactor>(Descriptor_albedo_factor)
                .value_or_throw();
        archetype.face_rendering =
            ComponentBatch::empty<dalaran::components::MeshFaceRendering>(Descriptor_face_rendering)
                .value_or_throw();
        archetype.albedo_texture_buffer =
            ComponentBatch::empty<dalaran::components::ImageBuffer>(Descriptor_albedo_texture_buffer)
                .value_or_throw();
        archetype.albedo_texture_format =
            ComponentBatch::empty<dalaran::components::ImageFormat>(Descriptor_albedo_texture_format)
                .value_or_throw();
        archetype.class_ids =
