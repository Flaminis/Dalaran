...
namespace dalaran::archetypes {
    ...
    DALARAN_SDK_EXPORT static const Transform3D IDENTITY;

    /// Invalid transformation.
    ///
    /// Applying this transform will cause this entity and the entire subtree not to be visualized.
    DALARAN_SDK_EXPORT static const Transform3D INVALID;
    ...
    /// Set the rotation component of the transform using the `dalaran::Rotation3D` utility.
    ...
    ///
    /// Applying this transform does not alter an entity's transformation.
    const Transform3D Transform3D::IDENTITY = Transform3D(dalaran::datatypes::Mat3x3::IDENTITY);

    /// Invalid transformation.
    ///
    /// Applying this transform will cause this entity and the entire subtree not to be visualized.
    const Transform3D Transform3D::INVALID = Transform3D(dalaran::datatypes::Mat3x3::INVALID);
