...
namespace dalaran::archetypes {
    ...
    struct GraphEdges {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.GraphEdges";

        /// `ComponentDescriptor` for the `edges` field.
        static constexpr auto Descriptor_edges = ComponentDescriptor(
            ArchetypeName, "GraphEdges:edges", Loggable<dalaran::components::GraphEdge>::ComponentType
        );
        ...
        static constexpr auto Descriptor_graph_type = ComponentDescriptor(
            ...
            Loggable<dalaran::components::GraphType>::ComponentType
        );
      ...
      public:
        ...
        explicit GraphEdges(Collection<dalaran::components::GraphEdge> _edges)
        ...
        /// A list of node tuples.
        GraphEdges with_edges(const Collection<dalaran::components::GraphEdge>& _edges) && {
        ...
        ///
        /// If no `components::GraphType` is provided, the graph is assumed to be undirected.
        GraphEdges with_graph_type(const dalaran::components::GraphType& _graph_type) && {
            graph_type =
        ...
        GraphEdges with_many_graph_type(const Collection<dalaran::components::GraphType>& _graph_type
        ) && {
            graph_type =
                ComponentBatch::from_loggable(_graph_type, Descriptor_graph_type).value_or_throw();
            return std::move(*this);
