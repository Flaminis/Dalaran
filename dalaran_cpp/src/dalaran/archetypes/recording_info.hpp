...
namespace dalaran::archetypes {
    ...
    struct RecordingInfo {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.RecordingInfo";
        ...
        static constexpr auto Descriptor_name = ComponentDescriptor(
            ArchetypeName, "RecordingInfo:name", Loggable<dalaran::components::Name>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// Should be an absolute time, i.e. relative to Unix Epoch.
        RecordingInfo with_start_time(const dalaran::components::Timestamp& _start_time) && {
            start_time =
        ...
        RecordingInfo with_many_start_time(
            const Collection<dalaran::components::Timestamp>& _start_time
        ) && {
            start_time =
                ComponentBatch::from_loggable(_start_time, Descriptor_start_time).value_or_throw();
            return std::move(*this);
        ...
        /// A user-chosen name for the recording.
        RecordingInfo with_name(const dalaran::components::Name& _name) && {
        ...
        /// be used when logging a single row's worth of data.
        RecordingInfo with_many_name(const Collection<dalaran::components::Name>& _name) && {
            name = ComponentBatch::from_loggable(_name, Descriptor_name).value_or_throw();
            return std::move(*this);
        }
