...
namespace dalaran::archetypes {
    ...
    struct VoxelGridMap {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.VoxelGridMap";
        ...
        static constexpr auto Descriptor_voxel_indices = ComponentDescriptor(
            ...
            Loggable<dalaran::components::VoxelIndex>::ComponentType
        );
        ...
        static constexpr auto Descriptor_voxel_size = ComponentDescriptor(
            ...
            Loggable<dalaran::components::VoxelSize>::ComponentType
        );
        ...
        static constexpr auto Descriptor_values = ComponentDescriptor(
            ...
            Loggable<dalaran::components::VoxelValue>::ComponentType
        );
        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "VoxelGridMap:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_opacity = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Opacity>::ComponentType
        );
      ...
      public:
        ...
        explicit VoxelGridMap(
            Collection<dalaran::components::VoxelIndex> _voxel_indices,
            dalaran::components::VoxelSize _voxel_size
        )
            : voxel_indices(
        ...
        VoxelGridMap with_voxel_indices(
            const Collection<dalaran::components::VoxelIndex>& _voxel_indices
        ) && {
        ...
        /// This defines the voxel size along the local grid X/Y/Z axes.
        /// Each dimension must be finite and positive.
        VoxelGridMap with_voxel_size(const dalaran::components::VoxelSize& _voxel_size) && {
            voxel_size =
        ...
        VoxelGridMap with_many_voxel_size(
            const Collection<dalaran::components::VoxelSize>& _voxel_size
        ) && {
            voxel_size =
                ComponentBatch::from_loggable(_voxel_size, Descriptor_voxel_size).value_or_throw();
            return std::move(*this);
        ...
        ///
        /// If explicit colors are not provided, values are mapped through `colormap` and `value_range`.
        VoxelGridMap with_values(const Collection<dalaran::components::VoxelValue>& _values) && {
        ...
        ///
        /// If set, these colors take precedence over color-mapped scalar values.
        VoxelGridMap with_colors(const Collection<dalaran::components::Color>& _colors) && {
        ...
        ///
        /// If not set, the minimum corner is placed at the origin of the map's parent coordinate frame.
        VoxelGridMap with_translation(const dalaran::components::Translation3D& _translation) && {
        ...
        /// Together with `components::Translation3D`, this defines the pose of the grid relative to the
        /// map's parent coordinate frame.
        VoxelGridMap with_quaternion(const dalaran::components::RotationQuat& _quaternion) && {
            quaternion =
        ...
        ///
        /// Defaults to 1.0 (fully opaque).
        VoxelGridMap with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        VoxelGridMap with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Defaults to `[0.0, 1.0]`.
        VoxelGridMap with_value_range(const dalaran::components::ValueRange& _value_range) && {
        ...
        VoxelGridMap with_many_value_range(
            const Collection<dalaran::components::ValueRange>& _value_range
        ) && {
            value_range = ComponentBatch::from_loggable(_value_range, Descriptor_value_range)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Defaults to Turbo.
        VoxelGridMap with_colormap(const dalaran::components::Colormap& _colormap) && {
            colormap =
        ...
        /// be used when logging a single row's worth of data.
        VoxelGridMap with_many_colormap(const Collection<dalaran::components::Colormap>& _colormap
        ) && {
            colormap =
                ComponentBatch::from_loggable(_colormap, Descriptor_colormap).value_or_throw();
            return std::move(*this);
