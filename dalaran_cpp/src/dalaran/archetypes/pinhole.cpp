...
namespace dalaran::archetypes {
    Pinhole Pinhole::clear_fields() {
        ...
        archetype.image_from_camera =
            ComponentBatch::empty<dalaran::components::PinholeProjection>(Descriptor_image_from_camera
            )
                .value_or_throw();
        archetype.resolution =
            ComponentBatch::empty<dalaran::components::Resolution>(Descriptor_resolution)
                .value_or_throw();
        archetype.camera_xyz =
            ComponentBatch::empty<dalaran::components::ViewCoordinates>(Descriptor_camera_xyz)
                .value_or_throw();
        ...
        archetype.image_plane_distance =
            ComponentBatch::empty<dalaran::components::ImagePlaneDistance>(
                Descriptor_image_plane_distance
            )
                .value_or_throw();
        archetype.color =
            ComponentBatch::empty<dalaran::components::Color>(Descriptor_color).value_or_throw();
        archetype.line_width =
            ComponentBatch::empty<dalaran::components::Radius>(Descriptor_line_width)
                .value_or_throw();
        return archetype;
    }
