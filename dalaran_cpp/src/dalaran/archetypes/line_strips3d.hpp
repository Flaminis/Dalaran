...
namespace dalaran::archetypes {
    ...
    struct LineStrips3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.LineStrips3D";
        ...
        static constexpr auto Descriptor_strips = ComponentDescriptor(
            ...
            Loggable<dalaran::components::LineStrip3D>::ComponentType
        );
        /// `ComponentDescriptor` for the `radii` field.
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "LineStrips3D:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "LineStrips3D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `labels` field.
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "LineStrips3D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
      ...
      public:
        ...
        explicit LineStrips3D(Collection<dalaran::components::LineStrip3D> _strips)
        ...
        /// All the actual 3D line strips that make up the batch.
        LineStrips3D with_strips(const Collection<dalaran::components::LineStrip3D>& _strips) && {
            strips = ComponentBatch::from_loggable(_strips, Descriptor_strips).value_or_throw();
            return std::move(*this);
        }

        /// Optional radii for the line strips.
        LineStrips3D with_radii(const Collection<dalaran::components::Radius>& _radii) && {
        ...
        ///
        /// The alpha channel is ignored.
        LineStrips3D with_colors(const Collection<dalaran::components::Color>& _colors) && {
        ...
        /// If there's a single label present, it will be placed at the center of the entity.
        /// Otherwise, each instance will have its own label.
        LineStrips3D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        LineStrips3D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        ///
        /// The `components::ClassId` provides colors and labels if not specified explicitly.
        LineStrips3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
