...
namespace dalaran::archetypes {
    ...
    struct StateChange {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.StateChange";

        /// `ComponentDescriptor` for the `state` field.
        static constexpr auto Descriptor_state = ComponentDescriptor(
            ArchetypeName, "StateChange:state", Loggable<dalaran::components::Text>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// The length of the state array should not change over time.
        StateChange with_state(const Collection<dalaran::components::Text>& _state) && {
