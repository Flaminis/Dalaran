...
namespace dalaran::archetypes {
    SeriesLines SeriesLines::clear_fields() {
        ...
        archetype.widths = ComponentBatch::empty<dalaran::components::StrokeWidth>(Descriptor_widths)
                               .value_or_throw();
        archetype.names =
            ComponentBatch::empty<dalaran::components::Name>(Descriptor_names).value_or_throw();
        archetype.visible_series =
            ComponentBatch::empty<dalaran::components::Visible>(Descriptor_visible_series)
                .value_or_throw();
        archetype.aggregation_policy = ComponentBatch::empty<dalaran::components::AggregationPolicy>(
                                           Descriptor_aggregation_policy
        )
                                           .value_or_throw();
        archetype.interpolation_mode = ComponentBatch::empty<dalaran::components::InterpolationMode>(
