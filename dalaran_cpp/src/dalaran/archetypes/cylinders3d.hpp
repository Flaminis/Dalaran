...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/cylinders3d.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Cylinders3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Cylinders3D";

        /// `ComponentDescriptor` for the `lengths` field.
        static constexpr auto Descriptor_lengths = ComponentDescriptor(
            ArchetypeName, "Cylinders3D:lengths", Loggable<dalaran::components::Length>::ComponentType
        );
        /// `ComponentDescriptor` for the `radii` field.
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "Cylinders3D:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
        ...
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "Cylinders3D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "Cylinders3D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
      ...
      public: // START of extensions from cylinders3d_ext.cpp:
        ...
        static Cylinders3D from_lengths_and_radii(
            const Collection<dalaran::components::Length>& lengths,
            const Collection<dalaran::components::Radius>& radii
        ) {
      ...
      public:
        ...
        /// The total axial length of the cylinder, measured as the straight-line distance between the centers of its two endcaps.
        Cylinders3D with_lengths(const Collection<dalaran::components::Length>& _lengths) && {
            lengths = ComponentBatch::from_loggable(_lengths, Descriptor_lengths).value_or_throw();
            return std::move(*this);
        }

        /// Radii of the cylinders.
        Cylinders3D with_radii(const Collection<dalaran::components::Radius>& _radii) && {
        ...
        ///
        /// If not specified, each cylinder will be centered at (0, 0, 0).
        Cylinders3D with_centers(const Collection<dalaran::components::Translation3D>& _centers) && {
        ...
        ///
        /// If no rotation is specified, the cylinders align with the +Z axis of the local coordinate system.
        Cylinders3D with_quaternions(const Collection<dalaran::components::RotationQuat>& _quaternions
        ) && {
        ...
        ///
        /// Alpha channel is used for transparency for solid fill-mode.
        Cylinders3D with_colors(const Collection<dalaran::components::Color>& _colors) && {
            colors = ComponentBatch::from_loggable(_colors, Descriptor_colors).value_or_throw();
            return std::move(*this);
        }

        /// Optional radii for the lines used when the cylinder is rendered as a wireframe.
        Cylinders3D with_line_radii(const Collection<dalaran::components::Radius>& _line_radii) && {
            line_radii =
        ...
        /// Optionally choose whether the cylinders are drawn with lines or solid.
        Cylinders3D with_fill_mode(const dalaran::components::FillMode& _fill_mode) && {
            fill_mode =
        ...
        Cylinders3D with_many_fill_mode(const Collection<dalaran::components::FillMode>& _fill_mode
        ) && {
            fill_mode =
                ComponentBatch::from_loggable(_fill_mode, Descriptor_fill_mode).value_or_throw();
            return std::move(*this);
        ...
        /// Optional text labels for the cylinders, which will be located at their centers.
        Cylinders3D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        Cylinders3D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        ///
        /// The class ID provides colors and labels if not specified explicitly.
        Cylinders3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
