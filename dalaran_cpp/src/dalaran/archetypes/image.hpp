...
namespace dalaran::archetypes {
    ...
    ///
    /// Dalaran also supports compressed images (JPEG, PNG, …), using `archetypes::EncodedImage`.
    ...
    ///
    /// Since the underlying [dalaran::components::Blob] uses `dalaran::Collection` internally,
    ...
    struct Image {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Image";

        /// `ComponentDescriptor` for the `buffer` field.
        static constexpr auto Descriptor_buffer = ComponentDescriptor(
            ArchetypeName, "Image:buffer", Loggable<dalaran::components::ImageBuffer>::ComponentType
        );
        /// `ComponentDescriptor` for the `format` field.
        static constexpr auto Descriptor_format = ComponentDescriptor(
            ArchetypeName, "Image:format", Loggable<dalaran::components::ImageFormat>::ComponentType
        );
        /// `ComponentDescriptor` for the `opacity` field.
        static constexpr auto Descriptor_opacity = ComponentDescriptor(
            ArchetypeName, "Image:opacity", Loggable<dalaran::components::Opacity>::ComponentType
        );
        /// `ComponentDescriptor` for the `draw_order` field.
        static constexpr auto Descriptor_draw_order = ComponentDescriptor(
            ArchetypeName, "Image:draw_order", Loggable<dalaran::components::DrawOrder>::ComponentType
        );
      ...
      public:
        ...
        /// The raw image data.
        Image with_buffer(const dalaran::components::ImageBuffer& _buffer) && {
        ...
        Image with_many_buffer(const Collection<dalaran::components::ImageBuffer>& _buffer) && {
            buffer = ComponentBatch::from_loggable(_buffer, Descriptor_buffer).value_or_throw();
            return std::move(*this);
        }

        /// The format of the image.
        Image with_format(const dalaran::components::ImageFormat& _format) && {
        ...
        /// be used when logging a single row's worth of data.
        Image with_many_format(const Collection<dalaran::components::ImageFormat>& _format) && {
            format = ComponentBatch::from_loggable(_format, Descriptor_format).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Defaults to 1.0 (fully opaque).
        Image with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        Image with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        /// Objects with higher values are drawn on top of those with lower values.
        /// Defaults to `-10.0`.
        Image with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
        ...
        /// be used when logging a single row's worth of data.
        Image with_many_draw_order(const Collection<dalaran::components::DrawOrder>& _draw_order) && {
            draw_order =
                ComponentBatch::from_loggable(_draw_order, Descriptor_draw_order).value_or_throw();
            return std::move(*this);
        }
