...
namespace dalaran::archetypes {
    ...
    struct CoordinateFrame {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.CoordinateFrame";
      ...
      public:
        ...
        explicit CoordinateFrame(dalaran::components::TransformFrameId _frame)
        ...
        ///
        /// Note that empty strings are not valid transform frame IDs.
        CoordinateFrame with_frame(const dalaran::components::TransformFrameId& _frame) && {
        ...
        CoordinateFrame with_many_frame(
            const Collection<dalaran::components::TransformFrameId>& _frame
        ) && {
            frame = ComponentBatch::from_loggable(_frame, Descriptor_frame).value_or_throw();
            return std::move(*this);
        }
