...
namespace dalaran::archetypes {
    ...
    struct McapMessage {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.McapMessage";

        /// `ComponentDescriptor` for the `data` field.
        static constexpr auto Descriptor_data = ComponentDescriptor(
            ArchetypeName, "McapMessage:data", Loggable<dalaran::components::Blob>::ComponentType
        );
      ...
      public:
        ...
        explicit McapMessage(dalaran::components::Blob _data)
        ...
        /// of this binary data depends on the encoding format (e.g., ros1, cdr, protobuf)
        /// and the message schema defined for the channel.
        McapMessage with_data(const dalaran::components::Blob& _data) && {
        ...
        McapMessage with_many_data(const Collection<dalaran::components::Blob>& _data) && {
            data = ComponentBatch::from_loggable(_data, Descriptor_data).value_or_throw();
            return std::move(*this);
        }
