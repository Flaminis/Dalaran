...
namespace dalaran::archetypes {
    ...
    struct SeriesPoints {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.SeriesPoints";

        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "SeriesPoints:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_markers = ComponentDescriptor(
            ...
            Loggable<dalaran::components::MarkerShape>::ComponentType
        );
        /// `ComponentDescriptor` for the `names` field.
        static constexpr auto Descriptor_names = ComponentDescriptor(
            ArchetypeName, "SeriesPoints:names", Loggable<dalaran::components::Name>::ComponentType
        );
        ...
        static constexpr auto Descriptor_marker_sizes = ComponentDescriptor(
            ...
            Loggable<dalaran::components::MarkerSize>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// May change over time, but can cause discontinuities in the line.
        SeriesPoints with_colors(const Collection<dalaran::components::Color>& _colors) && {
        ...
        ///
        /// May change over time.
        SeriesPoints with_markers(const Collection<dalaran::components::MarkerShape>& _markers) && {
        ...
        ///
        /// Used in the legend. Expected to be unchanging over time.
        SeriesPoints with_names(const Collection<dalaran::components::Name>& _names) && {
        ...
        SeriesPoints with_marker_sizes(
            const Collection<dalaran::components::MarkerSize>& _marker_sizes
        ) && {
