...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/encoded_image.fbs".
...
namespace dalaran::archetypes {
    ...
    struct EncodedImage {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.EncodedImage";

        /// `ComponentDescriptor` for the `blob` field.
        static constexpr auto Descriptor_blob = ComponentDescriptor(
            ArchetypeName, "EncodedImage:blob", Loggable<dalaran::components::Blob>::ComponentType
        );
      ...
      public:
        ...
        /// The encoded content of some image file, e.g. a PNG or JPEG.
        EncodedImage with_blob(const dalaran::components::Blob& _blob) && {
        ...
        EncodedImage with_many_blob(const Collection<dalaran::components::Blob>& _blob) && {
            blob = ComponentBatch::from_loggable(_blob, Descriptor_blob).value_or_throw();
            return std::move(*this);
        }
        ...
        /// If omitted, the viewer will try to guess from the data blob.
        /// If it cannot guess, it won't be able to render the asset.
        EncodedImage with_media_type(const dalaran::components::MediaType& _media_type) && {
            media_type =
        ...
        ///
        /// Defaults to 1.0 (fully opaque).
        EncodedImage with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        EncodedImage with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Objects with higher values are drawn on top of those with lower values.
        EncodedImage with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
