...
namespace dalaran::archetypes {
    ...
    struct TransformAxes3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.TransformAxes3D";
        ...
        static constexpr auto Descriptor_axis_length = ComponentDescriptor(
            ...
            Loggable<dalaran::components::AxisLength>::ComponentType
        );
      ...
      public:
        ...
        explicit TransformAxes3D(dalaran::components::AxisLength _axis_length)
            : axis_length(
        ...
        /// The length is interpreted in the local coordinate system of the transform.
        /// If the transform is scaled, the axes will be scaled accordingly.
        TransformAxes3D with_axis_length(const dalaran::components::AxisLength& _axis_length) && {
        ...
        TransformAxes3D with_many_axis_length(
            const Collection<dalaran::components::AxisLength>& _axis_length
        ) && {
            axis_length = ComponentBatch::from_loggable(_axis_length, Descriptor_axis_length)
                              .value_or_throw();
            return std::move(*this);
        ...
        /// Whether to show a text label with the corresponding frame.
        TransformAxes3D with_show_frame(const dalaran::components::ShowLabels& _show_frame) && {
            show_frame =
        ...
        TransformAxes3D with_many_show_frame(
            const Collection<dalaran::components::ShowLabels>& _show_frame
        ) && {
            show_frame =
                ComponentBatch::from_loggable(_show_frame, Descriptor_show_frame).value_or_throw();
            return std::move(*this);
