...
namespace dalaran::archetypes {
    Points3D Points3D::clear_fields() {
        ...
        archetype.positions =
            ComponentBatch::empty<dalaran::components::Position3D>(Descriptor_positions)
                .value_or_throw();
        archetype.radii =
        ...
        archetype.point_shading =
            ComponentBatch::empty<dalaran::components::PointShading>(Descriptor_point_shading)
                .value_or_throw();
        archetype.class_ids =
            ComponentBatch::empty<dalaran::components::ClassId>(Descriptor_class_ids)
                .value_or_throw();
        archetype.keypoint_ids =
            ComponentBatch::empty<dalaran::components::KeypointId>(Descriptor_keypoint_ids)
                .value_or_throw();
        return archetype;
    }
