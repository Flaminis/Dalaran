...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/mesh3d.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Mesh3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Mesh3D";
        ...
        static constexpr auto Descriptor_vertex_positions = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Position3D>::ComponentType
        );
        ...
        static constexpr auto Descriptor_triangle_indices = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TriangleIndices>::ComponentType
        );
        ...
        static constexpr auto Descriptor_vertex_normals = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Vector3D>::ComponentType
        );
        /// `ComponentDescriptor` for the `vertex_colors` field.
        static constexpr auto Descriptor_vertex_colors = ComponentDescriptor(
            ArchetypeName, "Mesh3D:vertex_colors", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_vertex_texcoords = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Texcoord2D>::ComponentType
        );
        ...
        static constexpr auto Descriptor_albedo_factor = ComponentDescriptor(
            ...
            Loggable<dalaran::components::AlbedoFactor>::ComponentType
        );
        ...
        static constexpr auto Descriptor_face_rendering = ComponentDescriptor(
            ...
            Loggable<dalaran::components::MeshFaceRendering>::ComponentType
        );
        ...
        static constexpr auto Descriptor_class_ids = ComponentDescriptor(
            ArchetypeName, "Mesh3D:class_ids", Loggable<dalaran::components::ClassId>::ComponentType
        );
      ...
      public:
        ...
        explicit Mesh3D(Collection<dalaran::components::Position3D> _vertex_positions)
        ...
        Mesh3D with_vertex_positions(
            const Collection<dalaran::components::Position3D>& _vertex_positions
        ) && {
            vertex_positions =
        ...
        Mesh3D with_triangle_indices(
            const Collection<dalaran::components::TriangleIndices>& _triangle_indices
        ) && {
            triangle_indices =
        ...
        /// An optional normal for each vertex.
        Mesh3D with_vertex_normals(const Collection<dalaran::components::Vector3D>& _vertex_normals
        ) && {
            vertex_normals =
        ...
        ///
        /// The alpha channel is ignored.
        Mesh3D with_vertex_colors(const Collection<dalaran::components::Color>& _vertex_colors) && {
        ...
        Mesh3D with_vertex_texcoords(
            const Collection<dalaran::components::Texcoord2D>& _vertex_texcoords
        ) && {
            vertex_texcoords =
        ...
        ///
        /// Alpha channel governs the overall mesh transparency.
        Mesh3D with_albedo_factor(const dalaran::components::AlbedoFactor& _albedo_factor) && {
        ...
        Mesh3D with_many_albedo_factor(
            const Collection<dalaran::components::AlbedoFactor>& _albedo_factor
        ) && {
            albedo_factor = ComponentBatch::from_loggable(_albedo_factor, Descriptor_albedo_factor)
                                .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// The default is `components::MeshFaceRendering::DoubleSided`, meaning both front and back faces are shown.
        Mesh3D with_face_rendering(const dalaran::components::MeshFaceRendering& _face_rendering) && {
            face_rendering =
        ...
        Mesh3D with_many_face_rendering(
            const Collection<dalaran::components::MeshFaceRendering>& _face_rendering
        ) && {
            face_rendering =
                ComponentBatch::from_loggable(_face_rendering, Descriptor_face_rendering)
                    .value_or_throw();
        ...
        Mesh3D with_albedo_texture_buffer(
            const dalaran::components::ImageBuffer& _albedo_texture_buffer
        ) && {
        ...
        Mesh3D with_many_albedo_texture_buffer(
            const Collection<dalaran::components::ImageBuffer>& _albedo_texture_buffer
        ) && {
            albedo_texture_buffer = ComponentBatch::from_loggable(
                                        _albedo_texture_buffer,
                                        Descriptor_albedo_texture_buffer
        ...
        Mesh3D with_albedo_texture_format(
            const dalaran::components::ImageFormat& _albedo_texture_format
        ) && {
        ...
        Mesh3D with_many_albedo_texture_format(
            const Collection<dalaran::components::ImageFormat>& _albedo_texture_format
        ) && {
            albedo_texture_format = ComponentBatch::from_loggable(
                                        _albedo_texture_format,
                                        Descriptor_albedo_texture_format
        ...
        ///
        /// The `components::ClassId` provides colors and labels if not specified explicitly.
        Mesh3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
