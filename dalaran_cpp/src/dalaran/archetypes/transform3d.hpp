...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/transform3d.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Transform3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Transform3D";
        ...
        static constexpr auto Descriptor_scale = ComponentDescriptor(
            ArchetypeName, "Transform3D:scale", Loggable<dalaran::components::Scale3D>::ComponentType
        );
        ...
        static constexpr auto Descriptor_relation = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TransformRelation>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_translation(const dalaran::components::Translation3D& _translation) && {
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_quaternion(const dalaran::components::RotationQuat& _quaternion) && {
            quaternion =
        ...
        Transform3D with_many_quaternion(
            const Collection<dalaran::components::RotationQuat>& _quaternion
        ) && {
            quaternion =
                ComponentBatch::from_loggable(_quaternion, Descriptor_quaternion).value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_scale(const dalaran::components::Scale3D& _scale) && {
        ...
        /// be used when logging a single row's worth of data.
        Transform3D with_many_scale(const Collection<dalaran::components::Scale3D>& _scale) && {
            scale = ComponentBatch::from_loggable(_scale, Descriptor_scale).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_mat3x3(const dalaran::components::TransformMat3x3& _mat3x3) && {
        ...
        /// be used when logging a single row's worth of data.
        Transform3D with_many_mat3x3(const Collection<dalaran::components::TransformMat3x3>& _mat3x3
        ) && {
            mat3x3 = ComponentBatch::from_loggable(_mat3x3, Descriptor_mat3x3).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_relation(const dalaran::components::TransformRelation& _relation) && {
            relation =
        ...
        Transform3D with_many_relation(
            const Collection<dalaran::components::TransformRelation>& _relation
        ) && {
            relation =
                ComponentBatch::from_loggable(_relation, Descriptor_relation).value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_child_frame(const dalaran::components::TransformFrameId& _child_frame) && {
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Transform3D with_parent_frame(const dalaran::components::TransformFrameId& _parent_frame) && {
