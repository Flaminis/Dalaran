...
namespace dalaran::archetypes {
    McapStatistics McapStatistics::clear_fields() {
        ...
        archetype.message_count =
            ComponentBatch::empty<dalaran::components::Count>(Descriptor_message_count)
                .value_or_throw();
        archetype.schema_count =
            ComponentBatch::empty<dalaran::components::Count>(Descriptor_schema_count)
                .value_or_throw();
        archetype.channel_count =
            ComponentBatch::empty<dalaran::components::Count>(Descriptor_channel_count)
                .value_or_throw();
        archetype.attachment_count =
            ComponentBatch::empty<dalaran::components::Count>(Descriptor_attachment_count)
                .value_or_throw();
        archetype.metadata_count =
            ComponentBatch::empty<dalaran::components::Count>(Descriptor_metadata_count)
                .value_or_throw();
        archetype.chunk_count =
            ComponentBatch::empty<dalaran::components::Count>(Descriptor_chunk_count)
                .value_or_throw();
        archetype.message_start_time =
            ComponentBatch::empty<dalaran::components::Timestamp>(Descriptor_message_start_time)
                .value_or_throw();
        archetype.message_end_time =
            ComponentBatch::empty<dalaran::components::Timestamp>(Descriptor_message_end_time)
                .value_or_throw();
        archetype.channel_message_counts =
            ComponentBatch::empty<dalaran::components::ChannelMessageCounts>(
