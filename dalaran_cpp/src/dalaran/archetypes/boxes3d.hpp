...
namespace dalaran::archetypes {
    ...
    struct Boxes3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Boxes3D";
        ...
        static constexpr auto Descriptor_half_sizes = ComponentDescriptor(
            ...
            Loggable<dalaran::components::HalfSize3D>::ComponentType
        );
        ...
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "Boxes3D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `radii` field.
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "Boxes3D:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
        /// `ComponentDescriptor` for the `fill_mode` field.
        static constexpr auto Descriptor_fill_mode = ComponentDescriptor(
            ArchetypeName, "Boxes3D:fill_mode", Loggable<dalaran::components::FillMode>::ComponentType
        );
        /// `ComponentDescriptor` for the `labels` field.
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "Boxes3D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
        ...
        static constexpr auto Descriptor_class_ids = ComponentDescriptor(
            ArchetypeName, "Boxes3D:class_ids", Loggable<dalaran::components::ClassId>::ComponentType
        );
      ...
      public:
        ...
        /// All half-extents that make up the batch of boxes.
        Boxes3D with_half_sizes(const Collection<dalaran::components::HalfSize3D>& _half_sizes) && {
            half_sizes =
        ...
        ///
        /// If not specified, the centers will be at (0, 0, 0).
        Boxes3D with_centers(const Collection<dalaran::components::Translation3D>& _centers) && {
        ...
        ///
        /// If no rotation is specified, the axes of the boxes align with the axes of the local coordinate system.
        Boxes3D with_quaternions(const Collection<dalaran::components::RotationQuat>& _quaternions
        ) && {
        ...
        ///
        /// Alpha channel is used for transparency for solid fill-mode.
        Boxes3D with_colors(const Collection<dalaran::components::Color>& _colors) && {
            colors = ComponentBatch::from_loggable(_colors, Descriptor_colors).value_or_throw();
            return std::move(*this);
        }

        /// Optional radii for the lines that make up the boxes.
        Boxes3D with_radii(const Collection<dalaran::components::Radius>& _radii) && {
            radii = ComponentBatch::from_loggable(_radii, Descriptor_radii).value_or_throw();
            return std::move(*this);
        }

        /// Optionally choose whether the boxes are drawn with lines or solid.
        Boxes3D with_fill_mode(const dalaran::components::FillMode& _fill_mode) && {
            fill_mode =
        ...
        Boxes3D with_many_fill_mode(const Collection<dalaran::components::FillMode>& _fill_mode) && {
            fill_mode =
                ComponentBatch::from_loggable(_fill_mode, Descriptor_fill_mode).value_or_throw();
            return std::move(*this);
        }
        ...
        /// If there's a single label present, it will be placed at the center of the entity.
        /// Otherwise, each instance will have its own label.
        Boxes3D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        Boxes3D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        /// be used when logging a single row's worth of data.
        Boxes3D with_many_show_labels(const Collection<dalaran::components::ShowLabels>& _show_labels
        ) && {
            show_labels = ComponentBatch::from_loggable(_show_labels, Descriptor_show_labels)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// The `components::ClassId` provides colors and labels if not specified explicitly.
        Boxes3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
