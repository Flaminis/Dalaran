...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/video_stream.fbs".
...
namespace dalaran::archetypes {
    ...
    struct VideoStream {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.VideoStream";
        ...
        static constexpr auto Descriptor_codec = ComponentDescriptor(
            ...
            Loggable<dalaran::components::VideoCodec>::ComponentType
        );
        ...
        static constexpr auto Descriptor_sample = ComponentDescriptor(
            ...
            Loggable<dalaran::components::VideoSample>::ComponentType
        );
        ...
        static constexpr auto Descriptor_is_keyframe = ComponentDescriptor(
            ...
            Loggable<dalaran::components::IsKeyframe>::ComponentType
        );
      ...
      public:
        ...
        explicit VideoStream(dalaran::components::VideoCodec _codec)
        ...
        ///
        /// This property is expected to be constant over time and is ideally logged statically once per stream.
        VideoStream with_codec(const dalaran::components::VideoCodec& _codec) && {
        ...
        VideoStream with_many_codec(const Collection<dalaran::components::VideoCodec>& _codec) && {
            codec = ComponentBatch::from_loggable(_codec, Descriptor_codec).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// See `components::VideoCodec` for codec specific requirements.
        VideoStream with_sample(const dalaran::components::VideoSample& _sample) && {
        ...
        /// be used when logging a single row's worth of data.
        VideoStream with_many_sample(const Collection<dalaran::components::VideoSample>& _sample) && {
            sample = ComponentBatch::from_loggable(_sample, Descriptor_sample).value_or_throw();
            return std::move(*this);
        }
        ...
        /// metadata that travels with the sample and can be inspected when querying the data
        /// back, for example to locate sync points or build a frame index.
        VideoStream with_is_keyframe(const dalaran::components::IsKeyframe& _is_keyframe) && {
        ...
        VideoStream with_many_is_keyframe(
            const Collection<dalaran::components::IsKeyframe>& _is_keyframe
        ) && {
            is_keyframe = ComponentBatch::from_loggable(_is_keyframe, Descriptor_is_keyframe)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Defaults to 1.0 (fully opaque).
        VideoStream with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        VideoStream with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        /// Objects with higher values are drawn on top of those with lower values.
        /// Defaults to `-15.0`.
        VideoStream with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
        ...
        /// be used when logging a single row's worth of data.
        VideoStream with_many_draw_order(const Collection<dalaran::components::DrawOrder>& _draw_order
        ) && {
            draw_order =
                ComponentBatch::from_loggable(_draw_order, Descriptor_draw_order).value_or_throw();
            return std::move(*this);
