...
namespace dalaran::archetypes {
    ...
    /// If the data does not outlive the image, use `std::move` or create the `dalaran::Collection`
    /// explicitly ahead of time with `dalaran::Collection::take_ownership`.
    ...
    ///
    /// @param elements Pixel data as a `dalaran::Collection`.
    /// If the data does not outlive the image, use `std::move` or create the `dalaran::Collection`
    /// explicitly ahead of time with `dalaran::Collection::take_ownership`.
    ...
    ///
    /// @param bytes Pixel data as a `dalaran::Collection`.
    /// If the data does not outlive the image, use `std::move` or create the `dalaran::Collection`
    /// explicitly ahead of time with `dalaran::Collection::take_ownership`.
