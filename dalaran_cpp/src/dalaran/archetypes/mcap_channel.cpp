...
namespace dalaran::archetypes {
    McapChannel McapChannel::clear_fields() {
        ...
        archetype.id =
            ComponentBatch::empty<dalaran::components::ChannelId>(Descriptor_id).value_or_throw();
        archetype.topic =
            ComponentBatch::empty<dalaran::components::Text>(Descriptor_topic).value_or_throw();
        archetype.message_encoding =
            ComponentBatch::empty<dalaran::components::Text>(Descriptor_message_encoding)
                .value_or_throw();
        archetype.metadata =
            ComponentBatch::empty<dalaran::components::KeyValuePairs>(Descriptor_metadata)
                .value_or_throw();
        return archetype;
    }
