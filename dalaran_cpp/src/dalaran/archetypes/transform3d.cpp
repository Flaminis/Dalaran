    ...
    Transform3D Transform3D::clear_fields() {
        ...
        archetype.quaternion =
            ComponentBatch::empty<dalaran::components::RotationQuat>(Descriptor_quaternion)
                .value_or_throw();
        archetype.scale =
            ComponentBatch::empty<dalaran::components::Scale3D>(Descriptor_scale).value_or_throw();
        archetype.mat3x3 =
            ComponentBatch::empty<dalaran::components::TransformMat3x3>(Descriptor_mat3x3)
                .value_or_throw();
        archetype.relation =
            ComponentBatch::empty<dalaran::components::TransformRelation>(Descriptor_relation)
                .value_or_throw();
        archetype.child_frame =
            ComponentBatch::empty<dalaran::components::TransformFrameId>(Descriptor_child_frame)
                .value_or_throw();
        archetype.parent_frame =
            ComponentBatch::empty<dalaran::components::TransformFrameId>(Descriptor_parent_frame)
                .value_or_throw();
        return archetype;
    }
