...
namespace dalaran::archetypes {
    TextLog TextLog::clear_fields() {
        ...
        archetype.text =
            ComponentBatch::empty<dalaran::components::Text>(Descriptor_text).value_or_throw();
        archetype.level = ComponentBatch::empty<dalaran::components::TextLogLevel>(Descriptor_level)
                              .value_or_throw();
        archetype.color =
