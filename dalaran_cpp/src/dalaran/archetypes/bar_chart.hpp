...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/bar_chart.fbs".
...
namespace dalaran::archetypes {
    ...
    struct BarChart {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.BarChart";

        /// `ComponentDescriptor` for the `values` field.
        static constexpr auto Descriptor_values = ComponentDescriptor(
            ArchetypeName, "BarChart:values", Loggable<dalaran::components::TensorData>::ComponentType
        );
        /// `ComponentDescriptor` for the `color` field.
        static constexpr auto Descriptor_color = ComponentDescriptor(
            ArchetypeName, "BarChart:color", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_abscissa = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TensorData>::ComponentType
        );
        /// `ComponentDescriptor` for the `widths` field.
        static constexpr auto Descriptor_widths = ComponentDescriptor(
            ArchetypeName, "BarChart:widths", Loggable<dalaran::components::Length>::ComponentType
        );
      ...
      public: // START of extensions from bar_chart_ext.cpp:
        ...
        BarChart(Collection<int8_t> i8)
            : BarChart(dalaran::datatypes::TensorBuffer::i8(std::move(i8))) {}
      ...
      public:
        ...
        explicit BarChart(dalaran::components::TensorData _values)
        ...
        /// The values. Should always be a 1-dimensional tensor (i.e. a vector).
        BarChart with_values(const dalaran::components::TensorData& _values) && {
        ...
        BarChart with_many_values(const Collection<dalaran::components::TensorData>& _values) && {
            values = ComponentBatch::from_loggable(_values, Descriptor_values).value_or_throw();
            return std::move(*this);
        }

        /// The color of the bar chart
        BarChart with_color(const dalaran::components::Color& _color) && {
        ...
        /// be used when logging a single row's worth of data.
        BarChart with_many_color(const Collection<dalaran::components::Color>& _color) && {
            color = ComponentBatch::from_loggable(_color, Descriptor_color).value_or_throw();
            return std::move(*this);
        }

        /// The abscissa corresponding to each value. Should be a 1-dimensional tensor (i.e. a vector) in same length as values.
        BarChart with_abscissa(const dalaran::components::TensorData& _abscissa) && {
            abscissa =
        ...
        /// be used when logging a single row's worth of data.
        BarChart with_many_abscissa(const Collection<dalaran::components::TensorData>& _abscissa) && {
            abscissa =
                ComponentBatch::from_loggable(_abscissa, Descriptor_abscissa).value_or_throw();
            return std::move(*this);
        }
        ...
        /// The width of the bins, defined in x-axis units and defaults to 1. Should be a 1-dimensional tensor (i.e. a vector) in same length as values.
        BarChart with_widths(const Collection<dalaran::components::Length>& _widths) && {
