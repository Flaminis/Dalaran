...
namespace dalaran::archetypes {
    ...
    struct GraphNodes {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.GraphNodes";
        ...
        static constexpr auto Descriptor_node_ids = ComponentDescriptor(
            ...
            Loggable<dalaran::components::GraphNode>::ComponentType
        );
        ...
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "GraphNodes:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `labels` field.
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "GraphNodes:labels", Loggable<dalaran::components::Text>::ComponentType
        );
        ...
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "GraphNodes:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
      ...
      public:
        ...
        explicit GraphNodes(Collection<dalaran::components::GraphNode> _node_ids)
        ...
        /// A list of node IDs.
        GraphNodes with_node_ids(const Collection<dalaran::components::GraphNode>& _node_ids) && {
            node_ids =
        ...
        /// Optional center positions of the nodes.
        GraphNodes with_positions(const Collection<dalaran::components::Position2D>& _positions) && {
            positions =
        ...
        /// Optional colors for the boxes.
        GraphNodes with_colors(const Collection<dalaran::components::Color>& _colors) && {
            colors = ComponentBatch::from_loggable(_colors, Descriptor_colors).value_or_throw();
            return std::move(*this);
        }

        /// Optional text labels for the node.
        GraphNodes with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        GraphNodes with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        /// Optional radii for nodes.
        GraphNodes with_radii(const Collection<dalaran::components::Radius>& _radii) && {
