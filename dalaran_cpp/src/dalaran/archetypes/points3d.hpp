...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/points3d.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Points3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Points3D";
        ...
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "Points3D:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "Points3D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `labels` field.
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "Points3D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
        ...
        static constexpr auto Descriptor_point_shading = ComponentDescriptor(
            ...
            Loggable<dalaran::components::PointShading>::ComponentType
        );
        /// `ComponentDescriptor` for the `class_ids` field.
        static constexpr auto Descriptor_class_ids = ComponentDescriptor(
            ArchetypeName, "Points3D:class_ids", Loggable<dalaran::components::ClassId>::ComponentType
        );
      ...
      public:
        ...
        explicit Points3D(Collection<dalaran::components::Position3D> _positions)
        ...
        /// All the 3D positions at which the point cloud shows points.
        Points3D with_positions(const Collection<dalaran::components::Position3D>& _positions) && {
            positions =
        ...
        /// Optional radii for the points, effectively turning them into circles.
        Points3D with_radii(const Collection<dalaran::components::Radius>& _radii) && {
        ...
        /// By default, the alpha channel affects brightness rather than transparency.
        /// TODO(#1611): To use the alpha channel for transparency, enable the experimental "Transparent point clouds" feature flag.
        Points3D with_colors(const Collection<dalaran::components::Color>& _colors) && {
        ...
        /// If there's a single label present, it will be placed at the center of the entity.
        /// Otherwise, each instance will have its own label.
        Points3D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        Points3D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        Points3D with_many_show_labels(const Collection<dalaran::components::ShowLabels>& _show_labels
        ) && {
            show_labels = ComponentBatch::from_loggable(_show_labels, Descriptor_show_labels)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// If not set, points are rendered with `components::PointShading::Gradient` by default.
        Points3D with_point_shading(const dalaran::components::PointShading& _point_shading) && {
        ...
        Points3D with_many_point_shading(
            const Collection<dalaran::components::PointShading>& _point_shading
        ) && {
            point_shading = ComponentBatch::from_loggable(_point_shading, Descriptor_point_shading)
                                .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// The `components::ClassId` provides colors and labels if not specified explicitly.
        Points3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
        ...
        /// E.g. the classification might be 'Person' and the keypoints refer to joints on a
        /// detected skeleton.
        Points3D with_keypoint_ids(const Collection<dalaran::components::KeypointId>& _keypoint_ids
        ) && {
