...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/segmentation_image.fbs".
...
namespace dalaran::archetypes {
    ...
    ///
    /// Since the underlying `dalaran::datatypes::TensorData` uses `dalaran::Collection` internally,
    ...
    struct SegmentationImage {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.SegmentationImage";
      ...
      public:
        ...
        /// The raw image data.
        SegmentationImage with_buffer(const dalaran::components::ImageBuffer& _buffer) && {
        ...
        SegmentationImage with_many_buffer(const Collection<dalaran::components::ImageBuffer>& _buffer
        ) && {
            buffer = ComponentBatch::from_loggable(_buffer, Descriptor_buffer).value_or_throw();
            return std::move(*this);
        }
        ...
        /// The format of the image.
        SegmentationImage with_format(const dalaran::components::ImageFormat& _format) && {
        ...
        /// be used when logging a single row's worth of data.
        SegmentationImage with_many_format(const Collection<dalaran::components::ImageFormat>& _format
        ) && {
            format = ComponentBatch::from_loggable(_format, Descriptor_format).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Defaults to 0.5 if there's any other images in the scene, otherwise 1.0.
        SegmentationImage with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        SegmentationImage with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity
        ) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        /// Objects with higher values are drawn on top of those with lower values.
        /// Defaults to `0.0`.
        SegmentationImage with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
