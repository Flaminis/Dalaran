...
namespace dalaran::archetypes {
    GaussianSplats3D GaussianSplats3D::clear_fields() {
        ...
        archetype.centers = ComponentBatch::empty<dalaran::components::Position3D>(Descriptor_centers)
                                .value_or_throw();
        archetype.scales =
            ComponentBatch::empty<dalaran::components::Scale3D>(Descriptor_scales).value_or_throw();
        ...
        archetype.sh_coefficients =
            ComponentBatch::empty<dalaran::components::SphericalHarmonics3Rgb>(
                Descriptor_sh_coefficients
            )
                .value_or_throw();
        archetype.spherical_harmonics_degree =
            ComponentBatch::empty<dalaran::components::SphericalHarmonicsDegree>(
