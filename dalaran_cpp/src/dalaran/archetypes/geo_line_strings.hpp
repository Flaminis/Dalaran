...
namespace dalaran::archetypes {
    ...
    struct GeoLineStrings {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.GeoLineStrings";
        ...
        static constexpr auto Descriptor_line_strings = ComponentDescriptor(
            ...
            Loggable<dalaran::components::GeoLineString>::ComponentType
        );
      ...
      public:
        ...
        explicit GeoLineStrings(Collection<dalaran::components::GeoLineString> _line_strings)
            : line_strings(
        ...
        GeoLineStrings with_line_strings(
            const Collection<dalaran::components::GeoLineString>& _line_strings
        ) && {
        ...
        /// *Note*: scene units radiii are interpreted as meters. Currently, the display scale only considers the latitude of
        /// the first vertex of each line string (see [this issue](https://github.com/rerun-io/rerun/issues/8013)).
        GeoLineStrings with_radii(const Collection<dalaran::components::Radius>& _radii) && {
            radii = ComponentBatch::from_loggable(_radii, Descriptor_radii).value_or_throw();
            return std::move(*this);
        }

        /// Optional colors for the line strings.
        GeoLineStrings with_colors(const Collection<dalaran::components::Color>& _colors) && {
