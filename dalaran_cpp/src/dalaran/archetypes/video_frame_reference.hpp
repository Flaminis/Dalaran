...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/video_frame_reference.fbs".
...
namespace dalaran::archetypes {
    ...
    struct VideoFrameReference {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.VideoFrameReference";
        ...
        static constexpr auto Descriptor_timestamp = ComponentDescriptor(
            ...
            Loggable<dalaran::components::VideoTimestamp>::ComponentType
        );
        ...
        static constexpr auto Descriptor_video_reference = ComponentDescriptor(
            ...
            Loggable<dalaran::components::EntityPath>::ComponentType
        );
      ...
      public:
        ...
        explicit VideoFrameReference(dalaran::components::VideoTimestamp _timestamp)
        ...
        /// This is oftentimes equivalent to presentation timestamps (known as PTS), but in the presence of B-frames
        /// (bidirectionally predicted frames) there may be an offset on the first presentation timestamp in the video.
        VideoFrameReference with_timestamp(const dalaran::components::VideoTimestamp& _timestamp) && {
            timestamp =
        ...
        VideoFrameReference with_many_timestamp(
            const Collection<dalaran::components::VideoTimestamp>& _timestamp
        ) && {
            timestamp =
                ComponentBatch::from_loggable(_timestamp, Descriptor_timestamp).value_or_throw();
            return std::move(*this);
        ...
        VideoFrameReference with_video_reference(
            const dalaran::components::EntityPath& _video_reference
        ) && {
            video_reference =
        ...
        VideoFrameReference with_many_video_reference(
            const Collection<dalaran::components::EntityPath>& _video_reference
        ) && {
            video_reference =
                ComponentBatch::from_loggable(_video_reference, Descriptor_video_reference)
                    .value_or_throw();
        ...
        ///
        /// Defaults to 1.0 (fully opaque).
        VideoFrameReference with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        VideoFrameReference with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity
        ) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        /// Objects with higher values are drawn on top of those with lower values.
        /// Defaults to `-15.0`.
        VideoFrameReference with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
