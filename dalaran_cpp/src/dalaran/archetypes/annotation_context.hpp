...
namespace dalaran::archetypes {
    ...
    struct AnnotationContext {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.AnnotationContext";
        ...
        static constexpr auto Descriptor_context = ComponentDescriptor(
            ...
            Loggable<dalaran::components::AnnotationContext>::ComponentType
        );
      ...
      public:
        ...
        explicit AnnotationContext(dalaran::components::AnnotationContext _context)
        ...
        /// List of class descriptions, mapping class indices to class names, colors etc.
        AnnotationContext with_context(const dalaran::components::AnnotationContext& _context) && {
        ...
        AnnotationContext with_many_context(
            const Collection<dalaran::components::AnnotationContext>& _context
        ) && {
            context = ComponentBatch::from_loggable(_context, Descriptor_context).value_or_throw();
            return std::move(*this);
        }
