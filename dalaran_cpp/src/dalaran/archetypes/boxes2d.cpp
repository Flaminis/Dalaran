...
namespace dalaran::archetypes {
    Boxes2D Boxes2D::clear_fields() {
        ...
        archetype.half_sizes =
            ComponentBatch::empty<dalaran::components::HalfSize2D>(Descriptor_half_sizes)
                .value_or_throw();
        archetype.centers = ComponentBatch::empty<dalaran::components::Position2D>(Descriptor_centers)
                                .value_or_throw();
        archetype.colors =
