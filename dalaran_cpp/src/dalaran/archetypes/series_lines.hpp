...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/series_lines.fbs".
...
namespace dalaran::archetypes {
    ...
    struct SeriesLines {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.SeriesLines";

        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "SeriesLines:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_widths = ComponentDescriptor(
            ...
            Loggable<dalaran::components::StrokeWidth>::ComponentType
        );
        /// `ComponentDescriptor` for the `names` field.
        static constexpr auto Descriptor_names = ComponentDescriptor(
            ArchetypeName, "SeriesLines:names", Loggable<dalaran::components::Name>::ComponentType
        );
        ...
        static constexpr auto Descriptor_aggregation_policy = ComponentDescriptor(
            ...
            Loggable<dalaran::components::AggregationPolicy>::ComponentType
        );
        ...
        static constexpr auto Descriptor_interpolation_mode = ComponentDescriptor(
            ...
            Loggable<dalaran::components::InterpolationMode>::ComponentType
        );
      ...
      public: // START of extensions from series_lines_ext.cpp:
        ...
        SeriesLines with_names(const char* _name) && {
            names = ComponentBatch::from_loggable(dalaran::components::Name(_name), Descriptor_names)
                        .value_or_throw();
      ...
      public:
        ...
        ///
        /// May change over time, but can cause discontinuities in the line.
        SeriesLines with_colors(const Collection<dalaran::components::Color>& _colors) && {
        ...
        ///
        /// May change over time, but can cause discontinuities in the line.
        SeriesLines with_widths(const Collection<dalaran::components::StrokeWidth>& _widths) && {
        ...
        ///
        /// Used in the legend. Expected to be unchanging over time.
        SeriesLines with_names(const Collection<dalaran::components::Name>& _names) && {
        ...
        SeriesLines with_visible_series(
            const Collection<dalaran::components::Visible>& _visible_series
        ) && {
            visible_series =
        ...
        SeriesLines with_aggregation_policy(
            const dalaran::components::AggregationPolicy& _aggregation_policy
        ) && {
            aggregation_policy =
        ...
        SeriesLines with_many_aggregation_policy(
            const Collection<dalaran::components::AggregationPolicy>& _aggregation_policy
        ) && {
            aggregation_policy =
                ComponentBatch::from_loggable(_aggregation_policy, Descriptor_aggregation_policy)
                    .value_or_throw();
        ...
        SeriesLines with_interpolation_mode(
            const dalaran::components::InterpolationMode& _interpolation_mode
        ) && {
            interpolation_mode =
        ...
        SeriesLines with_many_interpolation_mode(
            const Collection<dalaran::components::InterpolationMode>& _interpolation_mode
        ) && {
            interpolation_mode =
                ComponentBatch::from_loggable(_interpolation_mode, Descriptor_interpolation_mode)
                    .value_or_throw();
