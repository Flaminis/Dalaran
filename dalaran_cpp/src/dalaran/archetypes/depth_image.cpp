...
namespace dalaran::archetypes {
    DepthImage DepthImage::clear_fields() {
        ...
        archetype.buffer = ComponentBatch::empty<dalaran::components::ImageBuffer>(Descriptor_buffer)
                               .value_or_throw();
        archetype.format = ComponentBatch::empty<dalaran::components::ImageFormat>(Descriptor_format)
                               .value_or_throw();
        archetype.meter =
            ComponentBatch::empty<dalaran::components::DepthMeter>(Descriptor_meter).value_or_throw();
        archetype.colormap = ComponentBatch::empty<dalaran::components::Colormap>(Descriptor_colormap)
                                 .value_or_throw();
        archetype.depth_range =
            ComponentBatch::empty<dalaran::components::ValueRange>(Descriptor_depth_range)
                .value_or_throw();
        archetype.point_fill_ratio =
            ComponentBatch::empty<dalaran::components::FillRatio>(Descriptor_point_fill_ratio)
                .value_or_throw();
        ...
        archetype.magnification_filter =
            ComponentBatch::empty<dalaran::components::MagnificationFilter>(
