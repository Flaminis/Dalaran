...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/ellipsoids3d.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Ellipsoids3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Ellipsoids3D";
        ...
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "Ellipsoids3D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        ...
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "Ellipsoids3D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// If all components are equal, then it is a sphere with that radius.
        Ellipsoids3D with_half_sizes(const Collection<dalaran::components::HalfSize3D>& _half_sizes
        ) && {
            half_sizes =
        ...
        ///
        /// If not specified, the centers will be at (0, 0, 0).
        Ellipsoids3D with_centers(const Collection<dalaran::components::Translation3D>& _centers) && {
        ...
        ///
        /// Alpha channel is used for transparency for solid fill-mode.
        Ellipsoids3D with_colors(const Collection<dalaran::components::Color>& _colors) && {
            colors = ComponentBatch::from_loggable(_colors, Descriptor_colors).value_or_throw();
            return std::move(*this);
        }

        /// Optional radii for the lines used when the ellipsoid is rendered as a wireframe.
        Ellipsoids3D with_line_radii(const Collection<dalaran::components::Radius>& _line_radii) && {
            line_radii =
        ...
        /// Optionally choose whether the ellipsoids are drawn with lines or solid.
        Ellipsoids3D with_fill_mode(const dalaran::components::FillMode& _fill_mode) && {
            fill_mode =
        ...
        Ellipsoids3D with_many_fill_mode(const Collection<dalaran::components::FillMode>& _fill_mode
        ) && {
            fill_mode =
                ComponentBatch::from_loggable(_fill_mode, Descriptor_fill_mode).value_or_throw();
            return std::move(*this);
        ...
        /// Optional text labels for the ellipsoids.
        Ellipsoids3D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        Ellipsoids3D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        ///
        /// The class ID provides colors and labels if not specified explicitly.
        Ellipsoids3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
