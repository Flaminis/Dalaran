...
namespace dalaran::archetypes {
    GridMap GridMap::clear_fields() {
        ...
        archetype.data =
            ComponentBatch::empty<dalaran::components::ImageBuffer>(Descriptor_data).value_or_throw();
        archetype.format = ComponentBatch::empty<dalaran::components::ImageFormat>(Descriptor_format)
                               .value_or_throw();
        archetype.cell_size =
            ComponentBatch::empty<dalaran::components::CellSize>(Descriptor_cell_size)
                .value_or_throw();
