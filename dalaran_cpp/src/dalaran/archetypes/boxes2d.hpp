...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/boxes2d.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Boxes2D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Boxes2D";
        ...
        static constexpr auto Descriptor_half_sizes = ComponentDescriptor(
            ...
            Loggable<dalaran::components::HalfSize2D>::ComponentType
        );
        /// `ComponentDescriptor` for the `centers` field.
        static constexpr auto Descriptor_centers = ComponentDescriptor(
            ArchetypeName, "Boxes2D:centers", Loggable<dalaran::components::Position2D>::ComponentType
        );
        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "Boxes2D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `radii` field.
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "Boxes2D:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
        /// `ComponentDescriptor` for the `labels` field.
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "Boxes2D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
        ...
        static constexpr auto Descriptor_class_ids = ComponentDescriptor(
            ArchetypeName, "Boxes2D:class_ids", Loggable<dalaran::components::ClassId>::ComponentType
        );
      ...
      public:
        ...
        /// All half-extents that make up the batch of boxes.
        Boxes2D with_half_sizes(const Collection<dalaran::components::HalfSize2D>& _half_sizes) && {
            half_sizes =
        ...
        /// Optional center positions of the boxes.
        Boxes2D with_centers(const Collection<dalaran::components::Position2D>& _centers) && {
            centers = ComponentBatch::from_loggable(_centers, Descriptor_centers).value_or_throw();
            return std::move(*this);
        }

        /// Optional colors for the boxes.
        Boxes2D with_colors(const Collection<dalaran::components::Color>& _colors) && {
            colors = ComponentBatch::from_loggable(_colors, Descriptor_colors).value_or_throw();
            return std::move(*this);
        }

        /// Optional radii for the lines that make up the boxes.
        Boxes2D with_radii(const Collection<dalaran::components::Radius>& _radii) && {
        ...
        /// If there's a single label present, it will be placed at the center of the entity.
        /// Otherwise, each instance will have its own label.
        Boxes2D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        Boxes2D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        Boxes2D with_many_show_labels(const Collection<dalaran::components::ShowLabels>& _show_labels
        ) && {
            show_labels = ComponentBatch::from_loggable(_show_labels, Descriptor_show_labels)
                              .value_or_throw();
            return std::move(*this);
        ...
        /// Objects with higher values are drawn on top of those with lower values.
        /// Defaults to `10.0`.
        Boxes2D with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
        ...
        /// be used when logging a single row's worth of data.
        Boxes2D with_many_draw_order(const Collection<dalaran::components::DrawOrder>& _draw_order
        ) && {
            draw_order =
                ComponentBatch::from_loggable(_draw_order, Descriptor_draw_order).value_or_throw();
            return std::move(*this);
        ...
        ///
        /// The `components::ClassId` provides colors and labels if not specified explicitly.
        Boxes2D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
