...
namespace dalaran::archetypes {
    VideoFrameReference VideoFrameReference::clear_fields() {
        ...
        archetype.timestamp =
            ComponentBatch::empty<dalaran::components::VideoTimestamp>(Descriptor_timestamp)
                .value_or_throw();
        archetype.video_reference =
            ComponentBatch::empty<dalaran::components::EntityPath>(Descriptor_video_reference)
                .value_or_throw();
        archetype.opacity =
