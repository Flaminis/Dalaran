...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/pinhole.fbs".
...
namespace dalaran::archetypes {
    ...
    struct Pinhole {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Pinhole";
        ...
        static constexpr auto Descriptor_image_from_camera = ComponentDescriptor(
            ...
            Loggable<dalaran::components::PinholeProjection>::ComponentType
        );
        ...
        static constexpr auto Descriptor_resolution = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Resolution>::ComponentType
        );
        ...
        static constexpr auto Descriptor_child_frame = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TransformFrameId>::ComponentType
        );
        ...
        static constexpr auto Descriptor_image_plane_distance = ComponentDescriptor(
            ...
            Loggable<dalaran::components::ImagePlaneDistance>::ComponentType
        );
        /// `ComponentDescriptor` for the `color` field.
        static constexpr auto Descriptor_color = ComponentDescriptor(
            ArchetypeName, "Pinhole:color", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `line_width` field.
        static constexpr auto Descriptor_line_width = ComponentDescriptor(
            ArchetypeName, "Pinhole:line_width", Loggable<dalaran::components::Radius>::ComponentType
        );
      ...
      public:
        ...
        explicit Pinhole(dalaran::components::PinholeProjection _image_from_camera)
        ...
        Pinhole with_image_from_camera(
            const dalaran::components::PinholeProjection& _image_from_camera
        ) && {
            image_from_camera =
        ...
        Pinhole with_many_image_from_camera(
            const Collection<dalaran::components::PinholeProjection>& _image_from_camera
        ) && {
            image_from_camera =
                ComponentBatch::from_loggable(_image_from_camera, Descriptor_image_from_camera)
                    .value_or_throw();
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Pinhole with_resolution(const dalaran::components::Resolution& _resolution) && {
            resolution =
        ...
        /// be used when logging a single row's worth of data.
        Pinhole with_many_resolution(const Collection<dalaran::components::Resolution>& _resolution
        ) && {
            resolution =
                ComponentBatch::from_loggable(_resolution, Descriptor_resolution).value_or_throw();
            return std::move(*this);
        ...
        /// `image_from_camera` is always defined to project along +Z in camera coordinates.
        /// `camera_xyz` reorients that projection to the forward axis of the pinhole entity.
        Pinhole with_camera_xyz(const dalaran::components::ViewCoordinates& _camera_xyz) && {
            camera_xyz =
        ...
        Pinhole with_many_camera_xyz(
            const Collection<dalaran::components::ViewCoordinates>& _camera_xyz
        ) && {
            camera_xyz =
                ComponentBatch::from_loggable(_camera_xyz, Descriptor_camera_xyz).value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Pinhole with_child_frame(const dalaran::components::TransformFrameId& _child_frame) && {
        ...
        Pinhole with_many_child_frame(
            const Collection<dalaran::components::TransformFrameId>& _child_frame
        ) && {
            child_frame = ComponentBatch::from_loggable(_child_frame, Descriptor_child_frame)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Any update to this field will reset all other transform properties that aren't changed in the same log call or `send_columns` row.
        Pinhole with_parent_frame(const dalaran::components::TransformFrameId& _parent_frame) && {
        ...
        Pinhole with_many_parent_frame(
            const Collection<dalaran::components::TransformFrameId>& _parent_frame
        ) && {
            parent_frame = ComponentBatch::from_loggable(_parent_frame, Descriptor_parent_frame)
                               .value_or_throw();
            return std::move(*this);
        ...
        Pinhole with_image_plane_distance(
            const dalaran::components::ImagePlaneDistance& _image_plane_distance
        ) && {
        ...
        Pinhole with_many_image_plane_distance(
            const Collection<dalaran::components::ImagePlaneDistance>& _image_plane_distance
        ) && {
            image_plane_distance = ComponentBatch::from_loggable(
                                       _image_plane_distance,
                                       Descriptor_image_plane_distance
        ...
        /// Color of the camera wireframe.
        Pinhole with_color(const dalaran::components::Color& _color) && {
        ...
        /// be used when logging a single row's worth of data.
        Pinhole with_many_color(const Collection<dalaran::components::Color>& _color) && {
            color = ComponentBatch::from_loggable(_color, Descriptor_color).value_or_throw();
            return std::move(*this);
        }

        /// Width of the camera wireframe lines.
        Pinhole with_line_width(const dalaran::components::Radius& _line_width) && {
            line_width =
        ...
        /// be used when logging a single row's worth of data.
        Pinhole with_many_line_width(const Collection<dalaran::components::Radius>& _line_width) && {
            line_width =
                ComponentBatch::from_loggable(_line_width, Descriptor_line_width).value_or_throw();
            return std::move(*this);
        }
