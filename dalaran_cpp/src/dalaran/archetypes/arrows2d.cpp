...
namespace dalaran::archetypes {
    Arrows2D Arrows2D::clear_fields() {
        ...
        archetype.vectors =
            ComponentBatch::empty<dalaran::components::Vector2D>(Descriptor_vectors).value_or_throw();
        archetype.origins = ComponentBatch::empty<dalaran::components::Position2D>(Descriptor_origins)
                                .value_or_throw();
        archetype.radii =
        ...
        archetype.draw_order =
            ComponentBatch::empty<dalaran::components::DrawOrder>(Descriptor_draw_order)
                .value_or_throw();
        archetype.class_ids =
