...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/grid_map.fbs".
...
namespace dalaran::archetypes {
    ...
    struct GridMap {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.GridMap";

        /// `ComponentDescriptor` for the `data` field.
        static constexpr auto Descriptor_data = ComponentDescriptor(
            ArchetypeName, "GridMap:data", Loggable<dalaran::components::ImageBuffer>::ComponentType
        );
        /// `ComponentDescriptor` for the `format` field.
        static constexpr auto Descriptor_format = ComponentDescriptor(
            ArchetypeName, "GridMap:format", Loggable<dalaran::components::ImageFormat>::ComponentType
        );
        /// `ComponentDescriptor` for the `cell_size` field.
        static constexpr auto Descriptor_cell_size = ComponentDescriptor(
            ArchetypeName, "GridMap:cell_size", Loggable<dalaran::components::CellSize>::ComponentType
        );
        ...
        static constexpr auto Descriptor_opacity = ComponentDescriptor(
            ArchetypeName, "GridMap:opacity", Loggable<dalaran::components::Opacity>::ComponentType
        );
        ...
        static constexpr auto Descriptor_colormap = ComponentDescriptor(
            ArchetypeName, "GridMap:colormap", Loggable<dalaran::components::Colormap>::ComponentType
        );
      ...
      public:
        ...
        /// The raw grid data.
        GridMap with_data(const dalaran::components::ImageBuffer& _data) && {
        ...
        GridMap with_many_data(const Collection<dalaran::components::ImageBuffer>& _data) && {
            data = ComponentBatch::from_loggable(_data, Descriptor_data).value_or_throw();
            return std::move(*this);
        }

        /// The format of the grid's image data.
        GridMap with_format(const dalaran::components::ImageFormat& _format) && {
        ...
        /// be used when logging a single row's worth of data.
        GridMap with_many_format(const Collection<dalaran::components::ImageFormat>& _format) && {
            format = ComponentBatch::from_loggable(_format, Descriptor_format).value_or_throw();
            return std::move(*this);
        }

        /// The scene unit size of a single grid cell (e.g. m / pixel).
        GridMap with_cell_size(const dalaran::components::CellSize& _cell_size) && {
            cell_size =
        ...
        /// be used when logging a single row's worth of data.
        GridMap with_many_cell_size(const Collection<dalaran::components::CellSize>& _cell_size) && {
            cell_size =
                ComponentBatch::from_loggable(_cell_size, Descriptor_cell_size).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// If not set, the lower-left image corner is placed at origin of the map's parent coordinate frame.
        GridMap with_translation(const dalaran::components::Translation3D& _translation) && {
        ...
        GridMap with_many_translation(
            const Collection<dalaran::components::Translation3D>& _translation
        ) && {
            translation = ComponentBatch::from_loggable(_translation, Descriptor_translation)
                              .value_or_throw();
            return std::move(*this);
        ...
        GridMap with_rotation_axis_angle(
            const dalaran::components::RotationAxisAngle& _rotation_axis_angle
        ) && {
            rotation_axis_angle =
        ...
        GridMap with_many_rotation_axis_angle(
            const Collection<dalaran::components::RotationAxisAngle>& _rotation_axis_angle
        ) && {
            rotation_axis_angle =
                ComponentBatch::from_loggable(_rotation_axis_angle, Descriptor_rotation_axis_angle)
                    .value_or_throw();
        ...
        /// Together with `components::Translation3D`, this defines the pose of the
        /// lower-left image corner relative to the map's parent coordinate frame.
        GridMap with_quaternion(const dalaran::components::RotationQuat& _quaternion) && {
            quaternion =
        ...
        /// be used when logging a single row's worth of data.
        GridMap with_many_quaternion(const Collection<dalaran::components::RotationQuat>& _quaternion
        ) && {
            quaternion =
                ComponentBatch::from_loggable(_quaternion, Descriptor_quaternion).value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Defaults to 1.0 (fully opaque).
        GridMap with_opacity(const dalaran::components::Opacity& _opacity) && {
        ...
        /// be used when logging a single row's worth of data.
        GridMap with_many_opacity(const Collection<dalaran::components::Opacity>& _opacity) && {
            opacity = ComponentBatch::from_loggable(_opacity, Descriptor_opacity).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// Higher values are drawn on top of lower values.
        GridMap with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
        ...
        /// be used when logging a single row's worth of data.
        GridMap with_many_draw_order(const Collection<dalaran::components::DrawOrder>& _draw_order
        ) && {
            draw_order =
                ComponentBatch::from_loggable(_draw_order, Descriptor_draw_order).value_or_throw();
            return std::move(*this);
        ...
        /// If not set, the grid map is shown using the underlying `components::ImageFormat`
        /// interpretation.
        GridMap with_colormap(const dalaran::components::Colormap& _colormap) && {
            colormap =
        ...
        /// be used when logging a single row's worth of data.
        GridMap with_many_colormap(const Collection<dalaran::components::Colormap>& _colormap) && {
            colormap =
                ComponentBatch::from_loggable(_colormap, Descriptor_colormap).value_or_throw();
            return std::move(*this);
        }
