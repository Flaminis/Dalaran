...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/depth_image.fbs".
...
namespace dalaran::archetypes {
    ...
    ///
    /// Since the underlying `dalaran::datatypes::ImageBuffer` uses `dalaran::Collection` internally,
    /// data can be passed in without a copy from raw pointers or by reference from `std::vector`/`std::array`/c-arrays.
    /// If needed, this "borrow-behavior" can be extended by defining your own `dalaran::CollectionAdapter`.
    ///
    /// ## Example
    ///
    /// ### Depth to 3D example
    ...
    struct DepthImage {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.DepthImage";
        ...
        static constexpr auto Descriptor_buffer = ComponentDescriptor(
            ...
            Loggable<dalaran::components::ImageBuffer>::ComponentType
        );
        ...
        static constexpr auto Descriptor_format = ComponentDescriptor(
            ...
            Loggable<dalaran::components::ImageFormat>::ComponentType
        );
        ...
        static constexpr auto Descriptor_meter = ComponentDescriptor(
            ...
            Loggable<dalaran::components::DepthMeter>::ComponentType
        );
        ...
        static constexpr auto Descriptor_colormap = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Colormap>::ComponentType
        );
        ...
        static constexpr auto Descriptor_depth_range = ComponentDescriptor(
            ...
            Loggable<dalaran::components::ValueRange>::ComponentType
        );
        ...
        static constexpr auto Descriptor_point_fill_ratio = ComponentDescriptor(
            ...
            Loggable<dalaran::components::FillRatio>::ComponentType
        );
        ...
        static constexpr auto Descriptor_magnification_filter = ComponentDescriptor(
            ...
            Loggable<dalaran::components::MagnificationFilter>::ComponentType
        );
      ...
      public:
        ...
        /// The raw depth image data.
        DepthImage with_buffer(const dalaran::components::ImageBuffer& _buffer) && {
        ...
        DepthImage with_many_buffer(const Collection<dalaran::components::ImageBuffer>& _buffer) && {
            buffer = ComponentBatch::from_loggable(_buffer, Descriptor_buffer).value_or_throw();
            return std::move(*this);
        }

        /// The format of the image.
        DepthImage with_format(const dalaran::components::ImageFormat& _format) && {
        ...
        /// be used when logging a single row's worth of data.
        DepthImage with_many_format(const Collection<dalaran::components::ImageFormat>& _format) && {
            format = ComponentBatch::from_loggable(_format, Descriptor_format).value_or_throw();
            return std::move(*this);
        }
        ...
        /// Note that the only effect on 2D views is the physical depth values shown when hovering the image.
        /// In 3D views on the other hand, this affects where the points of the point cloud are placed.
        DepthImage with_meter(const dalaran::components::DepthMeter& _meter) && {
        ...
        /// be used when logging a single row's worth of data.
        DepthImage with_many_meter(const Collection<dalaran::components::DepthMeter>& _meter) && {
            meter = ComponentBatch::from_loggable(_meter, Descriptor_meter).value_or_throw();
            return std::move(*this);
        }
        ...
        ///
        /// If not set, the depth image will be rendered using the Turbo colormap.
        DepthImage with_colormap(const dalaran::components::Colormap& _colormap) && {
            colormap =
        ...
        /// be used when logging a single row's worth of data.
        DepthImage with_many_colormap(const Collection<dalaran::components::Colormap>& _colormap) && {
            colormap =
                ComponentBatch::from_loggable(_colormap, Descriptor_colormap).value_or_throw();
            return std::move(*this);
        }
        ...
        /// E.g. if all values are positive, some bigger than 1.0 and all smaller than 255.0,
        /// the Viewer will guess that the data likely came from an 8bit image, thus assuming a range of 0-255.
        DepthImage with_depth_range(const dalaran::components::ValueRange& _depth_range) && {
        ...
        DepthImage with_many_depth_range(
            const Collection<dalaran::components::ValueRange>& _depth_range
        ) && {
            depth_range = ComponentBatch::from_loggable(_depth_range, Descriptor_depth_range)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// TODO(#6744): This applies only to 3D views!
        DepthImage with_point_fill_ratio(const dalaran::components::FillRatio& _point_fill_ratio) && {
            point_fill_ratio =
        ...
        DepthImage with_many_point_fill_ratio(
            const Collection<dalaran::components::FillRatio>& _point_fill_ratio
        ) && {
            point_fill_ratio =
                ComponentBatch::from_loggable(_point_fill_ratio, Descriptor_point_fill_ratio)
                    .value_or_throw();
        ...
        /// Objects with higher values are drawn on top of those with lower values.
        /// Defaults to `-20.0`.
        DepthImage with_draw_order(const dalaran::components::DrawOrder& _draw_order) && {
            draw_order =
        ...
        /// be used when logging a single row's worth of data.
        DepthImage with_many_draw_order(const Collection<dalaran::components::DrawOrder>& _draw_order
        ) && {
            draw_order =
                ComponentBatch::from_loggable(_draw_order, Descriptor_draw_order).value_or_throw();
            return std::move(*this);
        ...
        DepthImage with_magnification_filter(
            const dalaran::components::MagnificationFilter& _magnification_filter
        ) && {
        ...
        DepthImage with_many_magnification_filter(
            const Collection<dalaran::components::MagnificationFilter>& _magnification_filter
        ) && {
            magnification_filter = ComponentBatch::from_loggable(
                                       _magnification_filter,
                                       Descriptor_magnification_filter
