...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/mcap_statistics.fbs".
...
namespace dalaran::archetypes {
    ...
    struct McapStatistics {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.McapStatistics";
        ...
        static constexpr auto Descriptor_message_count = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Count>::ComponentType
        );
        ...
        static constexpr auto Descriptor_message_start_time = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Timestamp>::ComponentType
        );
        ...
        static constexpr auto Descriptor_channel_message_counts = ComponentDescriptor(
            ...
            Loggable<dalaran::components::ChannelMessageCounts>::ComponentType
        );
      ...
      public:
        ...
        explicit McapStatistics(
            dalaran::components::Count _message_count, dalaran::components::Count _schema_count,
            dalaran::components::Count _channel_count, dalaran::components::Count _attachment_count,
            dalaran::components::Count _metadata_count, dalaran::components::Count _chunk_count,
            dalaran::components::Timestamp _message_start_time,
            dalaran::components::Timestamp _message_end_time
        )
            : message_count(
        ...
        /// This count includes all timestamped data messages but excludes metadata records,
        /// schema definitions, and other non-message records.
        McapStatistics with_message_count(const dalaran::components::Count& _message_count) && {
        ...
        McapStatistics with_many_message_count(
            const Collection<dalaran::components::Count>& _message_count
        ) && {
            message_count = ComponentBatch::from_loggable(_message_count, Descriptor_message_count)
                                .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Each schema defines the structure for one or more message types used by channels.
        McapStatistics with_schema_count(const dalaran::components::Count& _schema_count) && {
        ...
        McapStatistics with_many_schema_count(
            const Collection<dalaran::components::Count>& _schema_count
        ) && {
            schema_count = ComponentBatch::from_loggable(_schema_count, Descriptor_schema_count)
                               .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Each channel represents a unique topic and encoding combination for publishing messages.
        McapStatistics with_channel_count(const dalaran::components::Count& _channel_count) && {
        ...
        McapStatistics with_many_channel_count(
            const Collection<dalaran::components::Count>& _channel_count
        ) && {
            channel_count = ComponentBatch::from_loggable(_channel_count, Descriptor_channel_count)
                                .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// Attachments can include calibration files, configuration data, or other auxiliary files.
        McapStatistics with_attachment_count(const dalaran::components::Count& _attachment_count) && {
            attachment_count =
        ...
        McapStatistics with_many_attachment_count(
            const Collection<dalaran::components::Count>& _attachment_count
        ) && {
            attachment_count =
                ComponentBatch::from_loggable(_attachment_count, Descriptor_attachment_count)
                    .value_or_throw();
        ...
        /// Metadata records contain key-value pairs with information about the recording environment,
        /// system configuration, or other contextual data.
        McapStatistics with_metadata_count(const dalaran::components::Count& _metadata_count) && {
            metadata_count =
        ...
        McapStatistics with_many_metadata_count(
            const Collection<dalaran::components::Count>& _metadata_count
        ) && {
            metadata_count =
                ComponentBatch::from_loggable(_metadata_count, Descriptor_metadata_count)
                    .value_or_throw();
        ...
        ///
        /// Chunks group related messages together for efficient storage and indexed access.
        McapStatistics with_chunk_count(const dalaran::components::Count& _chunk_count) && {
        ...
        McapStatistics with_many_chunk_count(
            const Collection<dalaran::components::Count>& _chunk_count
        ) && {
            chunk_count = ComponentBatch::from_loggable(_chunk_count, Descriptor_chunk_count)
                              .value_or_throw();
            return std::move(*this);
        ...
        McapStatistics with_message_start_time(
            const dalaran::components::Timestamp& _message_start_time
        ) && {
            message_start_time =
        ...
        McapStatistics with_many_message_start_time(
            const Collection<dalaran::components::Timestamp>& _message_start_time
        ) && {
            message_start_time =
                ComponentBatch::from_loggable(_message_start_time, Descriptor_message_start_time)
                    .value_or_throw();
        ...
        ///
        /// Together with `message_start_time`, this defines the total duration of the recording.
        McapStatistics with_message_end_time(const dalaran::components::Timestamp& _message_end_time
        ) && {
            message_end_time =
        ...
        McapStatistics with_many_message_end_time(
            const Collection<dalaran::components::Timestamp>& _message_end_time
        ) && {
            message_end_time =
                ComponentBatch::from_loggable(_message_end_time, Descriptor_message_end_time)
                    .value_or_throw();
        ...
        McapStatistics with_channel_message_counts(
            const dalaran::components::ChannelMessageCounts& _channel_message_counts
        ) && {
        ...
        McapStatistics with_many_channel_message_counts(
            const Collection<dalaran::components::ChannelMessageCounts>& _channel_message_counts
        ) && {
            channel_message_counts = ComponentBatch::from_loggable(
                                         _channel_message_counts,
                                         Descriptor_channel_message_counts
