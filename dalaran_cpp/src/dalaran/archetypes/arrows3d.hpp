...
namespace dalaran::archetypes {
    ...
    struct Arrows3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.archetypes.Arrows3D";

        /// `ComponentDescriptor` for the `vectors` field.
        static constexpr auto Descriptor_vectors = ComponentDescriptor(
            ArchetypeName, "Arrows3D:vectors", Loggable<dalaran::components::Vector3D>::ComponentType
        );
        ...
        static constexpr auto Descriptor_radii = ComponentDescriptor(
            ArchetypeName, "Arrows3D:radii", Loggable<dalaran::components::Radius>::ComponentType
        );
        /// `ComponentDescriptor` for the `colors` field.
        static constexpr auto Descriptor_colors = ComponentDescriptor(
            ArchetypeName, "Arrows3D:colors", Loggable<dalaran::components::Color>::ComponentType
        );
        /// `ComponentDescriptor` for the `labels` field.
        static constexpr auto Descriptor_labels = ComponentDescriptor(
            ArchetypeName, "Arrows3D:labels", Loggable<dalaran::components::Text>::ComponentType
        );
        ...
        static constexpr auto Descriptor_class_ids = ComponentDescriptor(
            ArchetypeName, "Arrows3D:class_ids", Loggable<dalaran::components::ClassId>::ComponentType
        );
      ...
      public:
        ...
        /// All the vectors for each arrow in the batch.
        Arrows3D with_vectors(const Collection<dalaran::components::Vector3D>& _vectors) && {
        ...
        ///
        /// If no origins are set, (0, 0, 0) is used as the origin for each arrow.
        Arrows3D with_origins(const Collection<dalaran::components::Position3D>& _origins) && {
        ...
        /// The shaft is rendered as a line with `radius = 0.5 * radius`.
        /// The tip is rendered with `height = 2.0 * radius` and `radius = 1.0 * radius`.
        Arrows3D with_radii(const Collection<dalaran::components::Radius>& _radii) && {
            radii = ComponentBatch::from_loggable(_radii, Descriptor_radii).value_or_throw();
            return std::move(*this);
        }

        /// Optional colors for the points.
        Arrows3D with_colors(const Collection<dalaran::components::Color>& _colors) && {
        ...
        /// If there's a single label present, it will be placed at the center of the entity.
        /// Otherwise, each instance will have its own label.
        Arrows3D with_labels(const Collection<dalaran::components::Text>& _labels) && {
        ...
        /// If not set, labels will automatically appear when there is exactly one label for this entity
        /// or the number of instances on this entity is under a certain threshold.
        Arrows3D with_show_labels(const dalaran::components::ShowLabels& _show_labels) && {
        ...
        Arrows3D with_many_show_labels(const Collection<dalaran::components::ShowLabels>& _show_labels
        ) && {
            show_labels = ComponentBatch::from_loggable(_show_labels, Descriptor_show_labels)
                              .value_or_throw();
            return std::move(*this);
        ...
        ///
        /// The `components::ClassId` provides colors and labels if not specified explicitly.
        Arrows3D with_class_ids(const Collection<dalaran::components::ClassId>& _class_ids) && {
            class_ids =
