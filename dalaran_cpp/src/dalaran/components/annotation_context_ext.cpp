...
namespace dalaran::components {
    ...
    /// Construct from an initializer list of elements from which `dalaran::datatypes::ClassDescriptionMapElem`s can be constructed.
    ///
    /// This will then create a new collection of `dalaran::datatypes::ClassDescriptionMapElem`.
    ///
    /// _Implementation note_:
    /// We handle this type of conversion in a generic `dalaran::ContainerAdapter`.
