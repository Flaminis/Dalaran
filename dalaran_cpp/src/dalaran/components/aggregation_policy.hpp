...
namespace dalaran {
    ...
    struct Loggable<components::AggregationPolicy> {
        static constexpr std::string_view ComponentType = "dalaran.components.AggregationPolicy";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::components::AggregationPolicy` into an arrow array.
