...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/media_type.fbs".
...
namespace dalaran::components {
    ...
    struct MediaType {
      ...
      public:
        ...
        MediaType(dalaran::datatypes::Utf8 value_) : value(std::move(value_)) {}

        MediaType& operator=(dalaran::datatypes::Utf8 value_) {
...
namespace dalaran {
    static_assert(sizeof(dalaran::datatypes::Utf8) == sizeof(components::MediaType));

    /// \private
    template <>
    struct Loggable<components::MediaType> {
        static constexpr std::string_view ComponentType = "dalaran.components.MediaType";
        ...
        /// Serializes an array of `dalaran::components::MediaType` into an arrow array.
