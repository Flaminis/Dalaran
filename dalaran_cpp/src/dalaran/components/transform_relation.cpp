...
namespace dalaran {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::TransformRelation>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<components::TransformRelation>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<components::TransformRelation>::fill_arrow_array_builder(
