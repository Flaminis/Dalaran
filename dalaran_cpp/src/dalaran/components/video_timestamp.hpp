...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/video_timestamp.fbs".
...
namespace dalaran::components {
    ...
    struct VideoTimestamp {
        dalaran::datatypes::VideoTimestamp timestamp;
      ...
      public:
        ...
        VideoTimestamp(dalaran::datatypes::VideoTimestamp timestamp_) : timestamp(timestamp_) {}

        VideoTimestamp& operator=(dalaran::datatypes::VideoTimestamp timestamp_) {
        ...
        operator dalaran::datatypes::VideoTimestamp() const {
            return timestamp;
        }
    };
} // namespace dalaran::components
...
namespace dalaran {
    static_assert(sizeof(dalaran::datatypes::VideoTimestamp) == sizeof(components::VideoTimestamp));

    /// \private
    template <>
    struct Loggable<components::VideoTimestamp> {
        static constexpr std::string_view ComponentType = "dalaran.components.VideoTimestamp";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype() {
            return Loggable<dalaran::datatypes::VideoTimestamp>::arrow_datatype();
        }

        /// Serializes an array of `dalaran::components::VideoTimestamp` into an arrow array.
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            const components::VideoTimestamp* instances, size_t num_instances
        ) {
            if (num_instances == 0) {
                return Loggable<dalaran::datatypes::VideoTimestamp>::to_arrow(nullptr, 0);
                ...
                return Loggable<dalaran::datatypes::VideoTimestamp>::to_arrow(
                    &instances->timestamp,
                    num_instances
                );
            }
