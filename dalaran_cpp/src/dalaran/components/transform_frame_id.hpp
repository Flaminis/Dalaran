...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/transform_frame_id.fbs".
...
namespace dalaran::components {
    ...
    struct TransformFrameId {
      ...
      public:
        ...
        TransformFrameId(dalaran::datatypes::Utf8 value_) : value(std::move(value_)) {}

        TransformFrameId& operator=(dalaran::datatypes::Utf8 value_) {
...
namespace dalaran {
    static_assert(sizeof(dalaran::datatypes::Utf8) == sizeof(components::TransformFrameId));

    /// \private
    template <>
    struct Loggable<components::TransformFrameId> {
        static constexpr std::string_view ComponentType = "dalaran.components.TransformFrameId";
        ...
        /// Serializes an array of `dalaran::components::TransformFrameId` into an arrow array.
