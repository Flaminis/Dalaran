...
namespace dalaran {
    ...
    struct Loggable<components::MagnificationFilter> {
        static constexpr std::string_view ComponentType = "dalaran.components.MagnificationFilter";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::components::MagnificationFilter` into an arrow array.
