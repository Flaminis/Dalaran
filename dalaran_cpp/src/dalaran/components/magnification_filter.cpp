...
namespace dalaran {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::MagnificationFilter>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<components::MagnificationFilter>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<components::MagnificationFilter>::fill_arrow_array_builder(
