...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/radius.fbs".
...
namespace dalaran::components {
    ...
    struct Radius {
      ...
      public:
        ...
        Radius(dalaran::datatypes::Float32 value_) : value(value_) {}

        Radius& operator=(dalaran::datatypes::Float32 value_) {
            value = value_;
            return *this;
        }
...
namespace dalaran {
    static_assert(sizeof(dalaran::datatypes::Float32) == sizeof(components::Radius));

    /// \private
    template <>
    struct Loggable<components::Radius> {
        static constexpr std::string_view ComponentType = "dalaran.components.Radius";
        ...
        /// Serializes an array of `dalaran::components::Radius` into an arrow array.
