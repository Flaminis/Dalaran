...
namespace dalaran {
    ...
    struct Loggable<components::TransformRelation> {
        static constexpr std::string_view ComponentType = "dalaran.components.TransformRelation";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::components::TransformRelation` into an arrow array.
