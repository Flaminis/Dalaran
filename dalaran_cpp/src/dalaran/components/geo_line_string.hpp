...
namespace dalaran::components {
    ...
    struct GeoLineString {
        dalaran::Collection<dalaran::datatypes::DVec2D> lat_lon;
...
namespace dalaran {
    ...
    struct Loggable<components::GeoLineString> {
        static constexpr std::string_view ComponentType = "dalaran.components.GeoLineString";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::components::GeoLineString` into an arrow array.
