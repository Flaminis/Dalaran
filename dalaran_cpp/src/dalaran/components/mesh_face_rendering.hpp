...
namespace dalaran {
    ...
    struct Loggable<components::MeshFaceRendering> {
        static constexpr std::string_view ComponentType = "dalaran.components.MeshFaceRendering";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::components::MeshFaceRendering` into an arrow array.
