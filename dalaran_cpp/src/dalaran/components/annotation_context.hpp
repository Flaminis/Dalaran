...
namespace dalaran::components {
    ...
    struct AnnotationContext {
        ...
        dalaran::Collection<dalaran::datatypes::ClassDescriptionMapElem> class_map;
      ...
      public:
        ...
        AnnotationContext(dalaran::Collection<dalaran::datatypes::ClassDescriptionMapElem> class_map_)
            : class_map(std::move(class_map_)) {}

        AnnotationContext& operator=(
            dalaran::Collection<dalaran::datatypes::ClassDescriptionMapElem> class_map_
        ) {
            class_map = std::move(class_map_);
            return *this;
        }
...
namespace dalaran {
    ...
    struct Loggable<components::AnnotationContext> {
        static constexpr std::string_view ComponentType = "dalaran.components.AnnotationContext";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::components::AnnotationContext` into an arrow array.
