...
namespace dalaran::blueprint::archetypes {
    LineGrid3D LineGrid3D::clear_fields() {
        ...
        archetype.spacing =
            ComponentBatch::empty<dalaran::blueprint::components::GridSpacing>(Descriptor_spacing)
                .value_or_throw();
        archetype.plane =
            ComponentBatch::empty<dalaran::components::Plane3D>(Descriptor_plane).value_or_throw();
        archetype.stroke_width =
            ComponentBatch::empty<dalaran::components::StrokeWidth>(Descriptor_stroke_width)
                .value_or_throw();
        archetype.color =
