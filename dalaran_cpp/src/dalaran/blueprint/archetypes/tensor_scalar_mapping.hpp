    ...
    struct TensorScalarMapping {
      ...
      public:
        ...
        static constexpr auto Descriptor_gamma = ComponentDescriptor(
            ...
            Loggable<dalaran::components::GammaCorrection>::ComponentType
        );
      ...
      public:
        ...
        TensorScalarMapping with_mag_filter(
            const dalaran::components::MagnificationFilter& _mag_filter
        ) && {
            mag_filter =
        ...
        /// How scalar values map to colors.
        TensorScalarMapping with_colormap(const dalaran::components::Colormap& _colormap) && {
            colormap =
        ...
        /// The final value for display is set as:
        /// `colormap( ((value - data_display_range.min) / (data_display_range.max - data_display_range.min)) ** gamma )`
        TensorScalarMapping with_gamma(const dalaran::components::GammaCorrection& _gamma) && {
