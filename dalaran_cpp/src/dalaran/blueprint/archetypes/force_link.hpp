...
namespace dalaran::blueprint::archetypes {
    ...
    struct ForceLink {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.ForceLink";
        ...
        static constexpr auto Descriptor_distance = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ForceDistance>::ComponentType
        );
        ...
        static constexpr auto Descriptor_iterations = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ForceIterations>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// The link force aims to achieve a target distance between two nodes that are connected by one ore more edges.
        ForceLink with_enabled(const dalaran::blueprint::components::Enabled& _enabled) && {
            enabled = ComponentBatch::from_loggable(_enabled, Descriptor_enabled).value_or_throw();
            return std::move(*this);
        }

        /// The target distance between two nodes.
        ForceLink with_distance(const dalaran::blueprint::components::ForceDistance& _distance) && {
            distance =
        ...
        ///
        /// Increasing this parameter can lead to better results at the cost of longer computation time.
        ForceLink with_iterations(const dalaran::blueprint::components::ForceIterations& _iterations
        ) && {
            iterations =
