...
namespace dalaran::blueprint::archetypes {
    TensorScalarMapping TensorScalarMapping::clear_fields() {
        ...
        archetype.mag_filter =
            ComponentBatch::empty<dalaran::components::MagnificationFilter>(Descriptor_mag_filter)
                .value_or_throw();
        archetype.colormap = ComponentBatch::empty<dalaran::components::Colormap>(Descriptor_colormap)
                                 .value_or_throw();
        archetype.gamma =
            ComponentBatch::empty<dalaran::components::GammaCorrection>(Descriptor_gamma)
                .value_or_throw();
        return archetype;
    }
