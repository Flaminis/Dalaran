...
namespace dalaran::blueprint::archetypes {
    ...
    struct EntityBehavior {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.EntityBehavior";
        ...
        static constexpr auto Descriptor_interactive = ComponentDescriptor(
            ...
            Loggable<dalaran::components::Interactive>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// Defaults to parent's `interactive` value or true if there is no parent.
        EntityBehavior with_interactive(const dalaran::components::Interactive& _interactive) && {
        ...
        ///
        /// Defaults to parent's `visible` value or true if there is no parent.
        EntityBehavior with_visible(const dalaran::components::Visible& _visible) && {
