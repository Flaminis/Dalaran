...
namespace dalaran::blueprint::archetypes {
    ...
    struct TableBlueprint {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.TableBlueprint";
        ...
        static constexpr auto Descriptor_segment_preview_column = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ColumnName>::ComponentType
        );
      ...
      public:
        ...
        TableBlueprint with_segment_preview_column(
            const dalaran::blueprint::components::ColumnName& _segment_preview_column
        ) && {
        ...
        /// `dalaran:is_table_index` metadata since flag changes are persisted to the server
        /// via upsert.
        TableBlueprint with_flag_column(const dalaran::blueprint::components::ColumnName& _flag_column
        ) && {
        ...
        TableBlueprint with_grid_view_card_title(
            const dalaran::blueprint::components::ColumnName& _grid_view_card_title
        ) && {
        ...
        ///
        /// If unset, defaults to the segment preview column.
        TableBlueprint with_url_column(const dalaran::blueprint::components::ColumnName& _url_column
        ) && {
            url_column =
