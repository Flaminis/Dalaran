...
namespace dalaran::blueprint::archetypes {
    ...
    struct ForceCenter {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.ForceCenter";
      ...
      public:
        ...
        ///
        /// The center force tries to move the center of mass of the graph towards the origin.
        ForceCenter with_enabled(const dalaran::blueprint::components::Enabled& _enabled) && {
            enabled = ComponentBatch::from_loggable(_enabled, Descriptor_enabled).value_or_throw();
            return std::move(*this);
        }

        /// The strength of the force.
        ForceCenter with_strength(const dalaran::blueprint::components::ForceStrength& _strength) && {
            strength =
