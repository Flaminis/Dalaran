...
namespace dalaran::blueprint::archetypes {
    ...
    struct GraphBackground {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.GraphBackground";
      ...
      public:
        ...
        /// Color used for the background.
        GraphBackground with_color(const dalaran::components::Color& _color) && {
