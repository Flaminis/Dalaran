...
namespace dalaran::blueprint::archetypes {
    ViewportBlueprint ViewportBlueprint::clear_fields() {
        ...
        archetype.root_container =
            ComponentBatch::empty<dalaran::blueprint::components::RootContainer>(
                Descriptor_root_container
            )
                .value_or_throw();
        archetype.maximized =
            ComponentBatch::empty<dalaran::blueprint::components::ViewMaximized>(Descriptor_maximized)
                .value_or_throw();
        archetype.auto_layout =
            ComponentBatch::empty<dalaran::blueprint::components::AutoLayout>(Descriptor_auto_layout)
                .value_or_throw();
        archetype.auto_views =
            ComponentBatch::empty<dalaran::blueprint::components::AutoViews>(Descriptor_auto_views)
                .value_or_throw();
        archetype.past_viewer_recommendations =
            ComponentBatch::empty<dalaran::blueprint::components::ViewerRecommendationHash>(
