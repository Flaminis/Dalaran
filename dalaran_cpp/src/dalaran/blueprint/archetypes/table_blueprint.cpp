...
namespace dalaran::blueprint::archetypes {
    TableBlueprint TableBlueprint::clear_fields() {
        ...
        archetype.segment_preview_column =
            ComponentBatch::empty<dalaran::blueprint::components::ColumnName>(
                Descriptor_segment_preview_column
            )
                .value_or_throw();
        archetype.flag_column =
            ComponentBatch::empty<dalaran::blueprint::components::ColumnName>(Descriptor_flag_column)
                .value_or_throw();
        ...
        archetype.url_column =
            ComponentBatch::empty<dalaran::blueprint::components::ColumnName>(Descriptor_url_column)
                .value_or_throw();
        return archetype;
    }
