    ...
    struct ViewportBlueprint {
      ...
      public:
        ...
        static constexpr auto Descriptor_root_container = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::RootContainer>::ComponentType
        );
        ...
        static constexpr auto Descriptor_maximized = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ViewMaximized>::ComponentType
        );
        ...
        static constexpr auto Descriptor_auto_layout = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::AutoLayout>::ComponentType
        );
        ...
        static constexpr auto Descriptor_auto_views = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::AutoViews>::ComponentType
        );
        ...
        static constexpr auto Descriptor_past_viewer_recommendations = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ViewerRecommendationHash>::ComponentType
        );
      ...
      public:
        ...
        ViewportBlueprint with_root_container(
            const dalaran::blueprint::components::RootContainer& _root_container
        ) && {
            root_container =
        ...
        ViewportBlueprint with_maximized(
            const dalaran::blueprint::components::ViewMaximized& _maximized
        ) && {
            maximized =
        ...
        ViewportBlueprint with_auto_layout(
            const dalaran::blueprint::components::AutoLayout& _auto_layout
        ) && {
        ...
        /// and which aren't deemed redundant to existing views.
        /// This defaults to `false` and is automatically set to `false` when the user adds views manually in the viewer.
        ViewportBlueprint with_auto_views(const dalaran::blueprint::components::AutoViews& _auto_views
        ) && {
            auto_views =
        ...
        ViewportBlueprint with_past_viewer_recommendations(
            const Collection<dalaran::blueprint::components::ViewerRecommendationHash>&
