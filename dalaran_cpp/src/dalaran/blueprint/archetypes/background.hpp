...
namespace dalaran::blueprint::archetypes {
    ...
    struct Background {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.Background";
        ...
        static constexpr auto Descriptor_kind = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::BackgroundKind>::ComponentType
        );
        /// `ComponentDescriptor` for the `color` field.
        static constexpr auto Descriptor_color = ComponentDescriptor(
            ArchetypeName, "Background:color", Loggable<dalaran::components::Color>::ComponentType
        );
      ...
      public:
        ...
        explicit Background(dalaran::blueprint::components::BackgroundKind _kind)
        ...
        /// The type of the background.
        Background with_kind(const dalaran::blueprint::components::BackgroundKind& _kind) && {
            kind = ComponentBatch::from_loggable(_kind, Descriptor_kind).value_or_throw();
            return std::move(*this);
        }

        /// Color used for the solid background type.
        Background with_color(const dalaran::components::Color& _color) && {
