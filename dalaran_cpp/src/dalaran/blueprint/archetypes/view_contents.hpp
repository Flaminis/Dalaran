...
namespace dalaran::blueprint::archetypes {
    ...
    struct ViewContents {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.ViewContents";
        ...
        static constexpr auto Descriptor_query = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::QueryExpression>::ComponentType
        );
      ...
      public:
        ...
        explicit ViewContents(Collection<dalaran::blueprint::components::QueryExpression> _query)
        ...
        ViewContents with_query(
            const Collection<dalaran::blueprint::components::QueryExpression>& _query
        ) && {
