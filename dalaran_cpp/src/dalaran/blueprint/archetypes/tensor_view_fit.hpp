...
namespace dalaran::blueprint::archetypes {
    ...
    struct TensorViewFit {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.TensorViewFit";
        ...
        static constexpr auto Descriptor_scaling = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ViewFit>::ComponentType
        );
      ...
      public:
        ...
        /// How the image is scaled to fit the view.
        TensorViewFit with_scaling(const dalaran::blueprint::components::ViewFit& _scaling) && {
