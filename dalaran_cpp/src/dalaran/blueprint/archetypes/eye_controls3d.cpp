...
namespace dalaran::blueprint::archetypes {
    EyeControls3D EyeControls3D::clear_fields() {
        ...
        archetype.kind =
            ComponentBatch::empty<dalaran::blueprint::components::Eye3DKind>(Descriptor_kind)
                .value_or_throw();
        archetype.position =
            ComponentBatch::empty<dalaran::components::Position3D>(Descriptor_position)
                .value_or_throw();
        archetype.look_target =
            ComponentBatch::empty<dalaran::components::Position3D>(Descriptor_look_target)
                .value_or_throw();
        archetype.eye_up =
            ComponentBatch::empty<dalaran::components::Vector3D>(Descriptor_eye_up).value_or_throw();
        archetype.speed = ComponentBatch::empty<dalaran::components::LinearSpeed>(Descriptor_speed)
                              .value_or_throw();
        archetype.tracking_entity =
            ComponentBatch::empty<dalaran::components::EntityPath>(Descriptor_tracking_entity)
                .value_or_throw();
        archetype.spin_speed =
            ComponentBatch::empty<dalaran::blueprint::components::AngularSpeed>(Descriptor_spin_speed)
                .value_or_throw();
        return archetype;
    }
