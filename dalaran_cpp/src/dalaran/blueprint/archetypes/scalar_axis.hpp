...
namespace dalaran::blueprint::archetypes {
    ...
    struct ScalarAxis {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.ScalarAxis";

        /// `ComponentDescriptor` for the `range` field.
        static constexpr auto Descriptor_range = ComponentDescriptor(
            ArchetypeName, "ScalarAxis:range", Loggable<dalaran::components::Range1D>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// If unset, the range well be automatically determined based on the queried data.
        ScalarAxis with_range(const dalaran::components::Range1D& _range) && {
        ...
        ScalarAxis with_zoom_lock(
            const dalaran::blueprint::components::LockRangeDuringZoom& _zoom_lock
        ) && {
            zoom_lock =
