...
namespace dalaran::blueprint::archetypes {
    ...
    struct EyeControls3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.EyeControls3D";
        ...
        static constexpr auto Descriptor_kind = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::Eye3DKind>::ComponentType
        );
        ...
        static constexpr auto Descriptor_speed = ComponentDescriptor(
            ...
            Loggable<dalaran::components::LinearSpeed>::ComponentType
        );
        ...
        static constexpr auto Descriptor_spin_speed = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::AngularSpeed>::ComponentType
        );
      ...
      public:
        ...
        /// This controls how the eye movement behaves when the user interact with the view.
        /// Defaults to orbital.
        EyeControls3D with_kind(const dalaran::blueprint::components::Eye3DKind& _kind) && {
            kind = ComponentBatch::from_loggable(_kind, Descriptor_kind).value_or_throw();
            return std::move(*this);
        }

        /// The cameras current position.
        EyeControls3D with_position(const dalaran::components::Position3D& _position) && {
            position =
        ...
        ///
        /// By default this is the center of the scene bounds.
        EyeControls3D with_look_target(const dalaran::components::Position3D& _look_target) && {
        ...
        /// Initially, the up-axis of the eye will be the same as the up-axis of the scene (or +Z if
        /// the scene has no up axis defined).
        EyeControls3D with_eye_up(const dalaran::components::Vector3D& _eye_up) && {
        ...
        /// For orbit cameras it is derived from the distance to the orbit center.
        /// For first person cameras it is derived from the scene size.
        EyeControls3D with_speed(const dalaran::components::LinearSpeed& _speed) && {
        ...
        ///
        /// If this is a camera, it takes over the camera pose, otherwise follows the entity.
        EyeControls3D with_tracking_entity(const dalaran::components::EntityPath& _tracking_entity
        ) && {
            tracking_entity =
        ...
        ///
        /// Defaults to zero, meaning no spinning.
        EyeControls3D with_spin_speed(const dalaran::blueprint::components::AngularSpeed& _spin_speed
        ) && {
            spin_speed =
