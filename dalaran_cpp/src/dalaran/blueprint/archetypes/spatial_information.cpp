...
namespace dalaran::blueprint::archetypes {
    SpatialInformation SpatialInformation::clear_fields() {
        ...
        archetype.target_frame =
            ComponentBatch::empty<dalaran::components::TransformFrameId>(Descriptor_target_frame)
                .value_or_throw();
        archetype.show_bounding_box = ComponentBatch::empty<dalaran::blueprint::components::Enabled>(
                                          Descriptor_show_bounding_box
        )
                                          .value_or_throw();
        archetype.show_axes =
            ComponentBatch::empty<dalaran::blueprint::components::Enabled>(Descriptor_show_axes)
                .value_or_throw();
        archetype.axes = ComponentBatch::empty<dalaran::components::ViewCoordinates>(Descriptor_axes)
                             .value_or_throw();
        return archetype;
    }
