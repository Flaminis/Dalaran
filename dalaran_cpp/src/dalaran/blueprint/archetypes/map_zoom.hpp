...
namespace dalaran::blueprint::archetypes {
    ...
    struct MapZoom {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.MapZoom";
        ...
        static constexpr auto Descriptor_zoom = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::ZoomLevel>::ComponentType
        );
      ...
      public:
        ...
        explicit MapZoom(dalaran::blueprint::components::ZoomLevel _zoom)
        ...
        ///
        /// Zoom level follow the [`OpenStreetMap` definition](https://wiki.openstreetmap.org/wiki/Zoom_levels).
        MapZoom with_zoom(const dalaran::blueprint::components::ZoomLevel& _zoom) && {
