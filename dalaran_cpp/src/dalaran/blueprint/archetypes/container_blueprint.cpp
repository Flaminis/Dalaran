...
namespace dalaran::blueprint::archetypes {
    ContainerBlueprint ContainerBlueprint::clear_fields() {
        ...
        archetype.container_kind =
            ComponentBatch::empty<dalaran::blueprint::components::ContainerKind>(
                Descriptor_container_kind
            )
                .value_or_throw();
        archetype.display_name =
            ComponentBatch::empty<dalaran::components::Name>(Descriptor_display_name)
                .value_or_throw();
        archetype.contents =
            ComponentBatch::empty<dalaran::blueprint::components::IncludedContent>(Descriptor_contents
            )
                .value_or_throw();
        archetype.col_shares =
            ComponentBatch::empty<dalaran::blueprint::components::ColumnShare>(Descriptor_col_shares)
                .value_or_throw();
        archetype.row_shares =
            ComponentBatch::empty<dalaran::blueprint::components::RowShare>(Descriptor_row_shares)
                .value_or_throw();
        archetype.active_tab =
            ComponentBatch::empty<dalaran::blueprint::components::ActiveTab>(Descriptor_active_tab)
                .value_or_throw();
        archetype.visible =
            ComponentBatch::empty<dalaran::components::Visible>(Descriptor_visible).value_or_throw();
        archetype.grid_columns =
            ComponentBatch::empty<dalaran::blueprint::components::GridColumns>(Descriptor_grid_columns
            )
                .value_or_throw();
        return archetype;
    }
