    ...
    struct TimePanelBlueprint {
      ...
      public:
        ...
        static constexpr auto Descriptor_state = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::PanelState>::ComponentType
        );
        ...
        static constexpr auto Descriptor_playback_speed = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::PlaybackSpeed>::ComponentType
        );
        ...
        static constexpr auto Descriptor_fps = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::Fps>::ComponentType
        );
        ...
        static constexpr auto Descriptor_play_state = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::PlayState>::ComponentType
        );
        ...
        static constexpr auto Descriptor_loop_mode = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::LoopMode>::ComponentType
        );
        ...
        static constexpr auto Descriptor_time_selection = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::AbsoluteTimeRange>::ComponentType
        );
      ...
      public:
        ...
        /// Current state of the panel.
        TimePanelBlueprint with_state(const dalaran::blueprint::components::PanelState& _state) && {
            state = ComponentBatch::from_loggable(_state, Descriptor_state).value_or_throw();
            return std::move(*this);
        }

        /// What timeline the panel is on.
        TimePanelBlueprint with_timeline(const dalaran::blueprint::components::TimelineName& _timeline
        ) && {
            timeline =
        ...
        TimePanelBlueprint with_playback_speed(
            const dalaran::blueprint::components::PlaybackSpeed& _playback_speed
        ) && {
            playback_speed =
        ...
        /// Frames per second. Only applicable for sequence timelines.
        TimePanelBlueprint with_fps(const dalaran::blueprint::components::Fps& _fps) && {
        ...
        TimePanelBlueprint with_play_state(
            const dalaran::blueprint::components::PlayState& _play_state
        ) && {
            play_state =
        ...
        ///
        /// Defaults to off.
        TimePanelBlueprint with_loop_mode(const dalaran::blueprint::components::LoopMode& _loop_mode
        ) && {
            loop_mode =
        ...
        TimePanelBlueprint with_time_selection(
            const dalaran::blueprint::components::AbsoluteTimeRange& _time_selection
        ) && {
            time_selection =
