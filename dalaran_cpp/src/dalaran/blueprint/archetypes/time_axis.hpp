...
namespace dalaran::blueprint::archetypes {
    ...
    struct TimeAxis {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.TimeAxis";
        ...
        static constexpr auto Descriptor_link = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::LinkAxis>::ComponentType
        );
        ...
        static constexpr auto Descriptor_view_range = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::TimeRange>::ComponentType
        );
        ...
        static constexpr auto Descriptor_zoom_lock = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::LockRangeDuringZoom>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// Linking with global will ignore `view_range`.
        TimeAxis with_link(const dalaran::blueprint::components::LinkAxis& _link) && {
            link = ComponentBatch::from_loggable(_link, Descriptor_link).value_or_throw();
            return std::move(*this);
        }

        /// The view range of the horizontal/X/time axis.
        TimeAxis with_view_range(const dalaran::blueprint::components::TimeRange& _view_range) && {
            view_range =
        ...
        /// If enabled, the X axis range will remain locked to the specified range when zooming.
        TimeAxis with_zoom_lock(const dalaran::blueprint::components::LockRangeDuringZoom& _zoom_lock
        ) && {
            zoom_lock =
