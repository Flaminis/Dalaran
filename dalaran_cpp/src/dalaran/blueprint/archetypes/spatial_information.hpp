...
namespace dalaran::blueprint::archetypes {
    ...
    struct SpatialInformation {
      ...
      public:
        ...
        explicit SpatialInformation(dalaran::components::TransformFrameId _target_frame)
            : target_frame(
        ...
        SpatialInformation with_target_frame(
            const dalaran::components::TransformFrameId& _target_frame
        ) && {
        ...
        SpatialInformation with_show_bounding_box(
            const dalaran::blueprint::components::Enabled& _show_bounding_box
        ) && {
            show_bounding_box =
        ...
        /// Whether axes should be shown at the origin.
        SpatialInformation with_show_axes(const dalaran::blueprint::components::Enabled& _show_axes
        ) && {
            show_axes =
        ...
        ///
        /// ⚠ [Dalaran does not yet support left-handed coordinate systems](https://github.com/rerun-io/rerun/issues/5032).
        SpatialInformation with_axes(const dalaran::components::ViewCoordinates& _axes) && {
