...
namespace dalaran::blueprint::archetypes {
    ...
    struct PanelBlueprint {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.PanelBlueprint";
      ...
      public:
        ...
        /// Current state of the panel.
        PanelBlueprint with_state(const dalaran::blueprint::components::PanelState& _state) && {
