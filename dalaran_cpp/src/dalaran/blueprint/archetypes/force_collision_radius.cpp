...
namespace dalaran::blueprint::archetypes {
    ForceCollisionRadius ForceCollisionRadius::clear_fields() {
        ...
        archetype.enabled =
            ComponentBatch::empty<dalaran::blueprint::components::Enabled>(Descriptor_enabled)
                .value_or_throw();
        archetype.strength =
            ComponentBatch::empty<dalaran::blueprint::components::ForceStrength>(Descriptor_strength)
                .value_or_throw();
        archetype.iterations = ComponentBatch::empty<dalaran::blueprint::components::ForceIterations>(
