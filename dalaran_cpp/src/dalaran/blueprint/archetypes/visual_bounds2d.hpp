...
namespace dalaran::blueprint::archetypes {
    ...
    struct VisualBounds2D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.VisualBounds2D";
        ...
        static constexpr auto Descriptor_range = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::VisualBounds2D>::ComponentType
        );
      ...
      public:
        ...
        explicit VisualBounds2D(dalaran::blueprint::components::VisualBounds2D _range)
        ...
        ///
        /// Use this to control pan & zoom of the view.
        VisualBounds2D with_range(const dalaran::blueprint::components::VisualBounds2D& _range) && {
