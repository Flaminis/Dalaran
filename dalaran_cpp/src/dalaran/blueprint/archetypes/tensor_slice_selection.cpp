...
namespace dalaran::blueprint::archetypes {
    TensorSliceSelection TensorSliceSelection::clear_fields() {
        ...
        archetype.width =
            ComponentBatch::empty<dalaran::components::TensorWidthDimension>(Descriptor_width)
                .value_or_throw();
        archetype.height =
            ComponentBatch::empty<dalaran::components::TensorHeightDimension>(Descriptor_height)
                .value_or_throw();
        archetype.indices = ComponentBatch::empty<dalaran::components::TensorDimensionIndexSelection>(
                                Descriptor_indices
        )
                                .value_or_throw();
        archetype.slider =
            ComponentBatch::empty<dalaran::blueprint::components::TensorDimensionIndexSlider>(
                Descriptor_slider
            )
                .value_or_throw();
        return archetype;
