...
namespace dalaran::blueprint::archetypes {
    ...
    struct LineGrid3D {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.LineGrid3D";

        /// `ComponentDescriptor` for the `visible` field.
        static constexpr auto Descriptor_visible = ComponentDescriptor(
            ArchetypeName, "LineGrid3D:visible", Loggable<dalaran::components::Visible>::ComponentType
        );
        ...
        static constexpr auto Descriptor_spacing = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::GridSpacing>::ComponentType
        );
        /// `ComponentDescriptor` for the `plane` field.
        static constexpr auto Descriptor_plane = ComponentDescriptor(
            ArchetypeName, "LineGrid3D:plane", Loggable<dalaran::components::Plane3D>::ComponentType
        );
        ...
        static constexpr auto Descriptor_color = ComponentDescriptor(
            ArchetypeName, "LineGrid3D:color", Loggable<dalaran::components::Color>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// Defaults to true.
        LineGrid3D with_visible(const dalaran::components::Visible& _visible) && {
        ...
        /// As you zoom out, successively only every tenth line is shown.
        /// This controls the closest zoom level.
        LineGrid3D with_spacing(const dalaran::blueprint::components::GridSpacing& _spacing) && {
        ...
        ///
        /// Defaults to the plane at zero units along the up/down axis defined by `archetypes::SpatialInformation`'s axes property.
        LineGrid3D with_plane(const dalaran::components::Plane3D& _plane) && {
        ...
        ///
        /// Default is 1.0 ui unit.
        LineGrid3D with_stroke_width(const dalaran::components::StrokeWidth& _stroke_width) && {
        ...
        /// Transparency via alpha channel is supported.
        /// Defaults to a slightly transparent light gray.
        LineGrid3D with_color(const dalaran::components::Color& _color) && {
