    ...
    struct TensorSliceSelection {
      ...
      public:
        ...
        static constexpr auto Descriptor_width = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TensorWidthDimension>::ComponentType
        );
        ...
        static constexpr auto Descriptor_height = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TensorHeightDimension>::ComponentType
        );
        ...
        static constexpr auto Descriptor_indices = ComponentDescriptor(
            ...
            Loggable<dalaran::components::TensorDimensionIndexSelection>::ComponentType
        );
        ...
        static constexpr auto Descriptor_slider = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::TensorDimensionIndexSlider>::ComponentType
        );
      ...
      public:
        ...
        ///
        /// If not specified, the height will be determined automatically based on the name and index of the dimension.
        TensorSliceSelection with_width(const dalaran::components::TensorWidthDimension& _width) && {
        ...
        ///
        /// If not specified, the height will be determined automatically based on the name and index of the dimension.
        TensorSliceSelection with_height(const dalaran::components::TensorHeightDimension& _height
        ) && {
        ...
        TensorSliceSelection with_indices(
            const Collection<dalaran::components::TensorDimensionIndexSelection>& _indices
        ) && {
        ...
        TensorSliceSelection with_slider(
            const Collection<dalaran::blueprint::components::TensorDimensionIndexSlider>& _slider
        ) && {
