...
namespace dalaran::blueprint::archetypes {
    ViewBlueprint ViewBlueprint::clear_fields() {
        ...
        archetype.class_identifier = ComponentBatch::empty<dalaran::blueprint::components::ViewClass>(
        ...
        archetype.space_origin =
            ComponentBatch::empty<dalaran::blueprint::components::ViewOrigin>(Descriptor_space_origin)
                .value_or_throw();
        archetype.visible =
