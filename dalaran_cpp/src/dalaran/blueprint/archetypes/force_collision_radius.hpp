...
namespace dalaran::blueprint::archetypes {
    ...
    struct ForceCollisionRadius {
      ...
      public:
        ...
        ///
        /// The collision force resolves collisions between nodes based on the bounding circle defined by their radius.
        ForceCollisionRadius with_enabled(const dalaran::blueprint::components::Enabled& _enabled
        ) && {
        ...
        ForceCollisionRadius with_strength(
            const dalaran::blueprint::components::ForceStrength& _strength
        ) && {
            strength =
        ...
        ForceCollisionRadius with_iterations(
            const dalaran::blueprint::components::ForceIterations& _iterations
        ) && {
            iterations =
