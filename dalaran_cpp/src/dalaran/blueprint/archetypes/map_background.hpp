...
namespace dalaran::blueprint::archetypes {
    ...
    struct MapBackground {
      ...
      public:
        ...
        static constexpr const char ArchetypeName[] = "dalaran.blueprint.archetypes.MapBackground";
        ...
        static constexpr auto Descriptor_provider = ComponentDescriptor(
            ...
            Loggable<dalaran::blueprint::components::MapProvider>::ComponentType
        );
      ...
      public:
        ...
        explicit MapBackground(dalaran::blueprint::components::MapProvider _provider)
        ...
        ///
        /// **Note**: Requires a Mapbox API key in the `DALARAN_MAPBOX_ACCESS_TOKEN` environment variable.
        MapBackground with_provider(const dalaran::blueprint::components::MapProvider& _provider) && {
            provider =
