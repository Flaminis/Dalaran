...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>&
        ...
        static const auto datatype = arrow::struct_({
            arrow::field("target", Loggable<dalaran::datatypes::Utf8>::arrow_datatype(), false),
            arrow::field(
                "source_kind",
                Loggable<dalaran::blueprint::datatypes::ComponentSourceKind>::arrow_datatype(),
                false
            ),
    ...
    dalaran::Error
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(
                    Loggable<dalaran::blueprint::datatypes::ComponentSourceKind>::
