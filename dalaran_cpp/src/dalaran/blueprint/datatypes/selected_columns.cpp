...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>&
        ...
        static const auto datatype = arrow::struct_({
            arrow::field(
                "time_columns",
                arrow::list(
                    arrow::field("item", Loggable<dalaran::datatypes::Utf8>::arrow_datatype(), false)
                ),
                false
            ),
            arrow::field(
    ...
    dalaran::Error Loggable<blueprint::datatypes::SelectedColumns>::fill_arrow_array_builder(
