...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>&
        ...
        static const auto datatype = arrow::struct_({
            arrow::field("active", Loggable<dalaran::datatypes::Bool>::arrow_datatype(), false),
            arrow::field(
                "column",
                Loggable<dalaran::blueprint::datatypes::ComponentColumnSelector>::arrow_datatype(),
                false
            ),
        });
        return datatype;
    ...
    dalaran::Error Loggable<blueprint::datatypes::FilterIsNotNull>::fill_arrow_array_builder(
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(
                    Loggable<dalaran::blueprint::datatypes::ComponentColumnSelector>::
