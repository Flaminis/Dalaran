...
namespace dalaran {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::Corner2D>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<blueprint::components::Corner2D>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<blueprint::components::Corner2D>::fill_arrow_array_builder(
