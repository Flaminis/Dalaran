...
namespace dalaran {
    ...
    struct Loggable<blueprint::components::Eye3DKind> {
        static constexpr std::string_view ComponentType = "dalaran.blueprint.components.Eye3DKind";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::blueprint:: components::Eye3DKind` into an arrow array.
