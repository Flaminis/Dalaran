...
namespace dalaran {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::MapProvider>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<blueprint::components::MapProvider>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<blueprint::components::MapProvider>::fill_arrow_array_builder(
