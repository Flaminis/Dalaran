...
namespace dalaran {
    ...
    struct Loggable<blueprint::components::MapProvider> {
        static constexpr std::string_view ComponentType = "dalaran.blueprint.components.MapProvider";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::blueprint:: components::MapProvider` into an arrow array.
