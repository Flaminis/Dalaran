...
#ifdef Unsorted
#error \
    "Found a macro 'Unsorted' (probably from X11), conflicting with `dalaran::SortingStatus::Unsorted`. Add '#undef Unsorted' before '#include <dalaran.hpp>' to work around this."
#endif
