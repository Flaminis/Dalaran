...
namespace dalaran {
    ...
    ///
    /// This is essentially an array of `dalaran::ComponentBatch` with all batches
    /// continuously in a single array.
    ///
    /// \see `dalaran::RecordingStream::send_columns`
    struct ComponentColumn {
      ...
      public:
        ...
        /// \param lengths The number of components in each run. for `dalaran::RecordingStream::send_columns`,
        ...
        static Result<ComponentColumn> from_loggable_with_lengths(
            ...
            const ComponentDescriptor& descriptor = dalaran::Loggable<T>::Descriptor
        ) {
        ...
        ///
        /// When used with `dalaran::RecordingStream::send_columns`, this is equivalent to `from_loggable(components, std::vector{1, 1, ...})`.
        ...
        /// To dalaran C API component batch.
        ///
