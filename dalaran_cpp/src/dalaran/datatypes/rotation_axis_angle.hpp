...
namespace dalaran::datatypes {
    ...
    struct RotationAxisAngle {
        ...
        dalaran::datatypes::Vec3D axis;

        /// How much to rotate around the axis.
        dalaran::datatypes::Angle angle;
...
namespace dalaran {
    ...
    struct Loggable<datatypes::RotationAxisAngle> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.RotationAxisAngle";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::RotationAxisAngle` into an arrow array.
