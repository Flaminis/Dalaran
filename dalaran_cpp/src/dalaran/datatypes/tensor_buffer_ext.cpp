...
namespace dalaran::datatypes {
    ...
    /// `dalaran::ContainerAdapter` exists.
    ///
    /// This constructor assumes the type of tensor buffer you want to use is defined by `TContainer::value_type`
    /// and then forwards the argument as-is to the appropriate `dalaran::Container` constructor.
    /// \see dalaran::ContainerAdapter, dalaran::Container
