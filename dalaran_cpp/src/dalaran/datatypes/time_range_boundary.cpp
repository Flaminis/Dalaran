...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::TimeRangeBoundary>::arrow_datatype(
        ...
        static const auto datatype = arrow::dense_union({
            ...
            arrow::field(
                "CursorRelative",
                Loggable<dalaran::datatypes::TimeInt>::arrow_datatype(),
                false
            ),
            arrow::field("Absolute", Loggable<dalaran::datatypes::TimeInt>::arrow_datatype(), false),
    ...
    dalaran::Error Loggable<datatypes::TimeRangeBoundary>::fill_arrow_array_builder(
