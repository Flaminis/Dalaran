...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::KeypointPair>::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            arrow::field(
                "keypoint0",
                Loggable<dalaran::datatypes::KeypointId>::arrow_datatype(),
                false
            ),
            arrow::field(
                "keypoint1",
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::KeypointPair>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::KeypointPair>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::KeypointPair>::fill_arrow_array_builder(
...

        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(Loggable<dalaran::datatypes::KeypointId>::fill_arrow_array_builder(
                    field_builder,
