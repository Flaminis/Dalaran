...
namespace dalaran {
    ...
    struct Loggable<datatypes::ChannelDatatype> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.ChannelDatatype";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::ChannelDatatype` into an arrow array.
