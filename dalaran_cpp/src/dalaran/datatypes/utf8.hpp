...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/utf8.fbs".
...
namespace dalaran {
    ...
    struct Loggable<datatypes::Utf8> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.Utf8";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::Utf8` into an arrow array.
