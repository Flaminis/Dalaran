...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/tensor_buffer.fbs".
...
namespace dalaran::datatypes {
    namespace detail {
        ...
        union TensorBufferData {
            ...
            dalaran::Collection<uint8_t> u8;

            /// 16bit unsigned integer.
            dalaran::Collection<uint16_t> u16;

            /// 32bit unsigned integer.
            dalaran::Collection<uint32_t> u32;

            /// 64bit unsigned integer.
            dalaran::Collection<uint64_t> u64;

            /// 8bit signed integer.
            dalaran::Collection<int8_t> i8;

            /// 16bit signed integer.
            dalaran::Collection<int16_t> i16;

            /// 32bit signed integer.
            dalaran::Collection<int32_t> i32;

            /// 64bit signed integer.
            dalaran::Collection<int64_t> i64;

            /// 16bit IEEE-754 floating point, also known as `half`.
            dalaran::Collection<dalaran::half> f16;

            /// 32bit IEEE-754 floating point, also known as `float` or `single`.
            dalaran::Collection<float> f32;

            /// 64bit IEEE-754 floating point, also known as `double`.
            dalaran::Collection<double> f64;
    ...
    struct TensorBuffer {
      ...
      public: // START of extensions from tensor_buffer_ext.cpp:
        ...
        /// 8bit unsigned integer.
        TensorBuffer(dalaran::Collection<uint8_t> u8) : TensorBuffer() {
            *this = TensorBuffer::u8(std::move(u8));
        }

        /// 16bit unsigned integer.
        TensorBuffer(dalaran::Collection<uint16_t> u16) : TensorBuffer() {
            *this = TensorBuffer::u16(std::move(u16));
        }

        /// 32bit unsigned integer.
        TensorBuffer(dalaran::Collection<uint32_t> u32) : TensorBuffer() {
            *this = TensorBuffer::u32(std::move(u32));
        }

        /// 64bit unsigned integer.
        TensorBuffer(dalaran::Collection<uint64_t> u64) : TensorBuffer() {
            *this = TensorBuffer::u64(std::move(u64));
        }

        /// 8bit signed integer.
        TensorBuffer(dalaran::Collection<int8_t> i8) : TensorBuffer() {
            *this = TensorBuffer::i8(std::move(i8));
        }

        /// 16bit signed integer.
        TensorBuffer(dalaran::Collection<int16_t> i16) : TensorBuffer() {
            *this = TensorBuffer::i16(std::move(i16));
        }

        /// 32bit signed integer.
        TensorBuffer(dalaran::Collection<int32_t> i32) : TensorBuffer() {
            *this = TensorBuffer::i32(std::move(i32));
        }

        /// 64bit signed integer.
        TensorBuffer(dalaran::Collection<int64_t> i64) : TensorBuffer() {
            *this = TensorBuffer::i64(std::move(i64));
        }

        /// 16bit IEEE-754 floating point, also known as `half`.
        TensorBuffer(dalaran::Collection<dalaran::half> f16) : TensorBuffer() {
            *this = TensorBuffer::f16(std::move(f16));
        }

        /// 32bit IEEE-754 floating point, also known as `float` or `single`.
        TensorBuffer(dalaran::Collection<float> f32) : TensorBuffer() {
            *this = TensorBuffer::f32(std::move(f32));
        }

        /// 64bit IEEE-754 floating point, also known as `double`.
        TensorBuffer(dalaran::Collection<double> f64) : TensorBuffer() {
            *this = TensorBuffer::f64(std::move(f64));
        }

        /// 8bit unsigned integer.
        static TensorBuffer u8(dalaran::Collection<uint8_t> u8) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::U8;
            new (&self._data.u8) dalaran::Collection<uint8_t>(std::move(u8));
            return self;
        }

        /// 16bit unsigned integer.
        static TensorBuffer u16(dalaran::Collection<uint16_t> u16) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::U16;
            new (&self._data.u16) dalaran::Collection<uint16_t>(std::move(u16));
            return self;
        }

        /// 32bit unsigned integer.
        static TensorBuffer u32(dalaran::Collection<uint32_t> u32) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::U32;
            new (&self._data.u32) dalaran::Collection<uint32_t>(std::move(u32));
            return self;
        }

        /// 64bit unsigned integer.
        static TensorBuffer u64(dalaran::Collection<uint64_t> u64) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::U64;
            new (&self._data.u64) dalaran::Collection<uint64_t>(std::move(u64));
            return self;
        }

        /// 8bit signed integer.
        static TensorBuffer i8(dalaran::Collection<int8_t> i8) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::I8;
            new (&self._data.i8) dalaran::Collection<int8_t>(std::move(i8));
            return self;
        }

        /// 16bit signed integer.
        static TensorBuffer i16(dalaran::Collection<int16_t> i16) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::I16;
            new (&self._data.i16) dalaran::Collection<int16_t>(std::move(i16));
            return self;
        }

        /// 32bit signed integer.
        static TensorBuffer i32(dalaran::Collection<int32_t> i32) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::I32;
            new (&self._data.i32) dalaran::Collection<int32_t>(std::move(i32));
            return self;
        }

        /// 64bit signed integer.
        static TensorBuffer i64(dalaran::Collection<int64_t> i64) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::I64;
            new (&self._data.i64) dalaran::Collection<int64_t>(std::move(i64));
            return self;
        }

        /// 16bit IEEE-754 floating point, also known as `half`.
        static TensorBuffer f16(dalaran::Collection<dalaran::half> f16) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::F16;
            new (&self._data.f16) dalaran::Collection<dalaran::half>(std::move(f16));
            return self;
        }

        /// 32bit IEEE-754 floating point, also known as `float` or `single`.
        static TensorBuffer f32(dalaran::Collection<float> f32) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::F32;
            new (&self._data.f32) dalaran::Collection<float>(std::move(f32));
            return self;
        }

        /// 64bit IEEE-754 floating point, also known as `double`.
        static TensorBuffer f64(dalaran::Collection<double> f64) {
            TensorBuffer self;
            self._tag = detail::TensorBufferTag::F64;
            new (&self._data.f64) dalaran::Collection<double>(std::move(f64));
            return self;
        }

        /// Return a pointer to u8 if the union is in that state, otherwise `nullptr`.
        const dalaran::Collection<uint8_t>* get_u8() const {
        ...
        const dalaran::Collection<uint16_t>* get_u16() const {
        ...
        const dalaran::Collection<uint32_t>* get_u32() const {
        ...
        const dalaran::Collection<uint64_t>* get_u64() const {
        ...
        const dalaran::Collection<int8_t>* get_i8() const {
        ...
        const dalaran::Collection<int16_t>* get_i16() const {
        ...
        const dalaran::Collection<int32_t>* get_i32() const {
        ...
        const dalaran::Collection<int64_t>* get_i64() const {
        ...
        const dalaran::Collection<dalaran::half>* get_f16() const {
        ...
        const dalaran::Collection<float>* get_f32() const {
        ...
        const dalaran::Collection<double>* get_f64() const {
...
namespace dalaran {
    ...
    struct Loggable<datatypes::TensorBuffer> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.TensorBuffer";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::TensorBuffer` into an arrow array.
