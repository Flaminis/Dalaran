...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::ClassDescription>::arrow_datatype(
        ...
        static const auto datatype = arrow::struct_({
            arrow::field(
                "info",
                Loggable<dalaran::datatypes::AnnotationInfo>::arrow_datatype(),
                false
            ),
            arrow::field(
            ...
            arrow::field(
                ...
                arrow::list(arrow::field(
                    "item",
                    Loggable<dalaran::datatypes::KeypointPair>::arrow_datatype(),
                    false
                )),
                false
            ),
    ...
    dalaran::Error Loggable<datatypes::ClassDescription>::fill_arrow_array_builder(
...

        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(
                    Loggable<dalaran::datatypes::AnnotationInfo>::fill_arrow_array_builder(
                        field_builder,
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                ...
                if (element.keypoint_connections.data()) {
                    DL_RETURN_NOT_OK(
                        Loggable<dalaran::datatypes::KeypointPair>::fill_arrow_array_builder(
                            value_builder,
