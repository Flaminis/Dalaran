...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::AnnotationInfo>::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            ...
            arrow::field("label", Loggable<dalaran::datatypes::Utf8>::arrow_datatype(), true),
            arrow::field("color", Loggable<dalaran::datatypes::Rgba32>::arrow_datatype(), true),
        });
        return datatype;
    }
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::AnnotationInfo>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::AnnotationInfo>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::AnnotationInfo>::fill_arrow_array_builder(
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                ...
                if (element.color.has_value()) {
                    DL_RETURN_NOT_OK(Loggable<dalaran::datatypes::Rgba32>::fill_arrow_array_builder(
                        field_builder,
                        &element.color.value(),
                        1
                    ));
