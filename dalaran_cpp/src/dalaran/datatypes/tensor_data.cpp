...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::TensorData>::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            ...
            arrow::field(
                "buffer",
                Loggable<dalaran::datatypes::TensorBuffer>::arrow_datatype(),
                true
            ),
        });
        return datatype;
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::TensorData>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::TensorData>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::TensorData>::fill_arrow_array_builder(
        ...
        }
        {
            ...
            ARROW_RETURN_NOT_OK(field_builder->Reserve(static_cast<int64_t>(num_elements)));
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(Loggable<dalaran::datatypes::TensorBuffer>::fill_arrow_array_builder(
                    field_builder,
