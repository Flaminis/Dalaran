...
namespace dalaran::datatypes {
    ...
    struct AnnotationInfo {
        ...
        std::optional<dalaran::datatypes::Utf8> label;

        /// The color that will be applied to the annotated entity.
        std::optional<dalaran::datatypes::Rgba32> color;
...
namespace dalaran {
    ...
    struct Loggable<datatypes::AnnotationInfo> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.AnnotationInfo";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::AnnotationInfo` into an arrow array.
