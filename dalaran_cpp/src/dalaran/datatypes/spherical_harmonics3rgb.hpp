...
namespace dalaran::datatypes {
    ...
    struct SphericalHarmonics3Rgb {
        ...
        std::array<std::array<dalaran::half, 3>, 15> coefficients;
...
namespace dalaran {
    ...
    struct Loggable<datatypes::SphericalHarmonics3Rgb> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.SphericalHarmonics3Rgb";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::SphericalHarmonics3Rgb` into an arrow array.
