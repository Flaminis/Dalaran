...
namespace dalaran {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::TensorBuffer>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            DL_RETURN_NOT_OK(Loggable<datatypes::TensorBuffer>::fill_arrow_array_builder(
    ...
    dalaran::Error Loggable<datatypes::TensorBuffer>::fill_arrow_array_builder(
        ...
        for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
            ...
            switch (union_instance.get_union_tag()) {
                ...
                case TagType::F16: {
                    ...
                    const dalaran::half* values = union_instance.get_union_data().f16.data();
                    ARROW_RETURN_NOT_OK(value_builder->AppendValues(
