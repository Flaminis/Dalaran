...
namespace dalaran {
    namespace datatypes {
        ...
        struct ImageFormatExt {
            uint32_t width;
            uint32_t height;
            std::optional<dalaran::datatypes::PixelFormat> pixel_format;
            std::optional<dalaran::datatypes::ColorModel> color_model;
            std::optional<dalaran::datatypes::ChannelDatatype> channel_datatype;
...
#define KeypointPair ImageFormatExt
            ...
            ImageFormat(dalaran::WidthHeight resolution, datatypes::PixelFormat pixel_format_)
            ...
            ImageFormat(dalaran::WidthHeight resolution, datatypes::ChannelDatatype datatype_)
                : width(resolution.width), height(resolution.height), channel_datatype(datatype_) {}

            ImageFormat(
                dalaran::WidthHeight resolution, datatypes::ColorModel color_model_,
