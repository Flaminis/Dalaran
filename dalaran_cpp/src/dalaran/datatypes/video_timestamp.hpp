...
namespace dalaran {
    ...
    struct Loggable<datatypes::VideoTimestamp> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.VideoTimestamp";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::VideoTimestamp` into an arrow array.
