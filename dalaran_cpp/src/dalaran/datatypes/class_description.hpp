...
namespace dalaran::datatypes {
    ...
    ///
    /// If an entity is annotated with a corresponding `components::ClassId`, Dalaran will use
    ...
    struct ClassDescription {
        ...
        dalaran::datatypes::AnnotationInfo info;

        /// The `datatypes::AnnotationInfo` for all of the keypoints.
        dalaran::Collection<dalaran::datatypes::AnnotationInfo> keypoint_annotations;

        /// The connections between keypoints.
        dalaran::Collection<dalaran::datatypes::KeypointPair> keypoint_connections;
...
namespace dalaran {
    ...
    struct Loggable<datatypes::ClassDescription> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.ClassDescription";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::ClassDescription` into an arrow array.
