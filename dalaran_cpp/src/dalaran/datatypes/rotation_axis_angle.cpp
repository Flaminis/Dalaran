...
namespace dalaran {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::RotationAxisAngle>::arrow_datatype(
        ...
        static const auto datatype = arrow::struct_({
            arrow::field("axis", Loggable<dalaran::datatypes::Vec3D>::arrow_datatype(), false),
            arrow::field("angle", Loggable<dalaran::datatypes::Angle>::arrow_datatype(), false),
        });
        return datatype;
    }
    ...
    dalaran::Error Loggable<datatypes::RotationAxisAngle>::fill_arrow_array_builder(
...

        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(Loggable<dalaran::datatypes::Vec3D>::fill_arrow_array_builder(
                    field_builder,
        ...
        }
        {
            ...
            ARROW_RETURN_NOT_OK(field_builder->Reserve(static_cast<int64_t>(num_elements)));
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                DL_RETURN_NOT_OK(Loggable<dalaran::datatypes::Angle>::fill_arrow_array_builder(
                    field_builder,
