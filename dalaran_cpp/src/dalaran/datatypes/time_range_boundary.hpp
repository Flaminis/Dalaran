...
namespace dalaran::datatypes {
    namespace detail {
        ...
        union TimeRangeBoundaryData {
            ...
            dalaran::datatypes::TimeInt cursor_relative;

            /// Boundary is an absolute value.
            dalaran::datatypes::TimeInt absolute;
    ...
    struct TimeRangeBoundary {
        ...
        /// Boundary is a value relative to the time cursor.
        static TimeRangeBoundary cursor_relative(dalaran::datatypes::TimeInt cursor_relative) {
            TimeRangeBoundary self;
            self._tag = detail::TimeRangeBoundaryTag::CursorRelative;
            new (&self._data.cursor_relative) dalaran::datatypes::TimeInt(std::move(cursor_relative));
            return self;
        }

        /// Boundary is an absolute value.
        static TimeRangeBoundary absolute(dalaran::datatypes::TimeInt absolute) {
            TimeRangeBoundary self;
            self._tag = detail::TimeRangeBoundaryTag::Absolute;
            new (&self._data.absolute) dalaran::datatypes::TimeInt(std::move(absolute));
            return self;
        }
        ...
        const dalaran::datatypes::TimeInt* get_cursor_relative() const {
        ...
        const dalaran::datatypes::TimeInt* get_absolute() const {
...
namespace dalaran {
    ...
    struct Loggable<datatypes::TimeRangeBoundary> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.TimeRangeBoundary";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::TimeRangeBoundary` into an arrow array.
