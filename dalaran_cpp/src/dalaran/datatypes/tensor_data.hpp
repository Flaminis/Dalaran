...
namespace dalaran::datatypes {
    ...
    struct TensorData {
        ...
        std::optional<dalaran::Collection<std::string>> names;
...
namespace dalaran {
    ...
    struct Loggable<datatypes::TensorData> {
        static constexpr std::string_view ComponentType = "dalaran.datatypes.TensorData";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `dalaran::datatypes::TensorData` into an arrow array.
