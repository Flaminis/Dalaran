...
///
/// This is practically a deserialized & validated version of [`dl_sdk_types::blueprint::archetypes::TensorSliceSelection`].
...
impl TensorSliceSelection {
    ...
    ) -> Result<Self, dl_sdk_types::DeserializationError> {
...
fn make_indices_valid(
    ...
    for (i, _) in covered_dims.into_iter().enumerate().filter(|(_, b)| !b) {
        indices.push(
            dl_sdk_types::datatypes::TensorDimensionIndexSelection {
                dimension: i as u32,
...
mod tests {
    use dl_sdk_types::blueprint::components::TensorDimensionIndexSlider;
    use dl_sdk_types::components::TensorDimensionIndexSelection;
