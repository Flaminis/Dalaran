...
use dl_renderer::resource_managers::{GpuTexture2D, ImageDataDesc, TextureManager2DError};
use dl_sdk_types::components::GammaCorrection;
use dl_sdk_types::datatypes::TensorData;
use dl_sdk_types::tensor_data::{TensorCastError, TensorDataType};
use dl_viewer_context::ColormapWithRange;
use dl_viewer_context::gpu_bridge::{self, colormap_to_re_renderer};
...
fn to_texture_desc<From: Copy, To: bytemuck::Pod>(
    ...
    {
        dl_tracing::profile_scope!("copy_from_slice");
    ...
    dl_tracing::profile_scope!("pod_collect_to_vec");
    Ok(ImageDataDesc {
