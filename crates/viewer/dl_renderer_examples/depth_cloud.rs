...
//! Native:
//! ```sh
//! cargo r -p dl_renderer --example depth_cloud
//! ```
//!
//! Web:
//! ```sh
...
impl RenderDepthClouds {
        ...
        ID: DrawData + Sync + Send + Clone + 'static,
    {
        ...
        let depth_cloud_draw_data = DepthCloudDrawData::new(
            ...
            &DepthClouds {
                clouds: vec![DepthCloud {
                    ...
                    colormap: dl_renderer::Colormap::Turbo,
        ...
        let mut view_builder = ViewBuilder::new(
            ...
            dl_renderer::ViewBuilderId::new(1),
        )?;
...
impl framework::Example for RenderDepthClouds {
    ...
    fn new(re_ctx: &dl_renderer::RenderContext) -> Self {
        dl_log::info!("Stop camera movement by pressing 'Space'");
        ...
        let image_draw_data = RectangleDrawData::new(
            ...
            &[TexturedRect {
                ...
                options: RectangleOptions {
                    texture_filter_magnification: dl_renderer::renderer::TextureFilterMag::Nearest,
                    texture_filter_minification: dl_renderer::renderer::TextureFilterMin::Linear,
...
impl DepthTexture {
    pub fn spiral(re_ctx: &dl_renderer::RenderContext, dimensions: glam::UVec2) -> Self {
        let size = (dimensions.x * dimensions.y) as usize;
...
impl AlbedoTexture {
    pub fn spiral(re_ctx: &dl_renderer::RenderContext, dimensions: glam::UVec2) -> Self {
        ...
        spiral(dimensions).for_each(|(texcoords, d)| {
            ...
            rgba8[idx..idx + 4].copy_from_slice(dl_renderer::colormap_turbo_srgba(d).as_slice());
        });
