...
impl Multiview {
    fn draw_view<D: 'static + dl_renderer::renderer::DrawData + Sync + Send + Clone>(
        &self,
        re_ctx: &RenderContext,
        ...
        let mut view_builder = ViewBuilder::new(
            re_ctx,
            target_cfg,
            dl_renderer::ViewBuilderId::new(index.into()),
        )?;
            ...
            .is_some_and(|i| i == index)
        {
            ...
            dl_log::info!("Scheduled screenshot for view {}", index);
        }
...
impl Example for Multiview {
    ...
    fn new(re_ctx: &RenderContext) -> Self {
        dl_log::info!("Switch between orthographic & perspective by pressing 'O'");
