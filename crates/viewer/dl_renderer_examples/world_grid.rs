...
impl framework::Example for Outlines {
    ...
    fn draw(
        ...
        view_builder.queue_draw(
            re_ctx,
            dl_renderer::renderer::WorldGridDrawData::new(
                re_ctx,
                &dl_renderer::renderer::WorldGridConfiguration {
                    #[expect(clippy::disallowed_methods)]
                    color: dl_renderer::Rgba::from_rgb(0.5, 0.5, 0.5),
                    spacing: 0.1,
                    thickness_ui: 1.0,
        ...
        view_builder.queue_draw(
            re_ctx,
            dl_renderer::renderer::MeshDrawData::new(re_ctx, &self.model_mesh_instances)?,
        );
