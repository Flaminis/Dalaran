...
use dl_query::{clamped_zip_1x2, range_zip_1x2};
use dl_sdk_types::Archetype as _;
use dl_sdk_types::archetypes::TextLog;
use dl_sdk_types::components::{Color, Text, TextLogLevel};
use dl_view::range_with_blueprint_resolved_data;
...
impl VisualizerSystem for TextLogSystem {
    ...
    fn execute(
        ...
        let query =
            dl_chunk_store::RangeQuery::new(view_query.timeline, AbsoluteTimeRange::EVERYTHING)
...
impl TextLogSystem {
    fn process_visualizer_instruction(
        ...
        ctx: &ViewContext<'_>,
        query: &dl_chunk_store::RangeQuery,
        ...
        let results = dl_view::BlueprintResolvedResults::from((query.clone(), range_results));
        let results =
