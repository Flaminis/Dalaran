...
use dl_sdk_types::components::{Name, Visible};
use dl_sdk_types::{Archetype as _, Loggable as _};
...
impl ContainerBlueprint {
    ...
    pub fn save_to_blueprint_store(&self, ctx: &ViewerContext<'_>) {
        ...
        let mut arch = dl_sdk_types::blueprint::archetypes::ContainerBlueprint::new(container_kind)
        ...
        // here.
        arch.active_tab =
            dl_sdk_types::try_serialize_field::<dl_sdk_types::blueprint::components::ActiveTab>(
                dl_sdk_types::blueprint::archetypes::ContainerBlueprint::descriptor_active_tab(),
        ...
        if let Some(cols) = grid_columns {
            ...
            arch.grid_columns = Some(dl_sdk_types::SerializedComponentBatch::new(
                dl_sdk_types::blueprint::components::GridColumns::arrow_empty(),
                dl_sdk_types::blueprint::archetypes::ContainerBlueprint::descriptor_grid_columns(),
            ));
        }
        ...
        let contents = container
            ...
            .filter_map(|child_id| {
                tile_to_contents.get(child_id).copied().or_else(|| {
                    dl_log::warn_once!("Missing child when building container.");
                    None
                })
            })
            .collect();
    ...
    pub fn clear(&self, ctx: &ViewerContext<'_>) {
        ...
        ctx.save_blueprint_archetype(
            self.entity_path(),
            &dl_sdk_types::archetypes::Clear::recursive(),
        );
    }
