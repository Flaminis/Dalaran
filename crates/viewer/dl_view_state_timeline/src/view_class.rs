...
use dl_sdk_types::blueprint::archetypes::TimeAxis;
use dl_sdk_types::blueprint::components::LinkAxis;
use dl_time_ruler::{MAX_ZIG_WIDTH, TimeRangesUi};
...
#[derive(Default, dl_byte_size::SizeBytes)]
...
impl ViewClass for StateTimelineView {
    ...
    fn handle_component_drop(
        ...
        match dl_view::handle_component_drop(
            ...
            dl_sdk_types::archetypes::StateChange::descriptor_state().component,
        ) {
    ...
    fn ui(
        ...
        dl_time_ruler::paint_time_ranges_and_ticks(
            &time_ranges_ui,
            ui,
        ...
        ui.scope_builder(egui::UiBuilder::new().max_rect(lanes_rect), |ui| {
            egui::ScrollArea::vertical()
                ...
                .show(ui, |ui: &mut egui::Ui| {
                    ...
                    dl_time_ruler::paint_time_ranges_gaps(
                        &time_ranges_ui,
                        ui,
                        &painter,
                        rect.y_range(),
        ...
        if let Some(phase) = hovered_phase {
            ...
            ctx.send_time_commands([TimeControlCommand::HighlightRange(
                dl_viewer_context::TimeRangeHighlight {
                    range,
                    timeline: query.timeline,
                    kind: dl_viewer_context::TimeRangeHighlightKind::StateTimeline,
...
fn resolve_linked_time_view(
    ...
    let view_range = global_time_axis
        .component_or_empty::<dl_sdk_types::blueprint::components::TimeRange>(
            TimeAxis::descriptor_view_range().component,
        )
        .ok()
        .flatten()
        .unwrap_or(dl_sdk_types::blueprint::components::TimeRange(
            dl_sdk_types::datatypes::TimeRange::EVERYTHING,
        ));

    let cursor = dl_sdk_types::datatypes::TimeInt(latest_at.as_i64());
...
fn save_linked_time_view(
    ...
    let new_range =
        dl_sdk_types::blueprint::components::TimeRange(dl_sdk_types::datatypes::TimeRange {
            start: dl_sdk_types::datatypes::TimeRangeBoundary::Absolute(
                dl_sdk_types::datatypes::TimeInt(start.as_i64()),
            ),
            end: dl_sdk_types::datatypes::TimeRangeBoundary::Absolute(
                dl_sdk_types::datatypes::TimeInt(end.as_i64()),
            ),
        });
...
#[test]
fn test_help_view() {
    dl_test_context::TestContext::test_help_view(|ctx| StateTimelineView.help(ctx));
}
