...
impl SyntaxHighlighting for Instance {
    fn syntax_highlight_into(&self, builder: &mut SyntaxHighlightedBuilder) {
        if self.is_all() {
            ...
            builder.append_index(&dl_format::format_uint(self.get()));
        }
    }
}
...
impl_sh_primitive!(f32, dl_format::format_f32);
impl_sh_primitive!(f64, dl_format::format_f64);

impl_sh_primitive!(i8, dl_format::format_int);
impl_sh_primitive!(i16, dl_format::format_int);
impl_sh_primitive!(i32, dl_format::format_int);
impl_sh_primitive!(i64, dl_format::format_int);
impl_sh_primitive!(isize, dl_format::format_int);
impl_sh_primitive!(u8, dl_format::format_uint);
impl_sh_primitive!(u16, dl_format::format_uint);
impl_sh_primitive!(u32, dl_format::format_uint);
impl_sh_primitive!(u64, dl_format::format_uint);
impl_sh_primitive!(usize, dl_format::format_uint);
