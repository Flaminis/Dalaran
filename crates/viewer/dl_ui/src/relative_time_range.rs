...
use dl_log_types::{AbsoluteTimeRange, TimeType, TimestampFormat};
...
mod tests {
        ...
        let mut harness = Harness::builder().build_ui(|ui| {
            ...
            ui.list_item_scope("test", |ui| {
                RelativeTimeRange {
                    ...
                    resolved_range: dl_log_types::AbsoluteTimeRange {
                        min: start.into(),
                        max: end.into(),
                    },
                    time_type,
    ...
    fn test_relative_time_range_ui() {
        ...
        for (time_type, time_range) in [
            ...
            (
                TimeType::DurationNs,
                dl_log_types::TimeInt::from_secs(0.0).as_i64()
                    ..=dl_log_types::TimeInt::from_secs(60.0).as_i64(),
            ),
            (
