...
pub trait UiExt {
    ...
    ///
    /// If the text contains [`dl_error::DETAILS_SEPARATOR`], the details are
    ...
    fn success_label(&mut self, success_text: impl Into<String>) -> egui::Response {
        ...
        let (summary, details) = dl_error::split_details(&success_text);
    ...
    fn info_label(&mut self, info_text: impl Into<String>) -> egui::Response {
        ...
        let (summary, details) = dl_error::split_details(&info_text);
    ...
    fn warning_label(&mut self, warning_text: impl Into<String>) -> egui::Response {
        ...
        let (summary, details) = dl_error::split_details(&warning_text);
    ...
    fn error_label(&mut self, error_text: impl Into<String>) -> egui::Response {
        ...
        let (summary, details) = dl_error::split_details(&error_text);
                ...
                .ui(ui, |ui| {
                    if let Some(help_ui) = help_ui.take() {
                        ...
                        if !user_has_clicked_any_help_button {
                            ...
                            dl_analytics::record(|| dl_analytics::event::HelpButtonFirstClicked {});
                        }
                    }
                })
                .0;
