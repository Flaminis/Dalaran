            ...
            |ui| {
                ...
                ui.list_item().show_hierarchical(
                    ...
                    list_item::LabelContent::new("LabelContent with icon")
                        .with_icon(&dl_ui::icons::VIEW_TEXT),
                );
                ...
                ui.list_item()
                    .show_hierarchical(
                        ...
                        list_item::LabelContent::new("LabelContent with LabelStyle")
                            .label_style(dl_ui::LabelStyle::Unnamed)
                            .with_icon(&dl_ui::icons::VIEW_2D),
                    )
                ...
                ui.list_item().show_hierarchical(
                    ...
                    list_item::LabelContent::new("LabelContent with buttons").with_buttons(|ui| {
                        ui.small_icon_button(&dl_ui::icons::ADD, "Add");
                        ui.small_icon_button(&dl_ui::icons::REMOVE, "Remove");
                    }),
                );
                ...
                list_item::list_item_scope(ui, "inner_scope", |ui| {
                    ...
                    ui.list_item().show_hierarchical(
                        ...
                        list_item::PropertyContent::new("Color")
                            .with_icon(&dl_ui::icons::VIEW_TEXT)
                            .with_action_button(&dl_ui::icons::ADD, "Add", || {
                                dl_log::warn!("Add button clicked");
                            })
            ...
            |ui| {
                ...
                list_item::list_item_scope(ui, "inner_scope", |ui| {
                    ...
                    if self.use_action_button {
                        content = content.with_action_button(&dl_ui::icons::ADD, "Add", || {
                            dl_log::warn!("Add button clicked");
                        });
                    }
        ...
        ui.list_item().show_hierarchical_with_children(
            ...
            |ui| {
                ...
                ui.list_item().show_hierarchical(
                    ...
                    .action_button(&dl_ui::icons::ADD, "Add", || {
                        dl_log::warn!("Add button clicked");
                    }),
                );
            },
