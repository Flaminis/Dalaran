...
use dl_ui::{DesignTokens, UiExt as _, list_item};
...
impl HierarchicalDragAndDrop {
    ...
    fn send_command(&self, command: Command) {
        ...
        dl_quota_channel::send_crossbeam(&self.command_sender, command).ok();
    }
}
    ...
    fn handle_interaction(
        ...
        let item_desc = dl_ui::drag_and_drop::ItemContext {
            ...
            item_kind: if is_container {
                dl_ui::drag_and_drop::ItemKind::Container {
                    parent_id,
                    position_index_in_parent,
                }
            } else {
                dl_ui::drag_and_drop::ItemKind::Leaf {
                    parent_id,
                    position_index_in_parent,
                }
            },
