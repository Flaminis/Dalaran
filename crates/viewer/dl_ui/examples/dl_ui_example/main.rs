// Run the example with `cargo r -p dl_ui --example dl_ui_example`
...
impl UICommandSender for CommandSender {
    ...
    fn send_ui(&self, command: UICommand) {
        ...
        dl_quota_channel::send_crossbeam(&self.0, command).ok();
    }
}
...
fn main() -> eframe::Result {
    ...
    let native_options = eframe::NativeOptions {
        viewport: dl_ui::viewport_with_window_chrome(
            egui::ViewportBuilder::default()
                .with_app_id("dl_ui_example")
...
pub struct ExampleApp {
    ...
    text_log_rx: Receiver<dl_log::LogMsg>,

    tree: egui_tiles::Tree<Tab>,

    /// regular modal
    modal_handler: dl_ui::modal::ModalHandler,

    /// modal with full span mode
    full_span_modal_handler: dl_ui::modal::ModalHandler,
...
impl ExampleApp {
    fn new(ctx: egui::Context) -> Self {
        let text_log_rx = dl_log::add_log_msg_receiver(dl_log::LevelFilter::INFO);
        ...
        Self {
            ...
            use_custom_decorations: dl_ui::custom_window_decorations_default(),
        }
    }
    ...
    fn ui(&mut self, ui: &mut egui::Ui, frame: &mut eframe::Frame) {
        ...
        let left_panel_bottom_section_ui = |ui: &mut egui::Ui| {
            ...
            self.modal_handler.ui(
                ui.ctx(),
                || dl_ui::modal::ModalWrapper::new("Modal window"),
            ...
            self.full_span_modal_handler.ui(
                ui.ctx(),
                || dl_ui::modal::ModalWrapper::new("Modal window").full_span_content(true),
                |ui| {
        ...
        if let Some(cmd) = dl_ui::UICommand::listen_for_kb_shortcut(ui) {
