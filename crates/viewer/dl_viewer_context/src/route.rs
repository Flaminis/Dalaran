...
use dl_log_types::{ApplicationId, StoreId, TableId};
...
pub enum Route {
    ...
    Loading(Box<dl_log_channel::LogSource>),
...
impl From<dl_uri::EntryUri> for Route {
...
impl Route {
    ...
    pub fn redap_origin(&self, store_hub: &crate::StoreHub) -> Option<dl_uri::Origin> {
        match self {
            ...
            | Self::ChunkStoreBrowser {
                ...
                if matches!(uri, dl_uri::RedapUri::Proxy(_)) {
                    return None;
                }
