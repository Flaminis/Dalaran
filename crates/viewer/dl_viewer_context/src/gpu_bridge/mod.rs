...
pub use dl_renderer_callback::new_renderer_callback;
...
pub fn tensor_decode_srgb_gamma_heuristic(
    ...
    data_type: dl_sdk_types::tensor_data::TensorDataType,
    channels: u32,
) -> bool {
...
pub fn render_image(
    ...
    debug_name: dl_renderer::Label,
) -> anyhow::Result<()> {
    dl_tracing::profile_function!();

    use dl_renderer::renderer::{TextureFilterMag, TextureFilterMin};
    ...
    let textured_rectangle = dl_renderer::renderer::TexturedRect {
    ...
    view_builder.queue_draw(
        render_ctx,
        dl_renderer::renderer::RectangleDrawData::new(render_ctx, &[textured_rectangle])?,
    );
