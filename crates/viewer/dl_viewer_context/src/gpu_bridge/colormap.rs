...
use dl_sdk_types::{ColormapCategory, ColormapSelection};
use dl_ui::list_item;
...
fn colormap_preview_ui(
    ...
    ui: &mut egui::Ui,
    colormap: dl_sdk_types::components::Colormap,
    ...
    let horizontal_gradient = get_or_create_texture(render_ctx, horizontal_gradient_id, || {
        ...
        dl_renderer::resource_managers::ImageDataDesc {
            label: "horizontal_gradient".into(),
            data: data.into(),
            format: wgpu::TextureFormat::R16Float.into(),
            width_height: [width, height],
            alpha_channel_usage: dl_renderer::AlphaChannelUsage::Opaque,
        }
    })
    .map_err(|err| anyhow::anyhow!("Failed to create horizontal gradient texture: {err}"))?;

    let colormapped_texture = dl_renderer::renderer::ColormappedTexture {
        texture: horizontal_gradient,
        range: [0.0, 1.0],
        decode_srgb: false,
        texture_alpha: dl_renderer::renderer::TextureAlpha::Opaque,
        gamma: 1.0,
        shader_decoding: None,
        color_mapper: dl_renderer::renderer::ColorMapper::Function(colormap_to_re_renderer(
            colormap,
        )),
    };
    ...
    render_image(
        ...
        dl_renderer::ViewBuilderId::new(response.id.value()),
        debug_name.into(),
    )?;
...
fn colormap_variant_ui(
    render_ctx: &dl_renderer::RenderContext,
    ui: &mut egui::Ui,
    option: &dl_sdk_types::components::Colormap,
    map: &mut dl_sdk_types::components::Colormap,
) -> egui::Response {
    ...
    let mut response = list_item.show_flat(
        ...
        list_item::CustomContent::new(|ui, _| {
            if let Err(err) = colormap_preview_ui(render_ctx, ui, *option) {
                dl_log::error_once!("Failed to paint colormap preview: {err}");
            }
...
fn colormap_category_ui(
    ...
    selected: &mut dl_sdk_types::components::Colormap,
) -> egui::Response {
    ...
    for option in dl_sdk_types::components::Colormap::variants()
        .iter()
...
pub fn colormap_edit_or_view_ui_with_selection(
    ctx: &crate::AppContext<'_>,
    ui: &mut egui::Ui,
    map: &mut MaybeMutRef<'_, dl_sdk_types::components::Colormap>,
    ...
    if let Some(map) = map.as_mut() {
        ...
        let map: dl_sdk_types::components::Colormap = **map;
...
pub fn colormap_to_re_renderer(
    colormap: dl_sdk_types::components::Colormap,
) -> dl_renderer::Colormap {
    match colormap {
        dl_sdk_types::components::Colormap::Grayscale => dl_renderer::Colormap::Grayscale,
        dl_sdk_types::components::Colormap::Inferno => dl_renderer::Colormap::Inferno,
        dl_sdk_types::components::Colormap::Magma => dl_renderer::Colormap::Magma,
        dl_sdk_types::components::Colormap::Plasma => dl_renderer::Colormap::Plasma,
        dl_sdk_types::components::Colormap::Turbo => dl_renderer::Colormap::Turbo,
        dl_sdk_types::components::Colormap::Viridis => dl_renderer::Colormap::Viridis,
        dl_sdk_types::components::Colormap::CyanToYellow => dl_renderer::Colormap::CyanToYellow,
        dl_sdk_types::components::Colormap::Spectral => dl_renderer::Colormap::Spectral,
        dl_sdk_types::components::Colormap::Twilight => dl_renderer::Colormap::Twilight,
        dl_sdk_types::components::Colormap::RvizMap => dl_renderer::Colormap::RvizMap,
        dl_sdk_types::components::Colormap::RvizCostmap => dl_renderer::Colormap::RvizCostmap,
        dl_sdk_types::components::Colormap::Costmap => dl_renderer::Colormap::Costmap,
    }
}
