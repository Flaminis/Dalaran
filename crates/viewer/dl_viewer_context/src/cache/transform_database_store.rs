...
pub struct TransformDatabaseStoreCache {
    ...
    transform_forest: Option<Arc<dl_tf::TransformForest>>,
...
impl TransformDatabaseStoreCache {
    ...
    pub fn latest_at_transform_cache_snapshot(
        ...
        query: &LatestAtQuery,
        filter: dl_tf::transform_cache_snapshot::SnapshotFilter,
    ) -> dl_tf::transform_cache_snapshot::Snapshot {
        let transform_cache = self
            .transform_cache
            .get_or_insert_with(|| TransformResolutionCache::new(entity_db));
    ...
    pub fn transform_forest(&self) -> Option<Arc<dl_tf::TransformForest>> {
...
impl dl_byte_size::MemUsageTreeCapture for TransformDatabaseStoreCache {
