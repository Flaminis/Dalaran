...
use dl_sdk_types::components::{ImageBuffer, MediaType};
...
/// Caches the results of decoding [`dl_sdk_types::archetypes::EncodedImage`] and [`dl_sdk_types::archetypes::EncodedDepthImage`].
#[derive(Default)]
...
pub(crate) fn decode_image(
    ...
    dl_tracing::profile_function!(media_type);
...
impl dl_byte_size::MemUsageTreeCapture for ImageDecodeCache {
