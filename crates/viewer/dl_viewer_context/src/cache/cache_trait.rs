...
/// single [`dl_log_types::StoreId`]. This means cache implementations are already scoped to one
...
pub trait Cache: std::any::Any + Send + Sync + dl_byte_size::MemUsageTreeCapture {
