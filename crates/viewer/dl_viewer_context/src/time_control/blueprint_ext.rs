use dl_chunk::{EntityPath, TimelineName};
...
impl<T: BlueprintContext> TimeBlueprintExt for T {
    fn set_timeline(&self, timeline: TimelineName) {
        self.save_blueprint_component(
            ...
            &dl_sdk_types::blueprint::components::TimelineName::from(timeline.as_str()),
        );
    }
    ...
    fn timeline(&self) -> Option<TimelineName> {
        let (_, timeline) = self
            .current_blueprint()
            .latest_at_component_quiet::<dl_sdk_types::blueprint::components::TimelineName>(
            &time_panel_blueprint_entity_path(),
    ...
    fn set_playback_speed(&self, playback_speed: f64) {
        self.save_blueprint_component(
            ...
            &dl_sdk_types::blueprint::components::PlaybackSpeed(playback_speed.into()),
        );
    }
    ...
    fn playback_speed(&self) -> Option<f64> {
        let (_, playback_speed) = self
            .current_blueprint()
            .latest_at_component_quiet::<dl_sdk_types::blueprint::components::PlaybackSpeed>(
            &time_panel_blueprint_entity_path(),
            self.blueprint_query(),
    ...
    fn set_fps(&self, fps: f64) {
        self.save_blueprint_component(
            ...
            &dl_sdk_types::blueprint::components::Fps(fps.into()),
        );
    }
    ...
    fn fps(&self) -> Option<f64> {
        let (_, fps) = self
            .current_blueprint()
            .latest_at_component_quiet::<dl_sdk_types::blueprint::components::Fps>(
                &time_panel_blueprint_entity_path(),
                self.blueprint_query(),
    ...
    fn set_time_selection(&self, time_range: AbsoluteTimeRange) {
        self.save_blueprint_component(
            ...
            &dl_sdk_types::blueprint::components::AbsoluteTimeRange(
                dl_sdk_types::datatypes::AbsoluteTimeRange {
    ...
    fn time_selection(&self) -> Option<AbsoluteTimeRange> {
        let (_, time_range) = self
            .current_blueprint()
            .latest_at_component_quiet::<dl_sdk_types::blueprint::components::AbsoluteTimeRange>(
            &time_panel_blueprint_entity_path(),
            self.blueprint_query(),
