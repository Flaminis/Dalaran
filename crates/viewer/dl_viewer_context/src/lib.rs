...
pub use dl_chunk_store::MissingChunkReporter;
...
#[inline]
pub fn icon_for_container_kind(kind: &egui_tiles::ContainerKind) -> &'static dl_ui::Icon {
    match kind {
        egui_tiles::ContainerKind::Tabs => &dl_ui::icons::CONTAINER_TABS,
        egui_tiles::ContainerKind::Horizontal => &dl_ui::icons::CONTAINER_HORIZONTAL,
        egui_tiles::ContainerKind::Vertical => &dl_ui::icons::CONTAINER_VERTICAL,
        egui_tiles::ContainerKind::Grid => &dl_ui::icons::CONTAINER_GRID,
    }
}

/// The style to use for displaying this view name in the UI.
pub fn contents_name_style(name: &ContentsName) -> dl_ui::LabelStyle {
    match name {
        ContentsName::Named(_) => dl_ui::LabelStyle::Normal,
        ContentsName::Placeholder(_) => dl_ui::LabelStyle::Unnamed,
    }
}
