...
use dl_sdk_types::{ComponentDescriptor, ComponentIdentifier, ViewClassIdentifier};
...
impl VisualizerQueryInfo {
    ...
    pub fn buffer_and_format<Buffer: dl_sdk_types::Component, Format: dl_sdk_types::Component>(
    ...
    pub fn single_required_component<C: dl_sdk_types::Component>(
...
#[derive(Debug, Clone, Default, PartialEq, Eq, Hash, dl_byte_size::SizeBytes)]
...
///
/// For a high-level failure handling overview, see the `dl_viewer` crate documentation.
#[derive(Debug, Clone, PartialEq, Eq, Hash, dl_byte_size::SizeBytes)]
...
pub struct VisualizerExecutionOutput {
    ...
    pub draw_data: Vec<dl_renderer::QueueableDrawData>,
...
impl VisualizerExecutionOutput {
    ...
    pub fn with_draw_data(
        mut self,
        draw_data: impl IntoIterator<Item = dl_renderer::QueueableDrawData>,
    ) -> Self {
