...
use dl_chunk::{ComponentIdentifier, TimelineName};
use dl_chunk_store::LatestAtQuery;
use dl_entity_db::{EntityPath, TimeInt};
...
impl VisualizerInstruction {
    ...
    pub fn write_instruction_to_blueprint(&self, ctx: &ViewerContext<'_>) {
        let new_visualizer_instruction =
            dl_sdk_types::blueprint::archetypes::VisualizerInstruction::new(
    ...
    pub fn save_override(
        ...
        new_value: &dyn dl_sdk_types::ComponentBatch,
    ) {
