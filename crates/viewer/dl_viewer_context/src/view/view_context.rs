...
use dl_sdk_types::{AsComponents, ComponentBatch, ComponentDescriptor, ViewClassIdentifier};
...
impl BlueprintContext for ViewContext<'_> {
    ...
    fn current_blueprint(&self) -> &dl_entity_db::EntityDb {
        self.viewer_ctx.current_blueprint()
    }

    fn default_blueprint(&self) -> Option<&dl_entity_db::EntityDb> {
...
impl<'a> ViewContext<'a> {
    ...
    #[inline]
    pub fn recording(&self) -> &dl_entity_db::EntityDb {
