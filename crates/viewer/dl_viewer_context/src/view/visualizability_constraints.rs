...
impl SingleRequiredComponentConstraint {
    pub fn new<C: dl_sdk_types::Component>(
    ...
    pub(crate) fn check_datatype_match(
        ...
        use dl_lenses_core::extract_nested_fields;
...
impl BufferAndFormatConstraint {
    ...
    pub fn new<Buffer: dl_sdk_types::Component, Format: dl_sdk_types::Component>(
    ...
    ///
    /// This is always [`dl_sdk_types::datatypes::Blob`]'s arrow datatype, since all image-like
    ...
    pub fn buffer_arrow_datatype() -> arrow::datatypes::DataType {
        <dl_sdk_types::datatypes::Blob as dl_types_core::Loggable>::arrow_datatype()
    }
    ...
    pub(crate) fn check_buffer_match(
        &self,
        incoming_arrow_datatype: &arrow::datatypes::DataType,
        descriptor: &dl_sdk_types::ComponentDescriptor,
    ) -> Option<DatatypeMatch> {
        use dl_lenses_core::extract_nested_fields;
