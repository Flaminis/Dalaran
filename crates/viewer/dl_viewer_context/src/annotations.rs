...
impl Annotations {
    ...
    pub fn resolved_class_description(
        &self,
        class_id: Option<dl_sdk_types::components::ClassId>,
...
impl ResolvedClassDescription<'_> {
    ...
    pub fn annotation_info_with_keypoint(
        &self,
        keypoint_id: dl_sdk_types::datatypes::KeypointId,
    ) -> ResolvedAnnotationInfo {
...
#[derive(Default, Clone, Debug, dl_byte_size::SizeBytes)]
...
impl AnnotationMap {
    ...
    pub fn load(&mut self, db: &dl_entity_db::EntityDb, time_query: &LatestAtQuery) {
...
impl dl_byte_size::MemUsageTreeCapture for AnnotationContextStoreSubscriber {
    fn capture_mem_usage_tree(&self) -> dl_byte_size::MemUsageTree {
        use dl_byte_size::SizeBytes as _;
        dl_byte_size::MemUsageTree::Bytes(self.entities_with_annotation_context.total_size_bytes())
    }
}
