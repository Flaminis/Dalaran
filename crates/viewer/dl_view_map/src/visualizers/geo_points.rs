...
use dl_renderer::renderer::PointCloudDrawDataError;
use dl_sdk_types::Archetype as _;
use dl_sdk_types::archetypes::GeoPoints;
use dl_sdk_types::components::{LatLon, Radius};
use dl_view::{
...
pub struct GeoPointBatch {
    ...
    pub colors: Vec<dl_renderer::Color32>,
...
impl VisualizerSystem for GeoPointsVisualizer {
    ...
    fn execute(
            ...
            view_query.iter_visualizer_instruction_for(Self::identifier())
        {
            ...
            for (_index, positions, colors, radii, class_ids) in dl_query::range_zip_1x3(
...
impl GeoPointsOutput {
    ...
    pub fn queue_draw_data(
        ...
        let mut points = dl_renderer::PointCloudBuilder::new(render_ctx);
        ...
        for (entity_path, batch) in &self.batches {
            ...
            let mut point_batch = points
                .batch_with_info(dl_renderer::renderer::PointCloudBatchInfo {
                    label: entity_path.to_string().into(),
                    flags: dl_renderer::renderer::PointCloudBatchFlags::empty(),
                    ..dl_renderer::renderer::PointCloudBatchInfo::default()
                })
