...
use dl_chunk_store::{ColumnDescriptor, SparseFillStrategy};
...
Configure in the selection panel:
 ...
 - Row filtering by time range",
    ...
    fn ui(
        ...
        let mut dataframe_query = dl_chunk_store::QueryExpression {
...
#[test]
fn test_help_view() {
    dl_test_context::TestContext::test_help_view(|ctx| DataframeView.help(ctx));
}
