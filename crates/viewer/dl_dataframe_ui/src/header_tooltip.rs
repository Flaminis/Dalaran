...
fn column_descriptor_ui(ui: &mut egui::Ui, column: &ColumnDescriptorRef<'_>, column_field: &Field) {
    ...
    match *column {
        ...
        ColumnDescriptorRef::Component(desc) => {
            let dl_sorbet::ComponentColumnDescriptor {
                store_datatype,
                component_type,
                entity_path,
                archetype,
    ...
    egui::Sides::new().show(
        ...
        |ui| {
                ...
                .clicked()
            {
                ...
                dl_log::info!("Copied full datatype of column `{column_name}` to clipboard");
            }
        },
    );
}
