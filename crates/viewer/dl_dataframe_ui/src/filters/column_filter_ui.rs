...
impl FilterState {
    ...
    pub fn filter_bar_ui(
        ...
        let timestamp_format =
            timestamp_format.with_date_visibility(dl_log_types::DateVisibility::ShowDate);
    ...
    fn ui(
        ...
        if let Some(rect) = atom_response.rect(Self::close_button_id()) {
            ...
            if ui
                .place(
                    rect,
                    ui.small_icon_button_widget(&dl_ui::icons::CLOSE_SMALL, "Remove filter")
...
mod tests {
    ...
    fn test_timestamp_filter_on_commit() {
        ...
        let options = dl_ui::testing::default_snapshot_options_for_ui();
