...
///
/// This is used to implement [`dl_ui::SyntaxHighlighting`] to types which may need to display
/// timestamps.
///
/// Note: this can't be moved to `dl_log_types` along with `TimestampFormat`, because then we cannot
