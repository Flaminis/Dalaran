fn main() {
    ...
    let disable_web_viewer_server =
        dl_build_tools::is_tracked_env_var_set("RERUN_DISABLE_WEB_VIEWER_SERVER")
    ...
    let trailing_web_viewer = dl_build_tools::is_tracked_env_var_set("RERUN_TRAILING_WEB_VIEWER")
    ...
    let external_web_viewer = dl_build_tools::is_tracked_env_var_set("RERUN_EXTERNAL_WEB_VIEWER")
