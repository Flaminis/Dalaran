//! Show arrow data as a tree of dalaran `list_items` or as a nicely formatted label with syntax highlighting.
...
) -> Result<dl_ui::syntax_highlighting::SyntaxHighlightedBuilder, arrow::error::ArrowError> {
