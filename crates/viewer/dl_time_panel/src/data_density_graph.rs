...
impl DensityGraph {
    ...
    pub fn paint(
...

        {
            ...
            dl_tracing::profile_scope!("triangles");
...
pub fn paint_loaded_indicator_bar(
    ...
    {
        dl_tracing::profile_scope!("draw loading");
...
pub fn build_density_graph<'a>(
...

    {
        ...
        dl_tracing::profile_scope!("add_chunk_range");
    ...
    let (chunk_ranges, total_events): (
        Vec<(Arc<dl_chunk_store::Chunk>, AbsoluteTimeRange, u64)>,
        u64,
    ) = {
        dl_tracing::profile_scope!("collect chunks");
    ...
    {
        dl_tracing::profile_scope!("add_data");
...
pub fn show_row_ids_tooltip(
    ...
    if let Some(component) = *component {
        ...
        dl_entity_db::InstancePath::entity_all(entity_path.clone()).data_ui(&ctx, ui, ui_layout);
    }
}
