use dl_arrow_ui::arrow_ui;
use dl_ui::UiExt as _;
use dl_viewer_context::{ComponentUiRegistry, StoreViewContext};

use super::EntityDataUi;

pub fn register_component_uis(registry: &mut dl_viewer_context::ComponentUiRegistry) {
    ...
    add_to_registry::<dl_sdk_types::components::AnnotationContext>(registry);
    ...
    add_to_registry::<dl_sdk_types::components::Blob>(registry);
    add_to_registry::<dl_sdk_types::components::TensorData>(registry);
    ...
    add_to_registry::<dl_sdk_types::components::ClassId>(registry);
    add_to_registry::<dl_sdk_types::components::KeypointId>(registry);
}

/// Registers how to show a given component in the ui.
pub fn add_to_registry<C: EntityDataUi + dl_sdk_types::Component>(
