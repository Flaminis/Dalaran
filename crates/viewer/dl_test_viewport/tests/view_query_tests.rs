//! Tests for [`dl_viewer_context::ViewQuery`] functionality.
...
use dl_viewer_context::{ViewClass as _, ViewSystemIdentifier};
use dl_viewport_blueprint::{ViewBlueprint, ViewportBlueprint};

/// Test that [`dl_viewer_context::ViewQuery::iter_visualizer_instruction_for`] returns the expected results.
#[test]
