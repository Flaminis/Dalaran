...
use dl_log_types::{ApplicationId, EntityPath, EntityPathHash};
use dl_ui::drag_and_drop::DropTarget;
use dl_ui::filter_widget::format_matching_text;
use dl_ui::list_item::ListItemContentButtonsExt as _;
use dl_ui::{ContextExt as _, DesignTokens, UiExt as _, filter_widget, list_item};
...
impl BlueprintTree {
                ...
                ui.list_item().interactive(false).show_flat(
                    ...
                    .menu_button(
                        ...
                        |ui| {
                            ...
                            dl_ui::RecordingCommandKind::AddViewOrContainer.menu_button_ui(
                                ui,
                                Some(recording_id),
                                ctx.command_sender(),
                            );
    ...
    fn tree_ui(
        ...
        egui::ScrollArea::both()
            ...
            .show(ui, |ui| {
                dl_tracing::profile_scope!("blueprint_tree_scroll_area");
                ui.panel_content(|ui| {
    ...
    fn data_result_ui(
                ...
                if ui
                    ...
                    .show_hierarchical(
                        ...
                        list_item::LabelContent::new("$origin")
                            .subdued(true)
                            .italics(true)
                            .with_icon(&dl_ui::icons::INTERNAL_LINK),
                    )
                    .on_hover_text(
        ...
        let response = response.on_hover_ui(|ui| {
            ...
            dl_data_ui::item_ui::entity_hover_card_ui(
                ui,
    ...
    fn handle_root_container_drag_and_drop_interaction(
        ...
        let item_desc = dl_ui::drag_and_drop::ItemContext {
            id: contents,
            item_kind: dl_ui::drag_and_drop::ItemKind::RootContainer,
            previous_container_id: None,
        };

        let drop_target = dl_ui::drag_and_drop::find_drop_target(
            ui,
            &item_desc,
            response.rect,
            None,
    ...
    fn handle_drag_and_drop_interaction(
        ...
        let item_desc = dl_ui::drag_and_drop::ItemContext {
            ...
            item_kind: match contents {
                Contents::Container(_) => dl_ui::drag_and_drop::ItemKind::Container {
                    parent_id: Contents::Container(parent_container_id),
                    position_index_in_parent,
                },
                Contents::View(_) => dl_ui::drag_and_drop::ItemKind::Leaf {
                    parent_id: Contents::Container(parent_container_id),
                    position_index_in_parent,
                },
            },
    ...
    fn handle_empty_space_drag_and_drop_interaction(
        ...
        if ui.rect_contains_pointer(empty_space) {
            let drop_target = dl_ui::drag_and_drop::DropTarget::new(
                empty_space.x_range(),
                empty_space.top(),
...
fn set_blueprint_to_default_menu_buttons(ctx: &ViewerContext<'_>, ui: &mut egui::Ui) {
    ...
    let response = dl_ui::RecordingCommandKind::ClearActiveBlueprint.menu_button_ui(
        ui,
        recording_id,
        ctx.command_sender(),
    );
...
fn remove_button_ui(ui: &mut Ui, alt_text_and_tooltip: &str) -> Response {
    ui.small_icon_button(&dl_ui::icons::REMOVE, alt_text_and_tooltip)
