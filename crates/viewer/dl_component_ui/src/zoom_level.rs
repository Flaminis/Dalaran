use dl_sdk_types::blueprint::components::ZoomLevel;
use dl_viewer_context::MaybeMutRef;

// TODO(#7876): move this to `dl_view_map` when the crate is no longer behind a Cargo feature.
...
/// Editor for a [`dl_sdk_types::blueprint::components::ZoomLevel`].
