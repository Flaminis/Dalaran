use dl_format::{format_f32, format_uint};
use dl_sdk_types::components::{LineStrip2D, LineStrip3D};
use dl_ui::UiExt as _;
use dl_viewer_context::{AppContext, MaybeMutRef, UiLayout};
...
pub fn register_linestrip_component_ui(registry: &mut dl_viewer_context::ComponentUiRegistry) {
