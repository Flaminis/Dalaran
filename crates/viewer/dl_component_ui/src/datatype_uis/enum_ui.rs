...
pub trait VariantAvailableProvider<EnumT: dl_types_core::reflection::Enum> {
...
struct AllEnumVariantAvailable<EnumT: dl_types_core::reflection::Enum> {
    _phantom: std::marker::PhantomData<EnumT>,
}

impl<EnumT: dl_types_core::reflection::Enum> VariantAvailableProvider<EnumT>
...
pub fn edit_view_enum<EnumT: dl_types_core::reflection::Enum + dl_types_core::Component>(
    ctx: &AppContext<'_>,
    ui: &mut egui::Ui,
...
pub fn edit_view_enum_with_variant_available<
    EnumT: dl_types_core::reflection::Enum + dl_types_core::Component,
...
fn edit_view_enum_impl<
    EnumT: dl_types_core::reflection::Enum,
    VariantAvailT: VariantAvailableProvider<EnumT>,
>(
    ctx: &AppContext<'_>,
    ui: &mut egui::Ui,
...
pub fn enum_variant_ui<EnumT: dl_types_core::reflection::Enum>(
    ui: &mut egui::Ui,
