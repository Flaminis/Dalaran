...
/// Generic editor for a [`dl_sdk_types::datatypes::Float32`] value from zero to max float with a suffix.
...
/// Generic editor for a [`dl_sdk_types::datatypes::Float32`] value representing a ui points value.
...
/// Generic editor for a [`dl_sdk_types::datatypes::Float32`] value from min to max float.
...
/// Generic editor for a [`dl_sdk_types::datatypes::Float32`] value from zero to one float.
...
/// Generic editor for a [`dl_sdk_types::datatypes::Float64`] value from zero to max float.
...
/// Generic editor for a [`dl_sdk_types::datatypes::Float64`] value from min to max float.
