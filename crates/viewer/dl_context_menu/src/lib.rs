...
trait ContextMenuAction {
    ...
    fn icon(&self) -> Option<&'static dl_ui::Icon> {
        None
    }
    ...
    fn process_app_id(&self, _ctx: &ContextMenuContext<'_>, _app_id: &dl_log_types::ApplicationId) {
    }

    fn process_data_source(
        &self,
        _ctx: &ContextMenuContext<'_>,
        _data_source: &dl_log_channel::LogSource,
    ) {
    }

    /// Process a single recording.
    fn process_store_id(&self, _ctx: &ContextMenuContext<'_>, _store_id: &dl_log_types::StoreId) {}
    ...
    fn process_redap_server(&self, _ctx: &ContextMenuContext<'_>, _origin: &dl_uri::Origin) {}

    /// Process a single redap entry (dataset or table).
    fn process_redap_entry(
        &self,
        _ctx: &ContextMenuContext<'_>,
        _entry_id: &dl_log_types::EntryId,
    ) {
    }
    ...
    fn process_component_path(
        &self,
        _ctx: &ContextMenuContext<'_>,
        _component_path: &dl_log_types::ComponentPath,
    ) {
    }
}
