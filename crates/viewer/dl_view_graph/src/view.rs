...
use dl_sdk_types::{ViewClassIdentifier, blueprint};
use dl_ui::{self, Help, IconText, MouseButtonText, UiExt as _, icons};
...
impl ViewClass for GraphView {
    ...
    fn identifier() -> ViewClassIdentifier {
        dl_viewer_context::external::dl_string_interner::intern_static_nonempty!(
            ViewClassIdentifier,
            "Graph"
        )
    }
        ...
        system_registry.register_fallback_provider(
            ...
            |ctx| {
                ...
                match state.layout_state.bounding_rect() {
                    ...
                    _ => dl_sdk_types::blueprint::components::VisualBounds2D::default(),
                }
            },
        );
    ...
    fn selection_ui(
        ...
        dl_ui::list_item::list_item_scope(ui, "graph_selection_ui", |ui| {
...
#[test]
fn test_help_view() {
    dl_test_context::TestContext::test_help_view(|ctx| GraphView.help(ctx));
}
