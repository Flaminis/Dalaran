...
impl<'ctx> GaussianSplatBuilder<'ctx> {
    ...
    pub fn reserve(
        ...
        dl_tracing::profile_function_if!(100_000 < expected_number_of_additional_gaussians);
...
impl GaussianSplatBatchBuilder<'_, '_> {
    ...
    pub fn add_gaussians(
        ...
        {
            dl_tracing::profile_scope!("GaussianScaleYZ");
        ...
        {
            dl_tracing::profile_scope!("rotations");
        ...
        if writes_sh && 0 < sh_num_coefficients {
            dl_tracing::profile_scope!("sh_coefficients");
        ...
        {
            dl_tracing::profile_scope!("colors");
            self.0
                .color_buffer
        ...
        {
            dl_tracing::profile_scope!("picking_ids");
            self.0
                .picking_instance_ids_buffer
                .extend_from_slice_clamped(
                    picking_ids,
