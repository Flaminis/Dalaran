...
use dl_renderer::device_caps;
use dl_renderer::mesh::{CpuMesh, GpuMesh, Material};
...
fn cube_gpu_mesh(ctx: &RenderContext) -> Arc<GpuMesh> {
    ...
    let bbox = dl_renderer::util::bounding_box_from_points(vertex_positions.iter().copied());
        ...
        GpuMesh::new(
            ...
            &CpuMesh {
                ...
                materials: smallvec![Material {
                    ...
                    albedo_factor: dl_renderer::Rgba::WHITE,
                }],
                bbox,
            },
        )
