...
pub fn viewer_started(
    ...
    device_tier: dl_renderer::device_caps::DeviceCapabilityTier,
) -> ViewerStarted {
    ...
    let screen_info = dl_analytics::event::ScreenInfo {
...
pub fn open_recording(
    ...
    let store_info = entity_db.store_info().map(|store_info| {
        ...
        use dl_log_types::StoreSource as S;
        let store_source_preprocessed = match &store_source {
            ...
            S::File { file_source } => match file_source {
                dl_log_types::FileSource::Cli => "file_cli".to_owned(),
                dl_log_types::FileSource::Uri => "file_uri".to_owned(),
                dl_log_types::FileSource::DragAndDrop { .. } => "file_drag_and_drop".to_owned(),
                dl_log_types::FileSource::FileDialog { .. } => "file_dialog".to_owned(),
                dl_log_types::FileSource::Sdk => "file_sdk".to_owned(),
            },
