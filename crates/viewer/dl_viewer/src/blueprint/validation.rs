...
mod tests {
    ...
    use dl_entity_db::EntityDb;
    use dl_log_types::{StoreId, TimePoint};
    use dl_sdk_types::{Loggable as _, archetypes::Points3D, components::Radius};

    use super::is_valid_blueprint;

    fn reflection() -> dl_types_core::reflection::ComponentReflectionMap {
        dl_sdk_types::reflection::generate_reflection()
