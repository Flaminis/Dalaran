...
pub struct HarnessOptions {
    ...
    pub snapshot_test_options: dl_ui::testing::TestOptions,
...
impl Default for HarnessOptions {
    fn default() -> Self {
        Self {
            ...
            snapshot_test_options: dl_ui::testing::TestOptions::Gui,
            os: None,
...
pub fn viewer_harness(options: &HarnessOptions) -> Harness<'static, App> {
    ...
    let mut harness_builder =
        dl_ui::testing::new_harness(options.snapshot_test_options, window_size);
    ...
    harness_builder.build_eframe(|cc| {
        ...
        let addr =
            std::net::SocketAddr::from((std::net::Ipv4Addr::LOCALHOST, dl_uri::DEFAULT_PROXY_PORT));
    ...
    if !success {
        ...
        harness
            .try_snapshot_options(
                test_description,
                &dl_ui::testing::default_snapshot_options_for_ui().output_path(snapshot_path),
            )
            .ok();
