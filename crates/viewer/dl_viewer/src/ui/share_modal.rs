...
impl ShareModal {
    ...
    pub fn ui(
        ...
        let Some(url) = &mut self.url else {
            ...
            dl_log::debug_assert!(!self.modal.is_open());
            return;
        };
...
mod tests {
    ...
    fn test_share_modal() {
        ...
        let timeline = dl_log_types::Timeline::new_timestamp("pictime");

        // Log some entity so our timeline exists.
        test_ctx.log_entity(EntityPath::from("points"), |builder| {
            builder.with_archetype(
                dl_chunk::RowId::new(),
                [(timeline, dl_chunk::TimeInt::ZERO)],
                &dl_sdk_types::archetypes::Points2D::new([(0., 0.), (1., 1.)]),
            )
        });
        ...
        test_ctx.send_time_commands(
            ...
            [
                ...
                TimeControlCommand::SetTime(dl_chunk::TimeInt::ZERO.into()),
        ...
        modal.lock().url = Some(ViewerOpenUrl::RedapDatasetSegment(
            dl_uri::DatasetSegmentUri {
                ...
                fragment: dl_uri::Fragment {
                    ...
                    time_selection: Some(dl_uri::TimeSelection {
                        timeline,
                        range: dl_log_types::AbsoluteTimeRange::new(0, 1000),
                    }),
                },
            },
        ));
