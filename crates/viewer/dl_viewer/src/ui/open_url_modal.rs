...
use dl_ui::{UICommand, UiExt as _};
...
mod tests {
    ...
    fn test_open_url_modal() {
        ...
        *url.lock() = "dalaran://sandbox.redap.dalaran.dev:443/dataset/185998CF5EF38BF27f3e5ede1ca9a1a2?segment_id=ILIAD_5e938e3b_2023_07_28_10h_25m_47s".to_owned();
        harness.run();
