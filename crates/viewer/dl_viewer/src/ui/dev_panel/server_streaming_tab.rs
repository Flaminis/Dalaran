...
fn recording_ui(
    ui: &mut egui::Ui,
    recording: &dl_entity_db::EntityDb,
...
fn recording_details_ui(ui: &mut egui::Ui, recording: &dl_entity_db::EntityDb, is_preview: bool) {
...
fn status_ui(ui: &mut egui::Ui, recording: &dl_entity_db::EntityDb) {
...
fn chunks_removed_ui(ui: &mut egui::Ui, recording: &dl_entity_db::EntityDb) {
...
fn streaming_plots(ui: &mut egui::Ui, history: &StreamingHistory) {
    ...
    let now = dl_memory::util::sec_since_start();
