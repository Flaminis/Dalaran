...
use dl_viewer_context::external::dl_tf::transform_cache_snapshot;
use dl_viewer_context::{StorageContext, TransformDatabaseStoreCache};
            ...
            |ui| {
                ...
                if current_model.snapshot.frames.is_empty() {
                    ...
                    ui.info_label(format!(
                        "{}, {}, {}",
                        dl_format::format_plural_s(current_model.num_trees(), "tree"),
                        dl_format::format_plural_s(current_model.snapshot.frames.len(), "frame"),
                        dl_format::format_plural_s(current_model.snapshot.edges.len(), "transform")
                    ));
                }
                ui.separator();
