...
impl dl_byte_size::MemUsageTreeCapture for ChunkEventStats {
    fn capture_mem_usage_tree(&self) -> dl_byte_size::MemUsageTree {
        dl_byte_size::MemUsageTree::Bytes(std::mem::size_of::<Self>() as u64)
    }
}
...
impl ChunkEventStats {
    ...
    pub fn for_store(store_id: &dl_log_types::StoreId) -> Self {
