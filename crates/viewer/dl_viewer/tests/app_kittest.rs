...
/// This is defined here instead of in `dl_viewer/tests` because it depends on `dl_test_context`,
/// which depends on `dl_viewer_context`.
#[test]
        ...
        .build_ui(|ui| {
            ...
            test_context.run_recording(&ui.ctx().clone(), |ctx| {
                ui.horizontal(|ui| {
                    ...
                    dl_viewer_context::gpu_bridge::colormap_edit_or_view_ui_with_selection(
                        ctx,
                        ui,
                        &mut colormap_ref,
