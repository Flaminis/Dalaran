...
impl SpatialViewState {
    ...
    /// the eye was updated.
    pub fn last_tracked_entity(&self) -> Option<&dl_log_types::EntityPath> {
...
pub fn draw_origin_axes(
    ...
    crate::visualizers::add_axis_arrows(
        ...
        axis_length,
        axes,
        dl_renderer::OutlineMaskPreference::NONE,
...
pub fn draw_bounding_boxes(
    ...
    let box_line_radius = dl_renderer::Size(*Radius::default().0);
