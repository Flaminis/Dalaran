...
impl dl_byte_size::SizeBytes for SubSpaceConnectionFlags {
...
impl dl_byte_size::SizeBytes for HeuristicHints {
    const IS_POD: bool = true;
...
impl dl_byte_size::MemUsageTreeCapture for SpatialTopologyStoreSubscriber {
...
impl SpatialTopology {
    ...
    fn on_store_diff<'a>(
        ...
        added_components: impl Iterator<Item = &'a dl_sdk_types::ComponentDescriptor>,
    ) {
        dl_tracing::profile_function!();
        ...
        for added_component in added_components.filter_map(|descr| descr.component_type) {
            ...
            } else if added_component == dl_tf::TransformFrameId::name() {
    ...
    /// True if a component of type [`dl_tf::TransformFrameId`] has been logged.
