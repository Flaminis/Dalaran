...
use dl_renderer::QueueableDrawData;
use dl_renderer::renderer::TexturedRect;
use dl_sdk_types::components::DepthMeter;
use dl_viewer_context::{ImageInfo, ViewSystemExecutionError};
...
impl PickableTexturedRect {
    ...
    pub fn to_draw_data(
        ...
        let rectangles = rects
            ...
            .collect::<Vec<_>>();
        match dl_renderer::renderer::RectangleDrawData::new(render_ctx, &rectangles) {
