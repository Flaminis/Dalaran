use dl_sdk_types::Archetype;
use dl_view::{AnnotationMapCache, DataResultQuery as _, VisualizerInstructionQueryResults};
...
{
    dl_tracing::profile_function!(V::identifier());
        ...
        query.iter_visualizer_instruction_for(system_identifier)
    {
        ...
        {
            dl_tracing::profile_scope!(format!("{entity_path}"));
            fun(
                &query_ctx,
                &instruction_context,
