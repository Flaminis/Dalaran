...
impl Points2DVisualizer {
    fn process_data<'a>(
        ...
        for data in data {
            ...
            let point_cloud_bounds = dl_renderer::util::point_cloud_bounds(&positions);

            {
                let point_batch = point_builder
                    ...
                    .flags(
                        dl_renderer::renderer::PointCloudBatchFlags::FLAG_DRAW_AS_CIRCLES
                            | dl_renderer::renderer::PointCloudBatchFlags::FLAG_ENABLE_SHADING,
                    )
                ...
                {
                    dl_tracing::profile_scope!("marking additional highlight points");
    ...
    fn execute(
        ...
        process_archetype::<Points2D, _, _>(
            ...
            |ctx, spatial_ctx, results| {
                ...
                let results_iter = dl_query::range_zip_1x6(
