...
use dl_sdk_types::archetypes::Ellipses2D;
use dl_sdk_types::components::{ClassId, Color, HalfSize2D, Position2D, Radius, ShowLabels};
use dl_sdk_types::{Archetype as _, ArrowString};
use dl_view::{clamped_or, process_annotation_slices, process_color_slice};
