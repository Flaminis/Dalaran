...
use dl_sdk_types::archetypes::LineStrips3D;
use dl_sdk_types::components::{ClassId, Color, LineStrip3D, Radius, ShowLabels};
use dl_sdk_types::{Archetype as _, ArrowString};
use dl_view::{process_annotation_slices, process_color_slice};
