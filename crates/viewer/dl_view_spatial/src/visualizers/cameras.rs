...
impl CamerasVisualizer {
    fn visit_instance(
        ...
        ctx: &dl_viewer_context::QueryContext<'_>,
        ...
        let pinhole_child_frame_id =
            dl_tf::TransformFrameIdHash::new(&pinhole_properties.child_frame);
        ...
        dl_log::debug_assert!(world_from_camera_iso.is_finite());
        ...
        let instance_path_for_picking =
            dl_entity_db::InstancePathHash::instance(ent_path, instance);
        let instance_layer_id =
            dl_view::picking_layer_id_from_instance_path_hash(instance_path_for_picking);
...
impl VisualizerSystem for CamerasVisualizer {
    ...
    fn execute(
        ...
        {
            let time_query = dl_chunk_store::LatestAtQuery::new(query.timeline, query.latest_at);
