...
use dl_sdk_types::archetypes::Asset3D;
use dl_sdk_types::components::{AlbedoFactor, Blob};
    ...
    fn process_data<'a>(
        ...
        for asset in asset_data {
            ...
            if let Some(mesh) = mesh {
                dl_tracing::profile_scope!("mesh instances");
    ...
    fn execute(
        ...
        process_archetype::<Asset3D, _, _>(
            ...
            |ctx, spatial_ctx, results| {
                ...
                let asset_data = dl_query::range_zip_1x2(
                    all_blobs.slice::<&[u8]>(),
