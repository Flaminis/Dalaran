...
use dl_sdk_types::archetypes::Points3D;
...
use dl_view::{process_annotation_and_keypoint_slices, process_color_slice};
...
impl Points3DCpu {
    fn compute(
        ...
        dl_tracing::profile_function!(num_instances.to_string());
        ...
        let point_cloud_bounds = {
            ...
            dl_renderer::util::point_cloud_bounds(positions)
        };
...
struct Points3DCacheKey {
    ...
    annotation_row_id: dl_chunk_store::RowId,
}
...
impl dl_byte_size::SizeBytes for Points3DCache {
...
impl dl_byte_size::MemUsageTreeCapture for Points3DCache {
...
impl VisualizerSystem for Points3DVisualizer {
    ...
    fn execute(
        ...
        point_builder.radius_boost_in_ui_points_for_outlines(
            dl_view::SIZE_BOOST_IN_POINTS_FOR_POINT_OUTLINES,
        );
        ...
        process_archetype::<Points3D, _, _>(
            ...
            |ctx, spatial_ctx, results| {
                dl_tracing::profile_scope!("Point3D");
                ...
                let num_positions = {
                    dl_tracing::profile_scope!("num_positions");
                    all_positions
                        .chunks()
                        .iter()
                ...
                let results_iter = dl_query::range_zip_1x7(
