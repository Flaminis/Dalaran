...
use dl_renderer::{LineDrawableBuilder, PickingLayerInstanceId, renderer::LineStripFlags};
use dl_sdk_types::{
    Archetype as _, ArrowString,
    archetypes::Arrows2D,
    components::{ClassId, Color, Position2D, Radius, ShowLabels, Vector2D},
};
use dl_view::{clamped_or, process_annotation_and_keypoint_slices, process_color_slice};
