...
///
/// Corresponds roughly to the [`dl_sdk_types::archetypes::Pinhole`] archetype, but uses render-friendly types.
#[derive(Clone, Copy, Debug, PartialEq, dl_byte_size::SizeBytes)]
pub struct Pinhole {
