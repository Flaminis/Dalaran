...
use dl_sdk_types::blueprint::archetypes::SpatialInformation;
...

    {
        test_context.log_entity("/", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::default(),
                &dl_sdk_types::archetypes::ViewCoordinates::RIGHT_HAND_Z_UP(),
            )
        });
        ...
        test_context.log_entity("sun", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::default(),
                &dl_sdk_types::archetypes::Points3D::new([[0.0, 0.0, 0.0]])
                    .with_radii([0.6])
        ...
        test_context.log_entity("sun/planet/cuberoids", |builder| {
            builder
                .with_archetype(
                    RowId::new(),
                    TimePoint::default(),
                    &dl_sdk_types::archetypes::Boxes3D::from_half_sizes([[0.1, 0.1, 0.1]])
                ...
                .with_archetype(
                    RowId::new(),
                    TimePoint::default(),
                    &dl_sdk_types::archetypes::InstancePoses3D::new().with_translations(
                        (0..6).flat_map(|x| {
        ...
        test_context.log_entity("sun/planet_path", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::default(),
                &dl_sdk_types::archetypes::LineStrips3D::new([
                    dl_sdk_types::components::LineStrip3D::from_iter(
                        circle
                            .iter()
        ...
        test_context.log_entity("sun/planet", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::default(),
                &dl_sdk_types::archetypes::Transform3D::from_translation_rotation(
                    [r_planet.sin() * d_planet, r_planet.cos() * d_planet, 0.0],
                    dl_sdk_types::datatypes::RotationAxisAngle {
                        axis: [1.0, 0.0, 0.0].into(),
                        angle: dl_sdk_types::datatypes::Angle::from_degrees(20.0),
                    },
                ),
            )
        });
        ...
        test_context.log_entity("sun/planet/moon", |builder| {
            builder.with_archetype(
                ...
                .with_relation(dl_sdk_types::components::TransformRelation::ChildFromParent),
            )
        });
    }
