...
use dl_sdk_types::components::FillMode;
...
use dl_viewer_context::{Item, RecommendedView, ViewClass as _};
...
fn test_select_box_instances() {
    ...
    for selected_instance_path in [
        ...
        let mut harness = test_context
            ...
            .with_options(dl_ui::testing::default_snapshot_options_for_3d(egui::vec2(
                300.0, 300.0,
            )))
            .build_ui(|ui| {
