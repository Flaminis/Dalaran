...
use dl_sdk_types::blueprint::archetypes::{SpatialInformation, VisualBounds2D};
use dl_sdk_types::blueprint::components::Enabled;
use dl_sdk_types::{Archetype as _, archetypes::Points2D};
use dl_test_context::TestContext;
use dl_test_viewport::TestContextExt as _;
use dl_view_spatial::{SpatialView2D, SpatialViewState};
use dl_viewer_context::{BlueprintContext as _, ViewClass as _, ViewStateExt as _};
...
fn test_spatial_information_2d() {
    ...
    let view_id = test_context.setup_viewport_blueprint(|ctx, blueprint| {
        ...
        let visual_bounds_path = dl_viewport_blueprint::entity_path_for_view_property(
            view.id,
            ctx.store_context
                .blueprint
                .storage_engine()
        ...
        ctx.save_blueprint_archetype(
            visual_bounds_path,
            &VisualBounds2D::new(dl_sdk_types::datatypes::Range2D {
