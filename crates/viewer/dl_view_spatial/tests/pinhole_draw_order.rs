...
use dl_sdk_types::archetypes::{Image, Pinhole, Transform3D};
...
use dl_viewer_context::{Item, ViewClass as _, ViewId};
...
fn solid_rgb_image(width: usize, height: usize, color: [u8; 3]) -> Image {
    ...
    Image::from_color_model_and_tensor(dl_sdk_types::datatypes::ColorModel::RGB, image)
...
fn run_view_ui_and_save_snapshot(
    ...
    let mut harness = test_context
        ...
        .with_options(dl_ui::testing::default_snapshot_options_for_3d(size))
        .build_ui(|ui| {
