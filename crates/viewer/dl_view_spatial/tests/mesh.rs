...
pub fn test_single_channel_mesh() {
    let texture_format = dl_sdk_types::components::ImageFormat::l8([2, 2]);
    let texture_buffer = dl_sdk_types::components::ImageBuffer::from(vec![128, 255, 0, 128]);
