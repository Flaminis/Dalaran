...

    {
            ...
            builder.with_archetype(
                ...
                &dl_sdk_types::archetypes::AnnotationContext::new([
                    (
                        0,
                        "black",
                        dl_sdk_types::datatypes::Rgba32::from_rgb(0, 0, 0),
                    ),
                    (
                        1,
                        "red",
        ...
        test_context.log_entity("detections", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::default(),
                &dl_sdk_types::archetypes::Boxes2D::from_mins_and_sizes(
        ...
        test_context.log_entity("segmentation/image", |builder| {
            ...
            builder.with_archetype(
                RowId::new(),
                TimePoint::default(),
                &dl_sdk_types::archetypes::SegmentationImage::try_from(image)
                    .unwrap()
                    .with_draw_order(0.0),
            )
        });
