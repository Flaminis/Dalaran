...
use dl_sdk_types::components::Position3D;
...

    {
        test_context.log_entity("base/boxes/clamped_colors", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::STATIC,
                &dl_sdk_types::archetypes::Boxes3D::from_half_sizes([
                    (1.0, 1.0, 1.0),
                    (2.0, 2.0, 2.0),
                ])
        ...
        test_context.log_entity("base/boxes/more_transforms_than_sizes", |builder| {
            builder
                ...
                .with_archetype(
                    ...
                    &dl_sdk_types::archetypes::InstancePoses3D::new()
        ...
        test_context.log_entity("base/boxes/no_primaries", |builder| {
            builder
                .with_archetype(
                    RowId::new(),
                    TimePoint::STATIC,
                    &dl_sdk_types::archetypes::Boxes3D::update_fields()
...

    {
        test_context.log_entity("base/spheres/clamped_colors", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::STATIC,
                &dl_sdk_types::archetypes::Ellipsoids3D::from_half_sizes([
                    (1.0, 1.0, 1.0),
                    (2.0, 2.0, 2.0),
                ])
                .with_colors([0xFF0000FF]),
        ...
        test_context.log_entity("base/spheres/ignored_colors", |builder| {
            builder.with_archetype(
                RowId::new(),
                TimePoint::STATIC,
                &dl_sdk_types::archetypes::Ellipsoids3D::from_centers_and_half_sizes(
                    [(5.0, 0.0, 0.0)],
                    [(1.0, 1.0, 1.0)],
                )
                .with_colors([0x00FF00FF, 0xFF00FFFF]),
        ...
        test_context.log_entity("base/spheres/no_primaries", |builder| {
            builder
                .with_archetype(
                    RowId::new(),
                    TimePoint::STATIC,
                    &dl_sdk_types::archetypes::Ellipsoids3D::update_fields()
                        .with_centers([(5.0, 0.0, 0.0)])
                        .with_colors([0xFF00FFFF]),
                )
                .with_archetype(
        ...
        test_context.log_entity("base/points/more_transforms_than_positions", |builder| {
            builder
                .with_archetype(
                    RowId::new(),
                    TimePoint::STATIC,
                    &dl_sdk_types::archetypes::Points3D::new([(0.0, -2.0, 0.0), (0.0, 1.0, 0.0)])
            ...
            |builder| {
                builder
                    .with_archetype(
                        RowId::new(),
                        TimePoint::STATIC,
                        &dl_sdk_types::archetypes::TransformAxes3D::new(1.0),
                    )
                    .with_archetype(
                        RowId::new(),
                        TimePoint::STATIC,
        ...
        BaseTransform::EntityHierarchy => {
            test_context.log_entity("base", |builder| {
                builder.with_archetype_auto_row(
                    TimePoint::STATIC,
                    &dl_sdk_types::archetypes::Transform3D::from_rotation(
                        dl_sdk_types::components::RotationAxisAngle::new(
                            glam::Vec3::Z,
        ...
        BaseTransform::FrameHierarchy => {
            ...
            for path in entity_paths {
                test_context.log_entity(path, |builder| {
                    builder.with_archetype_auto_row(
                        TimePoint::STATIC,
                        &dl_sdk_types::archetypes::CoordinateFrame::new("base"),
                    )
                });
            }
