...
#[derive(Copy, Clone, Eq, dl_byte_size::SizeBytes)]
...
///     dl_string_interner::intern_static!(ViewSystemIdentifier, "Ellipsoids3D")
/// }
/// ```
#[macro_export]
...
/// ```ignore
/// fn identifier() -> ViewSystemIdentifier {
///     dl_string_interner::intern_static_nonempty!(ViewSystemIdentifier, "Ellipsoids3D")
/// }
/// ```
///
...
///     pub struct MyString;
/// );
/// let _ = dl_string_interner::intern_static_nonempty!(MyString, "non_empty");
/// ```
///
...
///     pub struct MyString;
/// );
/// let _ = dl_string_interner::intern_static_nonempty!(MyString, "");
/// ```
#[macro_export]
...
/// Usage:
/// ```
/// dl_string_interner::declare_new_type!(
///     /// My typesafe string
///     pub struct MyString;
/// );
/// ```
...
macro_rules! declare_new_type {
    (
        ...
        impl dl_byte_size::SizeBytes for $StructName {
