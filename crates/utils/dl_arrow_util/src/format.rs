...
// A) Because `dl_format` cannot depend on other crates (cyclic deps)
// B) Because how to deserialize and inspect some type is a private implementation detail of that
//    type, dl_format shouldn't know how to deserialize a TUID…
...
// TODO(#1775): This should be defined and registered by the `dl_tuid` crate.
