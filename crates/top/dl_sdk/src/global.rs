...
pub fn cleanup_if_forked_child() {
    ...
    {
        dl_log::debug!("Fork detected. Forgetting global recording");
    ...
    {
        dl_log::debug!("Fork detected. Forgetting global blueprint");
        RecordingStream::forget_global(StoreKind::Recording);
    }
    ...
    {
        dl_log::debug!("Fork detected. Forgetting thread-local recording");
    ...
    {
        dl_log::debug!("Fork detected. Forgetting thread-local blueprint");
