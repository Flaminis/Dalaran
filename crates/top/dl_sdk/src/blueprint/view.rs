...
use dl_sdk_types::blueprint::components::{QueryExpression, ViewClass};
use dl_sdk_types::components::{Name, Visible};
use dl_sdk_types::datatypes::Bool;
use dl_sdk_types::{AsComponents, SerializedComponentBatch, Visualizer};
...
impl MapView {
    ...
    pub fn with_map_provider(
        mut self,
        provider: dl_sdk_types::blueprint::components::MapProvider,
    ) -> Self {
        self.0
...
/// Text log view, for use with [`dl_sdk_types::archetypes::TextLog`].
...
/// Bar chart view, for use with [`dl_sdk_types::archetypes::BarChart`].
...
/// Tensor view, for use with [`dl_sdk_types::archetypes::Tensor`].
