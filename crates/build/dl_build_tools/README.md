...
Library to be used in `build.rs` files in order to build the build info defined in `dl_build_info` by setting environment variables.

Some information in `dl_build_info` can be provided through env vars:
