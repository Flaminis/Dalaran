...
//!
//! To use this you also need to call `dl_build_tools::export_env_vars()` from your build.rs.
...
/// calling `dl_build_tools::export_env_vars()` from your build.rs.
#[macro_export]
macro_rules! build_info {
    () => {
        $crate::BuildInfo {
            ...
            is_in_dalaran_workspace: env!("RE_BUILD_IS_IN_DALARAN_WORKSPACE") == "yes",
...
/// `dl_build_tools::export_build_info_vars_for_crate()`.
///
