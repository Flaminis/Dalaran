...
//! `dl_protos` proto files. We are currently generating both client and server
    ...
    P: AsRef<std::path::Path>,
{
    ...
    prost_config.bytes([
        ".dalaran.common.v1alpha1",
        ".dalaran.cloud.v1alpha1",
        ".dalaran.log_msg.v1alpha1",
        ".dalaran.manifest_registry.v1alpha1",
    ]);
