...
//!
//! The definitions are a subset of Rust that `dl_types_builder` parses (see
...
//!
//! The crate root is `dalaran/lib.rs`, so that `dalaran/components/position3d.rs` is the module
//! `crate::components::position3d`, and the `extern crate self as dalaran;` in the root makes
//! `dalaran::components::Position3D` — the fully-qualified name with `::` for `.` — resolve from
...
const CRATE_ROOT_DIR: &str = "dalaran";
...
const PRELUDE: &str = "dl_types_builder_prelude";
...
fn module_file(contents: &DirContents, is_crate_root: bool) -> String {
    ...
    if is_crate_root {
        write!(
            out,
            "
// Dalaran's type definitions. This crate is never linked into anything: rustc compiles it so that
// we get name resolution, typo-checking, rust-analyzer and `cargo fmt` on the definitions.
//
// `extern crate self as dalaran;` is what lets a definition refer to another one by its
// fully-qualified name — `dalaran::components::Position3D` — with no `use` statement anywhere.
...
mod tests {
    ...
    fn package_module_file() {
        ...
        // DO NOT EDIT! This file was auto-generated by crates/build/dl_types_builder/src/codegen/definitions/mod.rs
    ...
    fn crate_root_module_file() {
        ...
        // plain Rust, and the attribute macro. Glob-imported, so that the vocabulary lives in the prelude
        // alone and this generator does not have to know it.
        pub use dl_types_builder_prelude::*;
