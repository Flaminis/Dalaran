...
//!
//! Make sure to test the behavior of its output though: `dl_sdk_types`!
//!
//!
...
pub fn compute_re_types_builder_hash() -> String {
    ...
    compute_crate_hash("dl_types_builder")
}
...
pub fn compute_re_types_hash(locations: &SourceLocations<'_>) -> String {
    ...
    dl_log::debug!("re_types_builder_hash: {re_types_builder_hash:?}");
    dl_log::debug!("definitions_hash: {definitions_hash:?}");
    dl_log::debug!("snippets_hash: {snippets_hash:?}");
    dl_log::debug!("snippets_index_hash: {snippets_index_hash:?}");
    dl_log::debug!("python_extensions_hash: {python_extensions_hash:?}");
    dl_log::debug!("cpp_extensions_hash: {cpp_extensions_hash:?}");
    dl_log::debug!("new_hash: {new_hash:?}");
...
fn generate_code(
    ...
    {
        dl_tracing::profile_wait!("write_files");
...
pub fn generate_docs(
    ...
    dl_log::info!("Generating docs to {}", output_docs_dir.as_ref());
