...
pub fn default_build_dir() -> Utf8PathBuf {
    // crates/viewer/dl_web_viewer_server/web_viewer
    workspace_root()
        .join("crates")
        .join("viewer")
        .join("dl_web_viewer_server")
        .join("web_viewer")
}
...
/// Build `dl_viewer` as Wasm, generate .js bindings for it, and place it all into the `build_dir` folder.
///
