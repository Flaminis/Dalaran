        ...
        [
            ...
            LayerDefinition::properties(
                ...
                [
                    prop(
                        "text_log",
                        dl_sdk_types::archetypes::TextLog::new("i'm segment 2"),
                    ),
                    prop(
                        "points",
                        dl_sdk_types::archetypes::Points2D::new([(0.0, 1.0)]),
                    ),
                ],
            )
            .layer_name("props"),
...
pub async fn register_and_scan_simple_dataset_with_properties_out_of_order(
    ...
    let first_logged_data_sources_def = DataSourcesDefinition::new_with_tuid_prefix(
        ...
        [LayerDefinition::properties(
            ...
            [prop(
                "text_log",
                dl_sdk_types::archetypes::TextLog::new(
    ...
    let last_logged_data_sources_def = DataSourcesDefinition::new_with_tuid_prefix(
        ...
        [LayerDefinition::properties(
            ...
            [prop(
                "text_log",
                dl_sdk_types::archetypes::TextLog::new("I was logged last, registered first"),
            )],
        )
        .layer_name("prop2")],
    );
...
pub async fn register_with_dataset_if_duplicate_behavior_skip(service: impl DalaranCloudService) {
    ...
    let first_data_sources_def = DataSourcesDefinition::new_with_tuid_prefix(
        ...
        [LayerDefinition::properties(
            ...
            [prop(
                "text_log",
                dl_sdk_types::archetypes::TextLog::new("first"),
            )],
        )],
    );
    ...
    let second_data_sources_def = DataSourcesDefinition::new_with_tuid_prefix(
        ...
        [LayerDefinition::properties(
            ...
            [prop(
                "text_log",
                dl_sdk_types::archetypes::TextLog::new("second"),
            )],
        )],
    );
