...
pub trait DalaranCloudServiceExt: DalaranCloudService {
    ...
    async fn register_with_dataset_name_blocking(
        &self,
        dataset_name: &str,
        data_sources: Vec<dl_protos::cloud::v1alpha1::DataSource>,
    );
...
impl<T: DalaranCloudService> DalaranCloudServiceExt for T {
    ...
    async fn register_with_dataset_name_blocking_with_behavior(
        ...
        let request = tonic::Request::new(RegisterWithDatasetRequest {
            data_sources,
            on_duplicate: dl_protos::common::v1alpha1::IfDuplicateBehavior::from(on_duplicate)
                as i32,
        })
    ...
    ///
    /// [`UnregisterFromDatasetRequest`]: dl_protos::cloud::v1alpha1::ext::UnregisterFromDatasetRequest
    async fn unregister_from_dataset_name_blocking(
        &self,
        dataset_name: &str,
        segments_to_drop: &[&str],
