...
mod tests {
    ...
    use dl_importer::importer_mcap::McapImporter;
    use dl_importer::{ImportedData, ImporterSettings};
    ...
    fn load_mcap_chunks(path: impl AsRef<std::path::Path>) -> Vec<Chunk> {
        ...
        let mcap_file = dl_mcap::McapFile::new(mcap_data, false);
    ...
    fn test_mcap_importer_ros2() {
        ...
        let store = ChunkStore::new(
            StoreId::random(dl_log_types::StoreKind::Recording, "test_mcap_importer"),
