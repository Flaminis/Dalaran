...
The upstream dataset and both Dalaran mirrors declare the Apache-2.0 license; see [`LICENSE-APACHE`](../../../../../../LICENSE-APACHE).

`v21_apple_storage` is derived from [`dalaran/v21_apple_storage`](https://huggingface.co/datasets/dalaran/v21_apple_storage) at revision `91b47932e95ae0c688960f96889bd3f447383d52`.
`v30_apple_storage` is derived from [`dalaran/v30_apple_storage`](https://huggingface.co/datasets/dalaran/v30_apple_storage) at revision `da288fcf2eee05e4f5839735d3c19839bf0b24e5`.
