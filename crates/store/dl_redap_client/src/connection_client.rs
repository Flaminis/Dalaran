...
pub type FetchChunksResponseStream =
    ApiResponseStream<dl_protos::cloud::v1alpha1::FetchChunksResponse>;

pub type QueryDatasetResponseStream =
    ApiResponseStream<dl_protos::cloud::v1alpha1::QueryDatasetResponse>;
...
async fn fetch_rrd_manifest_via_key(
    ...
    cfg_select! {
            target_family = "wasm" => {
                let response = dl_async::spawn_local_with_result(ehttp::fetch_async(request))
                .await
...
pub struct SegmentQueryParams {
    ...
    pub query: Option<dl_protos::cloud::v1alpha1::Query>,
}
    ...
    <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
{
    ...
    /// and permissions.
    #[tracing::instrument(level = "info", skip_all)]
    pub async fn who_am_i(&mut self) -> ApiResult<dl_protos::cloud::v1alpha1::WhoAmIResponse> {
        self.inner()
            .who_am_i(dl_protos::cloud::v1alpha1::WhoAmIRequest {})
            .await
    ...
    pub async fn rtt(&mut self, num_pings: usize) -> ApiResult<std::time::Duration> {
        ...
        for _ in 0..num_pings {
            ...
            let mut stream = self
                .inner()
                .do_bandwidth_test(dl_protos::cloud::v1alpha1::DoBandwidthTestRequest {
                    num_bytes: 1,
                })
                .await
    ...
    pub async fn bandwidth_bytes_per_sec(
        ...
        let mut stream = self
            .inner()
            .do_bandwidth_test(dl_protos::cloud::v1alpha1::DoBandwidthTestRequest { num_bytes })
            .await
            .map_err(|err| ApiError::tonic(err, "/DoBandwidthTest failed"))?
            .into_inner();
    ...
    pub async fn watch_events(&mut self) -> ApiResult<ApiResponseStream<WatchEventsResponse>> {
        let response = self
            .inner()
            .watch_events(dl_protos::cloud::v1alpha1::WatchEventsRequest {
                kinds: vec![dl_protos::cloud::v1alpha1::EventKind::entry()],
            })
            .await
        ...
        T: Clone,
    {
        ...
        if chunk_info_batches.is_empty() {
            return Ok(ApiResponseStream::new(
                tokio_stream::empty::<ApiResult<dl_protos::cloud::v1alpha1::FetchChunksResponse>>(),
                None,
            ));
        }
    ...
    pub async fn do_global_maintenance(&mut self) -> ApiResult {
        self.inner()
            .do_global_maintenance(tonic::Request::new(
                dl_protos::cloud::v1alpha1::DoGlobalMaintenanceRequest {},
            ))
            .await
    ...
    pub async fn get_table_names(&mut self) -> ApiResult<Vec<EntryName>> {
        Ok(self
            .find_entries(dl_protos::cloud::v1alpha1::EntryFilter {
    ...
    pub async fn write_table(
        ...
        let insert_mode = dl_protos::cloud::v1alpha1::TableInsertMode::from(insert_mode).into();
        let stream = stream
...
mod tests {
    ...
    async fn direct_rrd_manifest_fetch_uses_range_and_etag() {
        ...
        let expected = dl_log_encoding::HubRrdManifest::try_from_raw(
            &raw_manifest,
            &segment_id,
            &layer,
            &canonical_url,
