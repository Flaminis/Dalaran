...
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash, dl_byte_size::SizeBytes)]
pub struct DatasetSegmentUri {
    pub origin: Origin,
    pub dataset_id: dl_tuid::Tuid,
...
impl DatasetSegmentUri {
    pub fn new(origin: Origin, dataset_id: dl_tuid::Tuid, url: &url::Url) -> Result<Self, Error> {
    ...
    pub fn store_id(&self) -> StoreId {
        #[expect(deprecated)]
        let application_id = dl_log_types::ApplicationId::from_entry_id(
            dl_log_types::EntryId::from(self.dataset_id),
        );
        StoreId::new(
