...
impl std::str::FromStr for RedapUri {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        ...
        match segments.as_slice() {
            ...
            ["entry", entry_id] => {
                let entry_id =
                    dl_log_types::EntryId::from_str(entry_id).map_err(Error::InvalidTuid)?;
            ...
            ["dataset", dataset_id] => {
                let dataset_id = dl_tuid::Tuid::from_str(dataset_id).map_err(Error::InvalidTuid)?;
