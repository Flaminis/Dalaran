use dl_log_types::{DataPath, TimeCell, TimelineName};
...
/// # }
/// ```
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash, Default, dl_byte_size::SizeBytes)]
pub struct Fragment {
        ...
        (
            ...
            Fragment {
                ...
                time_selection: Some(TimeSelection {
                    timeline: dl_log_types::Timeline::log_time(),
                    range: dl_log_types::AbsoluteTimeRange::new(
