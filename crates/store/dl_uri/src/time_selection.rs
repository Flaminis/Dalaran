use dl_log_types::{AbsoluteTimeRange, AbsoluteTimeRangeF, TimeCell, Timeline, TimelineName};
...
impl TimeSelection {
    pub fn format(&self, timestamp_format: dl_log_types::TimestampFormat) -> String {
        format!(
            "{}-{}",
