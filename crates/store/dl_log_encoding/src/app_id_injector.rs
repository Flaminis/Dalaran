...
use dl_log_types::{ApplicationId, RecordingId, StoreId, StoreInfo, StoreKind};
use dl_protos::common::v1alpha1::ext::StoreIdMissingApplicationIdError;
...
pub trait ApplicationIdInjector {
    /// Populate the cache based on a [`dl_log_types::SetStoreInfo`] payload.
