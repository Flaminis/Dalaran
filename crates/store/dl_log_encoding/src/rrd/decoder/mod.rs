    ...
    fn decode(
        ...
        Ok(Some(match message_kind {
            MessageKind::SetStoreInfo => Self::SetStoreInfo(
                dl_protos::log_msg::v1alpha1::SetStoreInfo::from_rrd_bytes(data)?,
            ),

            MessageKind::ArrowMsg => Self::ArrowMsg(
                dl_protos::log_msg::v1alpha1::ArrowMsg::from_rrd_bytes(data)?,
            ),

            MessageKind::BlueprintActivationCommand => Self::BlueprintActivationCommand(
                dl_protos::log_msg::v1alpha1::BlueprintActivationCommand::from_rrd_bytes(data)?,
            ),
