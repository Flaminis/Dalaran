...
pub struct StreamFooterEntry {
    ...
    /// let rrd_footer = dl_protos::RrdFooter::decode(bytes)?;
    /// let rrd_footer = rrd_footer.to_application()?;
    /// ```
    ///
    /// [`RrdFooter`]: [crate::RrdFooter]
    pub rrd_footer_byte_span_from_start_excluding_header: dl_span::Span<u64>,
...
impl StreamFooter {
    ...
    pub fn new(
        rrd_footer_byte_span_from_start_excluding_header: dl_span::Span<u64>,
    ...
    pub fn from_rrd_footer_bytes(
        ...
        let rrd_footer_byte_span_from_start_excluding_header = dl_span::Span {
