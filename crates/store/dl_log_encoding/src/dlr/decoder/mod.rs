//! Decoding `LogMsg`:es from `.dlr` files/streams.
...
pub enum DecodeError {
    #[error("Codec error: {0}")]
    Codec(#[from] crate::dlr::CodecError),
...
/// * [`dl_log_types::LogMsg`]: application-level root message
/// * [`dl_protos::log_msg::v1alpha1::log_msg::Msg`]: transport-level root message
///
...
pub trait DecoderEntrypoint: Sized {
    fn decode(
        ...
        byte_span_excluding_headers: dl_chunk::Span<u64>,
        message_kind: crate::dlr::MessageKind,
        app_id_injector: &mut impl ApplicationIdInjector,
        patched_version: Option<CrateVersion>,
    ) -> Result<Option<Self>, crate::dlr::CodecError>;
}

impl DecoderEntrypoint for dl_log_types::LogMsg {
    fn decode(
        data_excluding_headers: bytes::Bytes,
        byte_span_excluding_headers: dl_chunk::Span<u64>,
        message_kind: crate::dlr::MessageKind,
        ...
        let Some(log_msg) = dl_protos::log_msg::v1alpha1::log_msg::Msg::decode(
...
impl DecoderEntrypoint for dl_protos::log_msg::v1alpha1::log_msg::Msg {
    fn decode(
        data_excluding_headers: bytes::Bytes,
        _byte_span_excluding_headers: dl_chunk::Span<u64>,
        message_kind: crate::dlr::MessageKind,
        ...
        Ok(Some(match message_kind {
            MessageKind::SetStoreInfo => Self::SetStoreInfo(
                dl_protos::log_msg::v1alpha1::SetStoreInfo::from_dlr_bytes(data)?,
            ),

            MessageKind::ArrowMsg => Self::ArrowMsg(
                dl_protos::log_msg::v1alpha1::ArrowMsg::from_dlr_bytes(data)?,
            ),

            MessageKind::BlueprintActivationCommand => Self::BlueprintActivationCommand(
                dl_protos::log_msg::v1alpha1::BlueprintActivationCommand::from_dlr_bytes(data)?,
            ),
