...
pub struct RrdManifestBuilder {
    ...
    sorbet_schema: dl_sorbet::SchemaBuilder,
    ...
    //
    // TODO(cmc): this only makes sense in the context of physical DLR files. We will need to make
...
impl RrdManifestBuilder {
    ...
    pub fn append(
        &mut self,
        chunk_batch: &dl_sorbet::ChunkBatch,
