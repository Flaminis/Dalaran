...
/// Usage:
/// ```ignore
/// dl_types_core::delegate_arrow_tuid!(RowId);
/// ```
#[macro_export]
macro_rules! delegate_arrow_tuid {
    ($typ:ident as $fqname:expr) => {
        ...
        impl $crate::Loggable for $typ {
            #[inline]
            fn arrow_datatype() -> ::arrow::datatypes::DataType {
                $crate::external::dl_tuid::Tuid::arrow_datatype()
            }
            ...
            fn to_arrow<'a>(
                ...
                <$crate::external::dl_tuid::Tuid as $crate::Loggable>::to_arrow(
            ...
            fn from_arrow(
                ...
                Ok(
                    <$crate::external::dl_tuid::Tuid as $crate::Loggable>::from_arrow(array)?
                        .into_iter()
                        .map(|tuid| Self(tuid))
                        .collect(),
                )
