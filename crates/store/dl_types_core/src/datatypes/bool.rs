...
#[derive(
    Clone, Debug, Copy, Default, PartialEq, Eq, PartialOrd, Ord, Hash, ::dl_byte_size::SizeBytes,
)]
#[repr(transparent)]
...
impl crate::Loggable for Bool {
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("dalaran.datatypes.Bool#value")?
            .into_iter()
            .map(|v| v.ok_or_else(DeserializationError::missing_data))
            .map(|res| res.map(|v| Some(Self(v))))
            .collect::<DeserializationResult<Vec<Option<_>>>>()
            .with_context("dalaran.datatypes.Bool#value")
            .with_context("dalaran.datatypes.Bool")?)
    }
}
