...
#[derive(Clone, Default, PartialEq, Eq, PartialOrd, Ord, Hash, ::dl_byte_size::SizeBytes)]
#[repr(transparent)]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Utf8#value")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Utf8#value")
        .with_context("dalaran.datatypes.Utf8")?)
    }
}
