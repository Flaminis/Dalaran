...
#[derive(
    Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Default, Hash, ::dl_byte_size::SizeBytes,
)]
#[repr(transparent)]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.EntityPath#path")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.EntityPath#path")
        .with_context("dalaran.datatypes.EntityPath")?)
    }
}
