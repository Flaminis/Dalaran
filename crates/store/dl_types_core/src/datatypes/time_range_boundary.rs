        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.TimeRangeBoundary")?;
            if arrow_data.is_empty() {
                ...
                let cursor_relative = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.TimeRangeBoundary#CursorRelative")?
                        .into_iter()
                ...
                let absolute = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.TimeRangeBoundary#Absolute")?
                        .into_iter()
                        .map(|res_or_opt| res_or_opt.map(crate::datatypes::TimeInt))
                        .collect::<Vec<_>>()
                };
                            ...
                            Ok(Some(match typ {
                                1i8 => Self::CursorRelative({
                                    if offset as usize >= cursor_relative.len() {
                                        ...
                                        .with_context(
                                            "dalaran.datatypes.TimeRangeBoundary#CursorRelative",
                                        );
                                    }
                                ...
                                2i8 => Self::Absolute({
                                    if offset as usize >= absolute.len() {
                                        ...
                                        .with_context(
                                            "dalaran.datatypes.TimeRangeBoundary#Absolute",
                                        );
                                    }
