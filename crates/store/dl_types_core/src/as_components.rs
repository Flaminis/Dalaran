...
/// ```compile_fail
/// let comp = dl_types_core::components::ClearIsRecursive::default();
/// let _ = (&comp as &dyn dl_types_core::AsComponents).as_serialized_batches();
/// ```
#[expect(dead_code)]
...
/// ```compile_fail
/// let comp = dl_types_core::components::ClearIsRecursive::default();
/// let _ = (&[comp, comp, comp] as &dyn dl_types_core::AsComponents).as_serialized_batches();
/// ```
#[expect(dead_code)]
#[expect(rustdoc::private_doc_tests)] // doc-tests are the only way to assert failed compilation
...
/// let _ = (&comps as &dyn dl_types_core::AsComponents).as_serialized_batches();
/// ```
#[expect(dead_code)]
#[expect(rustdoc::private_doc_tests)] // doc-tests are the only way to assert failed compilation
...
/// let comp = dl_types_core::components::ClearIsRecursive::default();
/// let comps = vec![comp, comp, comp];
/// let _ = (&[comps] as &dyn dl_types_core::ComponentBatch).to_arrow();
/// ```
#[expect(dead_code)]
#[expect(rustdoc::private_doc_tests)] // doc-tests are the only way to assert failed compilation
...
/// let comp = dl_types_core::components::ClearIsRecursive::default();
/// let comps = vec![comp, comp, comp];
/// let _ = (&[comps.clone(), comps.clone(), comps.clone()] as &dyn dl_types_core::AsComponents).as_serialized_batches();
/// ```
#[expect(dead_code)]
#[expect(rustdoc::private_doc_tests)] // doc-tests are the only way to assert failed compilation
...
/// let comp = dl_types_core::components::ClearIsRecursive::default();
/// let comps = vec![comp, comp, comp];
/// let _ = (&[comps.clone(), comps.clone(), comps.clone()] as &dyn dl_types_core::ComponentBatch).to_arrow();
/// ```
#[expect(dead_code)]
#[expect(rustdoc::private_doc_tests)] // doc-tests are the only way to assert failed compilation
