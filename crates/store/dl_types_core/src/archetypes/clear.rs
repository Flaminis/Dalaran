    ...
    pub fn descriptor_is_recursive() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.archetypes.Clear".into()),
                component: "Clear:is_recursive".into(),
                component_type: Some("dalaran.components.ClearIsRecursive".into()),
            });
        (*DESCRIPTOR).clone()
    }
}
...
impl crate::Archetype for Clear {
    ...
    fn name() -> crate::ArchetypeName {
        crate::external::dl_string_interner::intern_static_nonempty!(
            crate::ArchetypeName,
            "dalaran.archetypes.Clear"
        )
    }
