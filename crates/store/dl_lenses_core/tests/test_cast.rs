...
use dl_lenses_core::{CastTo, ChunkExt as _, Lens, LensRuntimeError, Runtime, Selector};
use dl_log_types::Timeline;
use dl_sdk_types::ComponentDescriptor;
use dl_sdk_types::archetypes::{Points3D, Scalars};
...
fn output_column(chunks: &[Chunk], component: dl_chunk::ComponentIdentifier) -> ListArray {
    chunks
        .iter()
