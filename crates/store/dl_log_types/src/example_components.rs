...
impl MyPoints {
    pub fn new(points: impl IntoIterator<Item = impl Into<MyPoint>>) -> Self {
        Self {
            points: dl_types_core::try_serialize_field(Self::descriptor_points(), points),
            ..Self::default()
        }
    }
    ...
    pub fn with_labels(mut self, labels: impl IntoIterator<Item = impl Into<MyLabel>>) -> Self {
        self.labels = dl_types_core::try_serialize_field(Self::descriptor_labels(), labels);
        self
    }

    #[inline]
    pub fn with_colors(mut self, colors: impl IntoIterator<Item = impl Into<MyColor>>) -> Self {
        self.colors = dl_types_core::try_serialize_field(Self::descriptor_colors(), colors);
        self
    }
}

impl dl_types_core::Archetype for MyPoints {
    ...
    fn required_components() -> ::std::borrow::Cow<'static, [dl_types_core::ComponentDescriptor]> {
        vec![Self::descriptor_points()].into()
    }

    fn recommended_components() -> std::borrow::Cow<'static, [dl_types_core::ComponentDescriptor]> {
        vec![Self::descriptor_colors(), Self::descriptor_labels()].into()
    }
}

impl ::dl_types_core::AsComponents for MyPoints {
    #[inline]
...
dl_types_core::macros::impl_into_cow!(MyPoint);
...
impl Loggable for MyPoint {
    ...
    ) -> dl_types_core::SerializationResult<arrow::array::ArrayRef>
    where
        Self: 'a,
    {
        use arrow::datatypes::DataType::Float32;
    ...
    ) -> dl_types_core::DeserializationResult<Vec<Option<Self>>> {
        let array = data
...
dl_types_core::macros::impl_into_cow!(MyPoint64);
...
dl_types_core::macros::impl_into_cow!(MyColor);
...
impl Loggable for MyColor {
    ...
    where
        Self: 'a,
    {
        use dl_types_core::datatypes::UInt32;
        UInt32::to_arrow_opt(
            data.into_iter()
...
#[derive(
    Debug, Clone, PartialEq, Eq, dl_byte_size::SizeBytes, serde::Deserialize, serde::Serialize,
)]
pub struct MyLabel(pub String);

dl_types_core::macros::impl_into_cow!(MyLabel);

impl Loggable for MyLabel {
    fn arrow_datatype() -> arrow::datatypes::DataType {
        dl_types_core::datatypes::Utf8::arrow_datatype()
    }
    ...
    where
        Self: 'a,
    {
        use dl_types_core::datatypes::Utf8;
        Utf8::to_arrow_opt(
            data.into_iter()
...
dl_types_core::macros::impl_into_cow!(MyIndex);
...
impl Loggable for MyIndex {
    ...
    where
        Self: 'a,
    {
        use dl_types_core::datatypes::UInt64;
        UInt64::to_arrow_opt(
            data.into_iter()
...
impl Component for MyIndex {
    fn name() -> dl_types_core::ComponentType {
