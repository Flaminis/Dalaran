...
pub use dl_types_core::{InvalidTimelineNameError, TimelineName};
...
pub mod external {
    pub use {arrow, dl_tuid, dl_types_core};
}
...
#[derive(Clone, Debug, PartialEq, Eq, dl_byte_size::SizeBytes)] // `PartialEq` used for tests in another crate
