...
use crate::external::dl_types_core;
...
impl std::str::FromStr for Timestamp {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let s = &dl_format::remove_number_formatting(s);
    ...
    pub fn format_opt(
        ...
        match timestamp_format.kind() {
            TimestampFormatKind::SecondsSinceUnixEpoch => {
                format!(
                    "{}{}",
                    dl_format::format_int(timestamp.as_second()),
    ...
    pub fn format_time_compact(self, timestamp_format: TimestampFormat) -> String {
        match timestamp_format.kind() {
            TimestampFormatKind::SecondsSinceUnixEpoch => {
                ...
                if is_whole_second {
                    dl_format::format_int(ns / 1_000_000_000)
                } else {
