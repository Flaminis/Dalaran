...
impl std::fmt::Debug for TimeInt {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self.0 {
            ...
            Some(t) => f.write_fmt(format_args!("TimeInt({})", dl_format::format_int(t.get()))),
...
impl TimeInt {
    ...
    pub fn closest_multiple_of(&self, snap_interval: i64) -> Self {
        dl_log::debug_assert!(1 <= snap_interval);
        match self.0 {
            Some(t) => {
                let v = t.get();
                let snapped =
...
impl From<TimeInt> for dl_types_core::datatypes::TimeInt {
    #[inline]
...
impl From<dl_types_core::datatypes::TimeInt> for TimeInt {
    #[inline]
    fn from(time: dl_types_core::datatypes::TimeInt) -> Self {
