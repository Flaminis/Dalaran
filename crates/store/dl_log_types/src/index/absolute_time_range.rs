...
///
/// Can be resolved from [`dl_types_core::datatypes::TimeRange`] (which *may* have relative bounds) using a given timeline & cursor.
///
...
impl AbsoluteTimeRange {
    ...
    pub fn from_relative_time_range(
        range: &dl_types_core::datatypes::TimeRange,
        cursor: impl Into<dl_types_core::datatypes::TimeInt>,
    ) -> Self {
