use dl_log_types::{ComponentPath, EntryId};
...
pub enum Error {
    ...
    #[error(transparent)]
    StoreLoadError(#[from] dl_entity_db::StoreLoadError),

    #[error("Invalid entry name: {0}")]
    InvalidEntryName(#[from] dl_protos::InvalidEntryNameError),
