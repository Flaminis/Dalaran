...
impl DalaranCloudHandlerBuilder {
    ...
    pub fn with_eager_chunk_store_config(
        mut self,
        config: dl_chunk_store::ChunkStoreConfig,
    ) -> Self {
...
impl DalaranCloudService for DalaranCloudHandler {
    ...
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::VersionResponse>> {
        let dl_protos::cloud::v1alpha1::VersionRequest {} = request.into_inner();

        // NOTE: Reminder that this is only fully filled iff CI=1.
        let build_info = dl_build_info::build_info!();

        Ok(tonic::Response::new(
            dl_protos::cloud::v1alpha1::VersionResponse {
                build_info: Some(build_info.into()),
                version: dl_build_info::exposed_version!().to_owned(),
                cloud_provider: None,
                cloud_region: None,
                features: dl_protos::cloud::v1alpha1::features::all_supported_features(),
            },
        ))
    }
    ...
    async fn who_am_i(
        &self,
        _request: tonic::Request<dl_protos::cloud::v1alpha1::WhoAmIRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::WhoAmIResponse>> {
        // The local server has no authentication, so grant full access.
        Ok(tonic::Response::new(
            dl_protos::cloud::v1alpha1::WhoAmIResponse {
                user_id: None,
                can_read: true,
                can_write: true,
            },
    ...
    async fn do_bandwidth_test(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::DoBandwidthTestRequest>,
    ) -> tonic::Result<tonic::Response<Self::DoBandwidthTestStream>> {
        let dl_protos::cloud::v1alpha1::DoBandwidthTestRequest { num_bytes } = request.into_inner();
    ...
    async fn watch_events(
        &self,
        request: Request<dl_protos::cloud::v1alpha1::WatchEventsRequest>,
    ...
    async fn find_entries(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::FindEntriesRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::FindEntriesResponse>> {
        ...
        let response = dl_protos::cloud::v1alpha1::FindEntriesResponse { entries };
    ...
    async fn create_dataset_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::CreateDatasetEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::CreateDatasetEntryResponse>>
    {
    ...
    async fn read_dataset_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::ReadDatasetEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::ReadDatasetEntryResponse>> {
        let store = self.store.read().await;
    ...
    async fn update_dataset_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::UpdateDatasetEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::UpdateDatasetEntryResponse>>
    {
    ...
    async fn read_table_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::ReadTableEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::ReadTableEntryResponse>> {
        let store = self.store.read().await;
    ...
    async fn update_table_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::UpdateTableEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::UpdateTableEntryResponse>> {
    ...
    async fn delete_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::DeleteEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::DeleteEntryResponse>> {
    ...
    async fn update_entry(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::UpdateEntryRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::UpdateEntryResponse>> {
    ...
    async fn register_with_dataset(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::RegisterWithDatasetRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::RegisterWithDatasetResponse>>
    {
        let mut store = self.store.write().await;
        ...
        Ok(tonic::Response::new(
            dl_protos::cloud::v1alpha1::RegisterWithDatasetResponse {
    ...
    async fn unregister_from_dataset(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::UnregisterFromDatasetRequest>,
        ...
        let stream = futures::stream::once(async move {
            Ok(dl_protos::cloud::v1alpha1::UnregisterFromDatasetResponse {
    ...
    async fn write_chunks(
        &self,
        request: tonic::Request<tonic::Streaming<dl_protos::cloud::v1alpha1::WriteChunksRequest>>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::WriteChunksResponse>> {
        let entry_id = get_entry_id_from_headers(&*self.store.read().await, &request)?;
        #[expect(deprecated)]
        let application_id = dl_log_types::ApplicationId::from_entry_id(entry_id);
        ...
        Ok(tonic::Response::new(
            dl_protos::cloud::v1alpha1::WriteChunksResponse {},
        ))
    }

    async fn write_table(
        &self,
        request: tonic::Request<tonic::Streaming<dl_protos::cloud::v1alpha1::WriteTableRequest>>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::WriteTableResponse>> {
        ...
        Ok(tonic::Response::new(
            dl_protos::cloud::v1alpha1::WriteTableResponse {},
        ))
    }
    ...
    async fn get_segment_table_schema(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::GetSegmentTableSchemaRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::GetSegmentTableSchemaResponse>>
    {
        let store = self.store.read().await;
    ...
    async fn scan_segment_table(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::ScanSegmentTableRequest>,
    ...
    async fn get_dataset_schema(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::GetDatasetSchemaRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::GetDatasetSchemaResponse>> {
        let store = self.store.read().await;
        let entry_id = get_entry_id_from_headers(&store, &request)?;
    ...
    async fn get_dlr_manifest(
        ...
        let segment_id = request
            ...
            .ok_or_else(|| {
                missing_field!(
                    dl_protos::cloud::v1alpha1::GetRrdManifestRequest,
                    "segment_id"
                )
            })?
            .try_into()?;
    ...
    async fn get_assets_for_segment(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::GetAssetsForSegmentRequest>,
        ...
        let response = futures::stream::once(futures::future::ok(
            dl_protos::cloud::v1alpha1::GetAssetsForSegmentResponse {
    ...
    async fn query_dataset(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::QueryDatasetRequest>,
        ...
        if scan_parameters.is_some() {
            ...
            dl_log::debug_once!("   scan_parameters are not yet implemented and will be ignored");
        }
        ...
        let per_segment_index_values: Option<BTreeMap<SegmentId, Vec<dl_log_types::TimeInt>>> =
                    ...
                    std::iter::zip(&segment_ids, &la.per_segment_values)
                        .map(|(sid, values)| {
                            (
                                ...
                                values
                                    .iter()
                                    .map(|v| dl_log_types::TimeInt::new_temporal(*v))
                                    .collect(),
                            )
                        })
                        .collect(),
                ...
                let metadata_vec: Vec<ChunkMetadata> = if let Some(query) = &query {
                    ...
                    let (chunks, missing_virtual) = if let Some(map) = &per_segment_index_values {
                        if let Some(values) = map.get(&segment_id) {
                            let synthesized: Vec<dl_log_types::TimeInt> = if values.is_empty() {
                                vec![dl_log_types::TimeInt::STATIC]
                            } else {
                                values.clone()
                            };
    ...
    async fn fetch_chunks(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::FetchChunksRequest>,
        ...
        let stream = futures::stream::iter(chunks).map(|(store_id, chunk)| {
            let arrow_msg = dl_log_types::ArrowMsg {
                chunk_id: *chunk.id(),
    ...
    async fn get_table_schema(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::GetTableSchemaRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::GetTableSchemaResponse>> {
        let store = self.store.read().await;
        ...
        Ok(tonic::Response::new(
            dl_protos::cloud::v1alpha1::GetTableSchemaResponse {
    ...
    async fn scan_table(
        &self,
        request: tonic::Request<dl_protos::cloud::v1alpha1::ScanTableRequest>,
    ...
    async fn do_maintenance(
        &self,
        _request: tonic::Request<dl_protos::cloud::v1alpha1::DoMaintenanceRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::DoMaintenanceResponse>> {
    ...
    async fn do_global_maintenance(
        &self,
        _request: tonic::Request<dl_protos::cloud::v1alpha1::DoGlobalMaintenanceRequest>,
    ) -> tonic::Result<tonic::Response<dl_protos::cloud::v1alpha1::DoGlobalMaintenanceResponse>>
    {
        Err(tonic::Status::unimplemented(
    ...
    async fn create_table_entry(
        &self,
        request: Request<dl_protos::cloud::v1alpha1::CreateTableEntryRequest>,
    ) -> tonic::Result<Response<dl_protos::cloud::v1alpha1::CreateTableEntryResponse>> {
...
impl ChunkMetadata {
    fn from_chunk(chunk: &Chunk) -> Self {
        ...
        Self {
            ...
            byte_size: dl_byte_size::SizeBytes::total_size_bytes(chunk),
            timelines,
        }
    }

    fn from_manifest(
        manifest: &dl_log_encoding::RrdManifest,
        chunk_id: ChunkId,
        row_idx: usize,
...
fn get_chunks_for_query_results(
    ...
    // entity filter. This is exercised by the shared `dl_redap_tests::query_dataset` "default" test
    // case.
