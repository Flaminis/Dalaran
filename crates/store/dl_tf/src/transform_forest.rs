...
impl dl_byte_size::MemUsageTreeCapture for TreeTransform {
...
impl dl_byte_size::MemUsageTreeCapture for TransformForest {
    fn capture_mem_usage_tree(&self) -> dl_byte_size::MemUsageTree {
        dl_tracing::profile_function!();
...
mod tests {
    ...
    -> Result<(), Box<dyn std::error::Error>> {
        ...
        assert_eq!(received_log.level, dl_log::Level::WARN);
        assert!(
            received_log
                .message
