...
use dl_entity_db::external::dl_query::StorageEngineReadGuard;
use dl_log_types::EntityPath;
use dl_sdk_types::archetypes::{self, InstancePoses3D};
use dl_sdk_types::external::arrow::array::Array as _;
use dl_sdk_types::{
...
mod tests {
    ...
    -> Result<(), Box<dyn std::error::Error>> {
        let mut entity_db = EntityDb::new(dl_log_types::StoreInfo::testing().store_id);
