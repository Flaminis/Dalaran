...
use dl_log_types::external::dl_types_core::ComponentDescriptor;
use dl_log_types::{RecordingId, TableId};
...
impl TryFrom<&crate::common::v1alpha1::Schema> for ArrowSchema {
    ...
    fn try_from(value: &crate::common::v1alpha1::Schema) -> Result<Self, Self::Error> {
        ...
        Ok(Self::clone(
            dl_sorbet::migrated_schema_from_ipc(schema_bytes)?.as_ref(),
        ))
    }
}
...
impl TryFrom<&ArrowSchema> for crate::common::v1alpha1::Schema {
    ...
    fn try_from(value: &ArrowSchema) -> Result<Self, Self::Error> {
        Ok(Self {
            arrow_schema: Some(dl_sorbet::ipc_from_schema(value)?.into()),
        })
    }
}
...
impl From<dl_log_types::EntryId> for crate::common::v1alpha1::EntryId {
    #[inline]
    fn from(value: dl_log_types::EntryId) -> Self {
        Self {
...
impl TryFrom<crate::common::v1alpha1::EntryId> for dl_log_types::EntryId {
...
impl From<dl_tuid::Tuid> for crate::common::v1alpha1::EntryId {
    fn from(id: dl_tuid::Tuid) -> Self {
        let id: dl_log_types::EntryId = id.into();
        Self {
            id: Some(id.id.into()),
        }
    }
...
impl TryFrom<crate::common::v1alpha1::Tuid> for crate::common::v1alpha1::EntryId {
    ...
    fn try_from(id: crate::common::v1alpha1::Tuid) -> Result<Self, Self::Error> {
        let id: dl_tuid::Tuid = id.try_into()?;
        Ok(Self {
            id: Some(id.into()),
        })
    }
...
pub use dl_types_core::SegmentId;
...
impl DatasetKind {
    ...
    pub fn store_kind(self) -> dl_log_types::StoreKind {
        match self {
            Self::Recording | Self::Asset => dl_log_types::StoreKind::Recording,
            Self::Blueprint => dl_log_types::StoreKind::Blueprint,
        }
    }
...
pub struct DatasetHandle {
    pub id: Option<dl_log_types::EntryId>,
...
impl DatasetHandle {
    ...
    pub fn with_id(mut self, id: dl_log_types::EntryId) -> Self {
        self.id = Some(id);
        self
    }
}
...
impl crate::common::v1alpha1::TaskId {
    pub fn new() -> Self {
        Self::from_hashable(dl_tuid::Tuid::new())
    }
...
impl TryFrom<crate::common::v1alpha1::Tuid> for dl_tuid::Tuid {
    type Error = TypeConversionError;
...
impl From<dl_tuid::Tuid> for crate::common::v1alpha1::Tuid {
    fn from(value: dl_tuid::Tuid) -> Self {
        Self {
...
impl From<dl_log_types::EntityPath> for crate::common::v1alpha1::EntityPath {
    fn from(value: dl_log_types::EntityPath) -> Self {
        Self {
...
impl TryFrom<crate::common::v1alpha1::EntityPath> for dl_log_types::EntityPath {
    type Error = TypeConversionError;
...
impl From<dl_log_types::AbsoluteTimeRange> for crate::common::v1alpha1::TimeRange {
    fn from(value: dl_log_types::AbsoluteTimeRange) -> Self {
        Self {
...
impl From<crate::common::v1alpha1::TimeRange> for dl_log_types::AbsoluteTimeRange {
    fn from(value: crate::common::v1alpha1::TimeRange) -> Self {
        Self::new(
            dl_log_types::TimeInt::new_temporal(value.start),
            dl_log_types::TimeInt::new_temporal(value.end),
        )
    }
}

impl From<dl_log_types::AbsoluteTimeRange> for crate::common::v1alpha1::IndexRange {
    fn from(value: dl_log_types::AbsoluteTimeRange) -> Self {
        Self {
...
impl TryFrom<crate::common::v1alpha1::IndexRange> for dl_log_types::AbsoluteTimeRange {
    type Error = TypeConversionError;
...
impl TryFrom<crate::common::v1alpha1::Timeline> for dl_log_types::TimelineName {
    type Error = TypeConversionError;
...
impl From<dl_log_types::TimelineName> for crate::common::v1alpha1::Timeline {
    fn from(value: dl_log_types::TimelineName) -> Self {
        Self {
...
impl From<dl_log_types::Timeline> for crate::common::v1alpha1::Timeline {
    fn from(value: dl_log_types::Timeline) -> Self {
        Self {
...
impl From<dl_log_types::TimeType> for crate::common::v1alpha1::TimeType {
    fn from(value: dl_log_types::TimeType) -> Self {
        match value {
            dl_log_types::TimeType::Sequence => Self::Sequence,
            dl_log_types::TimeType::DurationNs => Self::DurationNs,
            dl_log_types::TimeType::TimestampNs => Self::TimestampNs,
        }
    }
}

impl std::fmt::Display for crate::common::v1alpha1::TimeType {
    /// Short, human-readable name, matching `dl_log_types::TimeType`'s `Display`
...
impl TryFrom<crate::common::v1alpha1::IndexColumnSelector> for dl_log_types::TimelineName {
    type Error = TypeConversionError;
...
impl From<dl_log_types::TimelineName> for crate::common::v1alpha1::IndexColumnSelector {
    fn from(value: dl_log_types::TimelineName) -> Self {
        Self {
...
impl TryFrom<crate::common::v1alpha1::ApplicationId> for dl_log_types::ApplicationId {
    type Error = dl_log_types::InvalidApplicationIdError;
...
impl From<dl_log_types::ApplicationId> for crate::common::v1alpha1::ApplicationId {
    #[inline]
    fn from(value: dl_log_types::ApplicationId) -> Self {
        Self {
            id: value.to_string(),
        }
    }
...
impl From<crate::common::v1alpha1::StoreKind> for dl_log_types::StoreKind {
    #[inline]
...
impl From<dl_log_types::StoreKind> for crate::common::v1alpha1::StoreKind {
    #[inline]
    fn from(value: dl_log_types::StoreKind) -> Self {
        match value {
            dl_log_types::StoreKind::Recording => Self::Recording,
            dl_log_types::StoreKind::Blueprint => Self::Blueprint,
        }
    }
}
...
pub struct StoreIdMissingApplicationIdError {
    pub store_kind: dl_log_types::StoreKind,
    pub recording_id: RecordingId,
}

impl StoreIdMissingApplicationIdError {
    /// Recover the store ID by providing the application ID.
    pub fn recover(self, application_id: dl_log_types::ApplicationId) -> dl_log_types::StoreId {
        dl_log_types::StoreId::new(self.store_kind, application_id, self.recording_id)
    }
...
pub enum StoreIdFromProtoError {
    ...
    InvalidApplicationId(dl_log_types::InvalidApplicationIdError),
}
...
/// Convert a store id
impl TryFrom<crate::common::v1alpha1::StoreId> for dl_log_types::StoreId {
    ...
    fn try_from(value: crate::common::v1alpha1::StoreId) -> Result<Self, Self::Error> {
        ...
        match value.application_id {
            ...
            Some(application_id) => {
                let application_id = dl_log_types::ApplicationId::try_new(application_id.id)
                    .map_err(StoreIdFromProtoError::InvalidApplicationId)?;
                Ok(dl_log_types::StoreId::new(
                    store_kind,
                    application_id,
                    recording_id,
                ))
...
impl From<dl_log_types::StoreId> for crate::common::v1alpha1::StoreId {
    #[inline]
    fn from(value: dl_log_types::StoreId) -> Self {
...
impl From<dl_log_types::TableId> for crate::common::v1alpha1::TableId {
    #[inline]
    fn from(value: dl_log_types::TableId) -> Self {
        Self {
...
impl From<crate::common::v1alpha1::TableId> for dl_log_types::TableId {
    #[inline]
...
impl TryFrom<crate::common::v1alpha1::ComponentDescriptor> for ComponentDescriptor {
    ...
    fn try_from(value: crate::common::v1alpha1::ComponentDescriptor) -> Result<Self, Self::Error> {
        ...
        Ok(ComponentDescriptor {
            archetype: archetype.and_then(|s| dl_types_core::ArchetypeName::try_new(s).ok()),
            component: dl_types_core::ComponentIdentifier::try_new(component).map_err(|err| {
                invalid_field!(
                    crate::common::v1alpha1::ComponentDescriptor,
                    "component",
                    err
            ...
            component_type: component_type
                .and_then(|s| dl_types_core::ComponentType::try_new(s).ok()),
        })
    }
}
...
impl From<dl_build_info::BuildInfo> for crate::common::v1alpha1::BuildInfo {
    fn from(build_info: dl_build_info::BuildInfo) -> Self {
        Self {
...
impl From<crate::common::v1alpha1::BuildInfo> for dl_build_info::BuildInfo {
...
impl From<dl_build_info::CrateVersion> for crate::common::v1alpha1::SemanticVersion {
    fn from(version: dl_build_info::CrateVersion) -> Self {
...
impl From<crate::common::v1alpha1::SemanticVersion> for dl_build_info::CrateVersion {
...
impl From<dl_build_info::Meta> for crate::common::v1alpha1::semantic_version::Meta {
    fn from(version_meta: dl_build_info::Meta) -> Self {
        match version_meta {
            dl_build_info::Meta::Rc(v) => Self::Rc(v.into()),

            dl_build_info::Meta::Alpha(v) => Self::Alpha(v.into()),

            dl_build_info::Meta::DevAlpha { alpha, commit } => {
...
impl From<crate::common::v1alpha1::semantic_version::Meta> for dl_build_info::Meta {
...
mod tests {
    ...
    fn entity_path_conversion() {
        let entity_path = dl_log_types::EntityPath::parse_strict("a/b/c").unwrap();
        let proto_entity_path: crate::common::v1alpha1::EntityPath = entity_path.clone().into();
        let entity_path2: dl_log_types::EntityPath = proto_entity_path.try_into().unwrap();
        assert_eq!(entity_path, entity_path2);
    }

    #[test]
    fn time_range_conversion() {
        let time_range = dl_log_types::AbsoluteTimeRange::new(
            dl_log_types::TimeInt::new_temporal(123456789),
            dl_log_types::TimeInt::new_temporal(987654321),
        );
        let proto_time_range: crate::common::v1alpha1::TimeRange = time_range.into();
        let time_range2: dl_log_types::AbsoluteTimeRange = proto_time_range.into();
    ...
    fn index_range_conversion() {
        ...
        let time_range2: dl_log_types::AbsoluteTimeRange = proto_index_range.try_into().unwrap();
        assert_eq!(time_range, time_range2);
    }
