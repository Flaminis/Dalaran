...
pub mod viewer_control_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// One `egui_inspection` request/response exchange, used by `dl_viewer_mcp` to control the viewer ui.
        ...
        /// Returns info about what the viewer is currently showing, so the agent can orient itself via `dl_viewer_mcp`
