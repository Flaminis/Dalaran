...
impl From<dl_log_types::StoreSource> for crate::log_msg::v1alpha1::StoreSource {
    #[inline]
    fn from(value: dl_log_types::StoreSource) -> Self {
        use crate::external::prost::Message as _;

        let (kind, payload) = match value {
            dl_log_types::StoreSource::Unknown => (
                crate::log_msg::v1alpha1::StoreSourceKind::Unspecified as i32,
                Bytes::new(),
            ),
            dl_log_types::StoreSource::CSdk => (
                crate::log_msg::v1alpha1::StoreSourceKind::CSdk as i32,
                Bytes::new(),
            ),
            dl_log_types::StoreSource::PythonSdk(python_version) => (
...
impl TryFrom<crate::log_msg::v1alpha1::StoreSource> for dl_log_types::StoreSource {
    ...
    fn try_from(value: crate::log_msg::v1alpha1::StoreSource) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            StoreSourceKind::PythonSdk => {
                ...
                Ok(Self::PythonSdk(dl_log_types::PythonVersion::try_from(
                    python_version,
                )?))
            }
            ...
            StoreSourceKind::File => {
                ...
                Ok(Self::File {
                    file_source: dl_log_types::FileSource::try_from(file_source)?,
                })
            }
...
impl From<dl_log_types::PythonVersion> for crate::log_msg::v1alpha1::PythonVersion {
    #[inline]
    fn from(value: dl_log_types::PythonVersion) -> Self {
        Self {
...
impl TryFrom<crate::log_msg::v1alpha1::PythonVersion> for dl_log_types::PythonVersion {
    type Error = TypeConversionError;
...
impl From<dl_log_types::FileSource> for crate::log_msg::v1alpha1::FileSource {
    #[inline]
    fn from(value: dl_log_types::FileSource) -> Self {
        let kind = match value {
            dl_log_types::FileSource::Cli => crate::log_msg::v1alpha1::FileSourceKind::Cli as i32,
            dl_log_types::FileSource::Uri => crate::log_msg::v1alpha1::FileSourceKind::Uri as i32,
            dl_log_types::FileSource::DragAndDrop { .. } => {
                crate::log_msg::v1alpha1::FileSourceKind::DragAndDrop as i32
            }
            dl_log_types::FileSource::FileDialog { .. } => {
                crate::log_msg::v1alpha1::FileSourceKind::FileDialog as i32
            }
            dl_log_types::FileSource::Sdk => crate::log_msg::v1alpha1::FileSourceKind::Sdk as i32,
        };
...
impl TryFrom<crate::log_msg::v1alpha1::FileSource> for dl_log_types::FileSource {
    type Error = TypeConversionError;
...
impl From<dl_log_types::StoreInfo> for crate::log_msg::v1alpha1::StoreInfo {
    #[inline]
    fn from(value: dl_log_types::StoreInfo) -> Self {
        #[expect(deprecated)]
        Self {
            application_id: None,
...
impl TryFrom<crate::log_msg::v1alpha1::StoreInfo> for dl_log_types::StoreInfo {
    type Error = TypeConversionError;
    ...
    fn try_from(value: crate::log_msg::v1alpha1::StoreInfo) -> Result<Self, Self::Error> {
        ...
        let store_id: dl_log_types::StoreId = match value
            .store_id
            .ok_or(missing_field!(
            ...
            .try_into()
        {
            ...
            Err(StoreIdFromProtoError::MissingApplicationId(err)) => match legacy_application_id {
                Some(app_id) => err.recover(dl_log_types::ApplicationId::try_from(app_id)?),
                None => {
        ...
        let store_source: dl_log_types::StoreSource = value
            .store_source
            .ok_or(missing_field!(
                crate::log_msg::v1alpha1::StoreInfo,
                "store_source",
        ...
        let store_version = value
            .store_version
            .map(|v| dl_build_info::CrateVersion::from_bytes(v.crate_version_bits.to_le_bytes()));
...
impl From<dl_log_types::SetStoreInfo> for crate::log_msg::v1alpha1::SetStoreInfo {
    #[inline]
    fn from(value: dl_log_types::SetStoreInfo) -> Self {
        Self {
...
impl TryFrom<crate::log_msg::v1alpha1::SetStoreInfo> for dl_log_types::SetStoreInfo {
    type Error = TypeConversionError;
...
impl From<dl_log_types::BlueprintActivationCommand>
    for crate::log_msg::v1alpha1::BlueprintActivationCommand
{
    #[inline]
    fn from(value: dl_log_types::BlueprintActivationCommand) -> Self {
        Self {
...
// dl_log_types::BlueprintActivationCommand is not tricky because of the `ApplicationId` in
...
mod tests {
    ...
    fn store_source_conversion() {
        let store_source = dl_log_types::StoreSource::PythonSdk(dl_log_types::PythonVersion {
            major: 3,
            minor: 8,
            patch: 0,
            suffix: "a".to_owned(),
        ...
        let store_source2: dl_log_types::StoreSource = proto_store_source.try_into().unwrap();
        assert_eq!(store_source, store_source2);
    }

    #[test]
    fn file_source_conversion() {
        let file_source = dl_log_types::FileSource::Uri;
        let proto_file_source: crate::log_msg::v1alpha1::FileSource = file_source.clone().into();
        let file_source2: dl_log_types::FileSource = proto_file_source.try_into().unwrap();
        assert_eq!(file_source, file_source2);
    }

    #[test]
    fn store_info_conversion() {
        let store_info = dl_log_types::StoreInfo::new_unversioned(
            dl_log_types::StoreId::new(
                dl_log_types::StoreKind::Recording,
                "test_app_id",
                "test_recording_id",
            ),
            dl_log_types::StoreSource::PythonSdk(dl_log_types::PythonVersion {
                major: 3,
                minor: 8,
                patch: 0,
                suffix: "a".to_owned(),
        ...
        let store_info2: dl_log_types::StoreInfo = proto_store_info.try_into().unwrap();
        assert_eq!(store_info, store_info2);
    }

    #[test]
    fn set_store_info_conversion() {
        let set_store_info = dl_log_types::SetStoreInfo {
            row_id: dl_tuid::Tuid::new(),
            info: dl_log_types::StoreInfo::new_unversioned(
                dl_log_types::StoreId::new(
                    dl_log_types::StoreKind::Recording,
                    "test_app_id",
                    "test_recording_id",
        ...
        let set_store_info2: dl_log_types::SetStoreInfo = proto_set_store_info.try_into().unwrap();
