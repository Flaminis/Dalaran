...
pub struct LatestAllResults {
    ...
    ///
    /// Until these chunks have been fetched and inserted into the appropriate [`dl_chunk_store::ChunkStore`], the
    /// results of this query cannot accurately be computed.
    ///
    /// Note, these are NOT necessarily _root_ chunks.
    /// Use [`dl_chunk_store::ChunkStore::find_root_chunks`] to get those.
    //
...
impl LatestAllComponentResults {
    ...
    pub fn iter_component_batches<C: dl_types_core::Component>(
        &self,
