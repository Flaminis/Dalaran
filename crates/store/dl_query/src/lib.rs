...
//! Caching datastructures for `dl_query`.
...
pub struct ComponentNotFoundError(pub dl_types_core::ComponentType);
...
pub enum QueryError {
    ...
    TypeMismatch {
        actual: dl_types_core::ComponentType,
        requested: dl_types_core::ComponentType,
    },

    #[error("Error deserializing: {0}")]
    DeserializationError(#[from] dl_types_core::DeserializationError),

    #[error("Error serializing: {0}")]
    SerializationError(#[from] dl_types_core::SerializationError),
