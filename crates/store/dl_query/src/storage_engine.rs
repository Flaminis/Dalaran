...
impl StorageEngineReadGuard<'_> {
    ...
    #[inline]
    pub fn schema(&self) -> &dl_chunk_store::StoreSchema {
        self.store.schema()
    }
...
impl dl_byte_size::SizeBytes for StorageEngineReadGuard<'_> {
...
impl dl_byte_size::MemUsageTreeCapture for StorageEngineReadGuard<'_> {
