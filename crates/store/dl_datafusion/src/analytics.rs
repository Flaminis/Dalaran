...
struct Inner {
    ...
    /// [`dl_redap_client::ConnectionClient`] (same HTTP/2 transport, same auth /
...
pub enum TableQueryCaller {
    ...
    /// Viewer table-detail UI in `dl_redap_browser`.
    BrowserDetailView,
}
...
mod table_query_tests {
    ...
    use dl_protos::cloud::v1alpha1::ext::{LanceTable, ProviderDetails, SystemTable};
    ...
    fn lance_provider_details() -> ProviderDetails {
        ...
        let proto = dl_protos::cloud::v1alpha1::LanceTable {
