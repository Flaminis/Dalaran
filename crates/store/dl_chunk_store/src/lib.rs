...
pub use {
    ...
    dl_log_types::{AbsoluteTimeRange, TimeInt, TimeType, Timeline},
    dl_sorbet::{ColumnDescriptor, ComponentColumnDescriptor, IndexColumnDescriptor},
};
...
pub enum ChunkStoreError {
    ...
    #[error(transparent)]
    Provider(#[from] dl_log_encoding::ChunkProviderError),
