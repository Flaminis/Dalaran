...
use dl_log_encoding::{ChunkProvider, RawRrdManifest, RrdManifest};
use dl_log_types::{AbsoluteTimeRange, EntityPath, StoreId, TimelineName};
...
mod tests {
    ...
    fn build_test_lazy_store(
        ...
        let provider = Arc::new(
            dl_log_encoding::RrdChunkProvider::from_reader(
                file,
