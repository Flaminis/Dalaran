...
use dl_chunk::Chunk;
use dl_types_core::{ArchetypeName, ComponentIdentifier};
...
mod tests {
    ...
    use dl_chunk::RowId;
    use dl_log_types::{EntityPath, Timeline, example_components::MyPoint};
        ...
        let chunk = Chunk::builder(entity_path.clone())
            .with_component_batches(
                ...
                [
                    (
                        points_descriptor,
                        points as &dyn dl_types_core::ComponentBatch,
                    ),
                    (
                        blob_descriptor,
        ...
        let chunk = Chunk::builder(entity_path)
            .with_component_batches(
                ...
                [
                    ...
                    (
                        medium_descriptor,
                        &[medium] as &dyn dl_types_core::ComponentBatch,
                    ),
                    (
                        heavy_descriptor,
                        &[heavy] as &dyn dl_types_core::ComponentBatch,
                    ),
                ],
            )
            .build()
            ...
            .with_component_batches(
                ...
                [
                    (
                        ...
                        p1 as &dyn dl_types_core::ComponentBatch,
                    ),
                    (
                        ComponentDescriptor {
                            archetype: Some(ArchetypeName::from("my.Points")),
                        ...
                        p2 as &dyn dl_types_core::ComponentBatch,
                    ),
                ],
            )
            .build()
