...
use dl_chunk::{TimeInt, TimePoint};
use dl_chunk_store::{Chunk, ChunkStore, ChunkStoreConfig, GarbageCollectionOptions};
...
fn setup_store() -> ChunkStore {
    let store_id = StoreId::random(dl_log_types::StoreKind::Recording, "benchmarks");
