...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/image_format.fbs".
...
#[derive(Clone, Debug, Default, Copy, PartialEq, Eq, Hash, ::dl_byte_size::SizeBytes)]
...
::dl_types_core::macros::impl_into_cow!(ImageFormat);

impl ::dl_types_core::Loggable for ImageFormat {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.ImageFormat")?;
            if arrow_data.is_empty() {
                ...
                let width = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.ImageFormat#width")?
                        .into_iter()
                };
                let height = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.ImageFormat#height")?
                        .into_iter()
                };
                let pixel_format = {
                    ...
                    crate::datatypes::PixelFormat::from_arrow_opt(arrow_data)
                        .with_context("dalaran.datatypes.ImageFormat#pixel_format")?
                        .into_iter()
                };
                let color_model = {
                    ...
                    crate::datatypes::ColorModel::from_arrow_opt(arrow_data)
                        .with_context("dalaran.datatypes.ImageFormat#color_model")?
                        .into_iter()
                };
                let channel_datatype = {
                    ...
                    crate::datatypes::ChannelDatatype::from_arrow_opt(arrow_data)
                        .with_context("dalaran.datatypes.ImageFormat#channel_datatype")?
                        .into_iter()
                };
