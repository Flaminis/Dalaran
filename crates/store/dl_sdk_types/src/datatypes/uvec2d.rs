...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/uvec2d.fbs".
...
::dl_types_core::macros::impl_into_cow!(UVec2D);

impl ::dl_types_core::Loggable for UVec2D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.UVec2D#xy")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.UVec2D#xy")
        .with_context("dalaran.datatypes.UVec2D")?)
    }
