...
::dl_types_core::macros::impl_into_cow!(ChannelCountPair);

impl ::dl_types_core::Loggable for ChannelCountPair {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.ChannelCountPair")?;
            if arrow_data.is_empty() {
                ...
                let channel_id = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.ChannelCountPair#channel_id")?
                        .into_iter()
                ...
                let message_count = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.ChannelCountPair#message_count")?
                        .into_iter()
                    ...
                    opt.map(|(channel_id, message_count)| {
                        Ok(Self {
                            channel_id: channel_id
                                ...
                                .with_context(
                                "dalaran.datatypes.ChannelCountPair#channel_id",
                            )?,
