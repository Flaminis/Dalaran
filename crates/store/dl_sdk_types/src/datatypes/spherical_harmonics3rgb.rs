...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/spherical_harmonics3rgb.fbs".
...
#[derive(
    Clone, Debug, Copy, PartialEq, bytemuck::Pod, bytemuck::Zeroable, ::dl_byte_size::SizeBytes,
)]
#[repr(transparent)]
...
::dl_types_core::macros::impl_into_cow!(SphericalHarmonics3Rgb);

impl ::dl_types_core::Loggable for SphericalHarmonics3Rgb {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            ...
            if arrow_data.is_empty() {
                ...
                ZipValidity::new_with_validity(offsets, arrow_data.nulls())
                    .map(|elem| {
                        elem.map(|(start, end): (usize, usize)| {
                            dl_log::debug_assert!(end - start == 15usize);
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.SphericalHarmonics3Rgb#coefficients")
        .with_context("dalaran.datatypes.SphericalHarmonics3Rgb")?)
    }
