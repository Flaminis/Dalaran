...
#[derive(
    Clone, Debug, Default, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, ::dl_byte_size::SizeBytes,
)]
#[repr(transparent)]
pub struct Uuid {
...
::dl_types_core::macros::impl_into_cow!(Uuid);

impl ::dl_types_core::Loggable for Uuid {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Uuid#bytes")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Uuid#bytes")
        .with_context("dalaran.datatypes.Uuid")?)
    }
