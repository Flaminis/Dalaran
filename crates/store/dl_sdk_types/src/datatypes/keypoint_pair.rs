...
::dl_types_core::macros::impl_into_cow!(KeypointPair);

impl ::dl_types_core::Loggable for KeypointPair {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.KeypointPair")?;
            if arrow_data.is_empty() {
                ...
                let keypoint0 = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.KeypointPair#keypoint0")?
                        .into_iter()
                ...
                let keypoint1 = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.KeypointPair#keypoint1")?
                        .into_iter()
                        .map(|res_or_opt| res_or_opt.map(crate::datatypes::KeypointId))
                };
