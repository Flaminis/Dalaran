...
::dl_types_core::macros::impl_into_cow!(TensorBuffer);

impl ::dl_types_core::Loggable for TensorBuffer {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.TensorBuffer")?;
                ...
                let u8 = {
                    let arrow_data = arrow_data.child(1).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#U8")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let u16 = {
                    let arrow_data = arrow_data.child(2).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#U16")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let u32 = {
                    let arrow_data = arrow_data.child(3).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#U32")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let u64 = {
                    let arrow_data = arrow_data.child(4).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#U64")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let i8 = {
                    let arrow_data = arrow_data.child(5).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#I8")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let i16 = {
                    let arrow_data = arrow_data.child(6).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#I16")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let i32 = {
                    let arrow_data = arrow_data.child(7).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#I32")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let i64 = {
                    let arrow_data = arrow_data.child(8).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#I64")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let f16 = {
                    let arrow_data = arrow_data.child(9).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#F16")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let f32 = {
                    let arrow_data = arrow_data.child(10).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#F32")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                ...
                let f64 = {
                    let arrow_data = arrow_data.child(11).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorBuffer#F64")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
