...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/vec4d.fbs".
...
::dl_types_core::macros::impl_into_cow!(Vec4D);

impl ::dl_types_core::Loggable for Vec4D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Vec4D#xyzw")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Vec4D#xyzw")
        .with_context("dalaran.datatypes.Vec4D")?)
    }
