...
///
/// If an entity is annotated with a corresponding [`components::ClassId`][crate::components::ClassId], Dalaran will use
...
::dl_types_core::macros::impl_into_cow!(ClassDescription);

impl ::dl_types_core::Loggable for ClassDescription {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.ClassDescription")?;
            if arrow_data.is_empty() {
                ...
                let info = {
                    ...
                    crate::datatypes::AnnotationInfo::from_arrow_opt(arrow_data)
                        .with_context("dalaran.datatypes.ClassDescription#info")?
                        .into_iter()
                };
                let keypoint_annotations = {
                    ...
                    let arrow_data = &**arrays_by_name["keypoint_annotations"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.datatypes.ClassDescription#keypoint_annotations",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let keypoint_connections = {
                    ...
                    let arrow_data = &**arrays_by_name["keypoint_connections"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.datatypes.ClassDescription#keypoint_connections",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
