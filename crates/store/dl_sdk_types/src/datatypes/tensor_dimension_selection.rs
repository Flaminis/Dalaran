...
::dl_types_core::macros::impl_into_cow!(TensorDimensionSelection);

impl ::dl_types_core::Loggable for TensorDimensionSelection {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.TensorDimensionSelection")?;
            if arrow_data.is_empty() {
                ...
                let dimension = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.TensorDimensionSelection#dimension")?
                        .into_iter()
                };
                let invert = {
