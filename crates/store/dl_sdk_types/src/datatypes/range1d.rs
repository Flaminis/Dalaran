...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/range1d.fbs".
...
::dl_types_core::macros::impl_into_cow!(Range1D);

impl ::dl_types_core::Loggable for Range1D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Range1D#range")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Range1D#range")
        .with_context("dalaran.datatypes.Range1D")?)
    }
