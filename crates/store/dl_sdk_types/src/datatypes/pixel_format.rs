...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/pixel_format.fbs".
...
::dl_types_core::macros::impl_into_cow!(PixelFormat);

impl ::dl_types_core::Loggable for PixelFormat {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("dalaran.datatypes.PixelFormat#enum")?
            .into_iter()
            .map(|typ| match typ {
            ...
            .with_context("dalaran.datatypes.PixelFormat")?)
    }
}
...
impl ::dl_types_core::reflection::Enum for PixelFormat {
    type Repr = u8;
