...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/rotation_axis_angle.fbs".
...
#[derive(Clone, Debug, Copy, PartialEq, ::dl_byte_size::SizeBytes)]
...
::dl_types_core::macros::impl_into_cow!(RotationAxisAngle);

impl ::dl_types_core::Loggable for RotationAxisAngle {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.RotationAxisAngle")?;
            if arrow_data.is_empty() {
                ...
                let axis = {
                    ...
                    let arrow_data = &**arrays_by_name["axis"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.RotationAxisAngle#axis")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let angle = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.datatypes.RotationAxisAngle#angle")?
                        .into_iter()
                        .map(|res_or_opt| {
