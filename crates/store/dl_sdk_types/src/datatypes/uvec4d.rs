...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/uvec4d.fbs".
...
::dl_types_core::macros::impl_into_cow!(UVec4D);

impl ::dl_types_core::Loggable for UVec4D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.UVec4D#xyzw")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.UVec4D#xyzw")
        .with_context("dalaran.datatypes.UVec4D")?)
    }
