...
::dl_types_core::macros::impl_into_cow!(IVec3D);

impl ::dl_types_core::Loggable for IVec3D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.IVec3D#xyz")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.IVec3D#xyz")
        .with_context("dalaran.datatypes.IVec3D")?)
    }
