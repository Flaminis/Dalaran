...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/mat4x4.fbs".
...
/// ```
#[derive(Clone, Debug, Copy, PartialEq, PartialOrd, ::dl_byte_size::SizeBytes)]
pub struct Mat4x4(
    /// Flat list of matrix coefficients in column-major order.
    pub [f32; 16usize],
);

::dl_types_core::macros::impl_into_cow!(Mat4x4);

impl ::dl_types_core::Loggable for Mat4x4 {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Mat4x4#flat_columns")?;
                ...
                ZipValidity::new_with_validity(offsets, arrow_data.nulls())
                    .map(|elem| {
                        elem.map(|(start, end): (usize, usize)| {
                            dl_log::debug_assert!(end - start == 16usize);
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Mat4x4#flat_columns")
        .with_context("dalaran.datatypes.Mat4x4")?)
    }
