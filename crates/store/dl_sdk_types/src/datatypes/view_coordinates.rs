...
::dl_types_core::macros::impl_into_cow!(ViewCoordinates);

impl ::dl_types_core::Loggable for ViewCoordinates {
    #[inline]
                    ...
                    .flat_map(|v| match v {
                        ...
                        None => {
                            itertools::Either::Right(
                                std::iter::repeat_n(
                                    <crate::datatypes::ViewDir as ::dl_types_core::reflection::Enum>::variants()[0],
                                    3usize,
                                ),
                            )
                        }
        ...
        Ok(
            {
                let arrow_data = arrow_data
                    ...
                    .with_context("dalaran.datatypes.ViewCoordinates#coordinates")?;
                ...
                .collect::<DeserializationResult<Vec<Option<_>>>>()
                .with_context("dalaran.datatypes.ViewCoordinates#coordinates")
                .with_context("dalaran.datatypes.ViewCoordinates")?,
        )
    }
}
