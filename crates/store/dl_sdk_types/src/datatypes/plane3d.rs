...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/plane3d.fbs".
...
::dl_types_core::macros::impl_into_cow!(Plane3D);

impl ::dl_types_core::Loggable for Plane3D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Plane3D#xyzd")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Plane3D#xyzd")
        .with_context("dalaran.datatypes.Plane3D")?)
    }
