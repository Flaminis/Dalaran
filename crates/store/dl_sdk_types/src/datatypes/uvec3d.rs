...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/uvec3d.fbs".
...
::dl_types_core::macros::impl_into_cow!(UVec3D);

impl ::dl_types_core::Loggable for UVec3D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.UVec3D#xyz")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.UVec3D#xyz")
        .with_context("dalaran.datatypes.UVec3D")?)
    }
