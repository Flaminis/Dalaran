...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/mat3x3.fbs".
...
::dl_types_core::macros::impl_into_cow!(Mat3x3);

impl ::dl_types_core::Loggable for Mat3x3 {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Mat3x3#flat_columns")?;
                ...
                ZipValidity::new_with_validity(offsets, arrow_data.nulls())
                    .map(|elem| {
                        elem.map(|(start, end): (usize, usize)| {
                            dl_log::debug_assert!(end - start == 9usize);
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Mat3x3#flat_columns")
        .with_context("dalaran.datatypes.Mat3x3")?)
    }
