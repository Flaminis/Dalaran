...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/quaternion.fbs".
...
::dl_types_core::macros::impl_into_cow!(Quaternion);

impl ::dl_types_core::Loggable for Quaternion {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Quaternion#xyzw")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Quaternion#xyzw")
        .with_context("dalaran.datatypes.Quaternion")?)
    }
