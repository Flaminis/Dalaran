...
::dl_types_core::macros::impl_into_cow!(Utf8Pair);

impl ::dl_types_core::Loggable for Utf8Pair {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Utf8Pair")?;
                ...
                let first = {
                    ...
                    let arrow_data = &**arrays_by_name["first"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.Utf8Pair#first")?;
                ...
                let second = {
                    ...
                    let arrow_data = &**arrays_by_name["second"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.Utf8Pair#second")?;
                        let arrow_data_buf = arrow_data.values();
                        let offsets = arrow_data.offsets();
                        ZipValidity::new_with_validity(offsets.windows(2), arrow_data.nulls())
                            .map(|elem| {
