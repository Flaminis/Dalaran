...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/vec3d.fbs".
...
::dl_types_core::macros::impl_into_cow!(Vec3D);

impl ::dl_types_core::Loggable for Vec3D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Vec3D#xyz")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Vec3D#xyz")
        .with_context("dalaran.datatypes.Vec3D")?)
    }
