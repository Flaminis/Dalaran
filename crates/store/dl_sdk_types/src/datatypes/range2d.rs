...
::dl_types_core::macros::impl_into_cow!(Range2D);

impl ::dl_types_core::Loggable for Range2D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Range2D")?;
                ...
                let x_range = {
                    ...
                    let arrow_data = &**arrays_by_name["x_range"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.Range2D#x_range")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let y_range = {
                    ...
                    let arrow_data = &**arrays_by_name["y_range"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.Range2D#y_range")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let offsets = ::std::iter::zip(
