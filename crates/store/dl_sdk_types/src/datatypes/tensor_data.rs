...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/datatypes/tensor_data.fbs".
...
pub struct TensorData {
    ...
    pub names: Option<Vec<::dl_types_core::ArrowString>>,

    /// The content/data.
    pub buffer: crate::datatypes::TensorBuffer,
}

::dl_types_core::macros::impl_into_cow!(TensorData);

impl ::dl_types_core::Loggable for TensorData {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.TensorData")?;
            if arrow_data.is_empty() {
                ...
                let shape = {
                    ...
                    let arrow_data = &**arrays_by_name["shape"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorData#shape")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let names = {
                    ...
                    let arrow_data = &**arrays_by_name["names"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.datatypes.TensorData#names")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                                let arrow_data_inner = &**arrow_data.values();
                                {
                                    ...
                                    .map(|res_or_opt| {
                                        res_or_opt.map(|res_or_opt| {
                                            res_or_opt
                                                .map(|v| ::dl_types_core::ArrowString::from(v))
                                        })
                                    })
                                    .collect::<DeserializationResult<Vec<Option<_>>>>()
                                    .with_context("dalaran.datatypes.TensorData#names")?
                ...
                let buffer = {
                    ...
                    crate::datatypes::TensorBuffer::from_arrow_opt(arrow_data)
                        .with_context("dalaran.datatypes.TensorData#buffer")?
                        .into_iter()
                };
                ZipValidity::new_with_validity(
