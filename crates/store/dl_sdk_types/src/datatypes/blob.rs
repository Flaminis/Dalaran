...
::dl_types_core::macros::impl_into_cow!(Blob);

impl ::dl_types_core::Loggable for Blob {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.Blob#data")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.datatypes.Blob#data")
        .with_context("dalaran.datatypes.Blob")?)
    }
}
