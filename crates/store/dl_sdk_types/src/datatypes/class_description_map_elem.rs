...
::dl_types_core::macros::impl_into_cow!(ClassDescriptionMapElem);

impl ::dl_types_core::Loggable for ClassDescriptionMapElem {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.datatypes.ClassDescriptionMapElem")?;
