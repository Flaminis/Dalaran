...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/tensor_slice_selection.fbs".
    ...
    pub fn descriptor_width() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.TensorSliceSelection".into()),
                component: "TensorSliceSelection:width".into(),
                component_type: Some("dalaran.components.TensorWidthDimension".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_height() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.TensorHeightDimension".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_indices() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.TensorDimensionIndexSelection".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_slider() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some(
                    "dalaran.blueprint.components.TensorDimensionIndexSlider".into(),
                ),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for TensorSliceSelection {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.TensorSliceSelection"
        )
    }
...
impl ::dl_types_core::AsComponents for TensorSliceSelection {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for TensorSliceSelection {}
