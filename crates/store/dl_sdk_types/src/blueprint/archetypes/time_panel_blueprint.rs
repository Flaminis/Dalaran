    ...
    pub fn descriptor_state() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.TimePanelBlueprint".into()),
                component: "TimePanelBlueprint:state".into(),
                component_type: Some("dalaran.blueprint.components.PanelState".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_timeline() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.TimelineName".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_playback_speed() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.PlaybackSpeed".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_fps() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.Fps".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_play_state() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.PlayState".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_loop_mode() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.LoopMode".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_time_selection() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.AbsoluteTimeRange".into()),
            });
        (*DESCRIPTOR).clone()
    }
}
...
impl ::dl_types_core::Archetype for TimePanelBlueprint {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.TimePanelBlueprint"
        )
    }
...
impl ::dl_types_core::AsComponents for TimePanelBlueprint {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for TimePanelBlueprint {}
