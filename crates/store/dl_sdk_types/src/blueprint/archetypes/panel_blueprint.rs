    ...
    pub fn descriptor_state() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.PanelBlueprint".into()),
...
impl ::dl_types_core::Archetype for PanelBlueprint {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.PanelBlueprint"
        )
    }
...
impl ::dl_types_core::AsComponents for PanelBlueprint {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for PanelBlueprint {}
