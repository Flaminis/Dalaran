...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/time_axis.fbs".
    ...
    pub fn descriptor_link() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.TimeAxis".into()),
                component: "TimeAxis:link".into(),
                component_type: Some("dalaran.blueprint.components.LinkAxis".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_view_range() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.TimeRange".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_zoom_lock() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.LockRangeDuringZoom".into()),
            });
        (*DESCRIPTOR).clone()
    }
}
...
impl ::dl_types_core::Archetype for TimeAxis {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.TimeAxis"
        )
    }
...
impl ::dl_types_core::AsComponents for TimeAxis {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for TimeAxis {}
