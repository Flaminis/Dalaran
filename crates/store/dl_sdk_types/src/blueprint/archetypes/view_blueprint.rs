...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/view_blueprint.fbs".
    ...
    pub fn descriptor_class_identifier() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.ViewBlueprint".into()),
                component: "ViewBlueprint:class_identifier".into(),
                component_type: Some("dalaran.blueprint.components.ViewClass".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_space_origin() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.ViewOrigin".into()),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for ViewBlueprint {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.ViewBlueprint"
        )
    }
...
impl ::dl_types_core::AsComponents for ViewBlueprint {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for ViewBlueprint {}
