...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/scalar_axis.fbs".
    ...
    pub fn descriptor_range() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.ScalarAxis".into()),
                component: "ScalarAxis:range".into(),
                component_type: Some("dalaran.components.Range1D".into()),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for ScalarAxis {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.ScalarAxis"
        )
    }
...
impl ::dl_types_core::AsComponents for ScalarAxis {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for ScalarAxis {}
