...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/container_blueprint.fbs".
    ...
    pub fn descriptor_container_kind() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.ContainerBlueprint".into()),
                component: "ContainerBlueprint:container_kind".into(),
                component_type: Some("dalaran.blueprint.components.ContainerKind".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_contents() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.IncludedContent".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_col_shares() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.ColumnShare".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_row_shares() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.RowShare".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_active_tab() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.ActiveTab".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_grid_columns() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.GridColumns".into()),
            });
        (*DESCRIPTOR).clone()
    }
}
...
impl ::dl_types_core::Archetype for ContainerBlueprint {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.ContainerBlueprint"
        )
    }
...
impl ::dl_types_core::AsComponents for ContainerBlueprint {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for ContainerBlueprint {}
