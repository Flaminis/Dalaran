...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/plot_legend.fbs".
    ...
    pub fn descriptor_corner() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.PlotLegend".into()),
                component: "PlotLegend:corner".into(),
                component_type: Some("dalaran.blueprint.components.Corner2D".into()),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for PlotLegend {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.PlotLegend"
        )
    }
...
impl ::dl_types_core::AsComponents for PlotLegend {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for PlotLegend {}
