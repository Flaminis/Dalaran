...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/viewport_blueprint.fbs".
    ...
    pub fn descriptor_root_container() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.RootContainer".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_maximized() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.ViewMaximized".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_auto_layout() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.AutoLayout".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_auto_views() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.blueprint.components.AutoViews".into()),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for ViewportBlueprint {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.ViewportBlueprint"
        )
    }
...
impl ::dl_types_core::AsComponents for ViewportBlueprint {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for ViewportBlueprint {}
