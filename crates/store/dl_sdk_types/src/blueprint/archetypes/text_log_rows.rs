...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/archetypes/text_log_rows.fbs".
    ...
    pub fn descriptor_filter_by_log_level() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.blueprint.archetypes.TextLogRows".into()),
...
impl ::dl_types_core::Archetype for TextLogRows {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.blueprint.archetypes.TextLogRows"
        )
    }
...
impl ::dl_types_core::AsComponents for TextLogRows {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for TextLogRows {}
