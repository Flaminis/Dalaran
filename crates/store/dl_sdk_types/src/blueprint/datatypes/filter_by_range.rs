...
::dl_types_core::macros::impl_into_cow!(FilterByRange);

impl ::dl_types_core::Loggable for FilterByRange {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.blueprint.datatypes.FilterByRange")?;
            if arrow_data.is_empty() {
                ...
                let start = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.blueprint.datatypes.FilterByRange#start")?
                        .into_iter()
                        ...
                        opt.map(|(start, end)| {
                            Ok(Self {
                                start: start
                                    ...
                                    .with_context(
                                        "dalaran.blueprint.datatypes.FilterByRange#start",
                                    )?,
                                end: end
                                    .ok_or_else(DeserializationError::missing_data)
                                    .with_context("dalaran.blueprint.datatypes.FilterByRange#end")?,
