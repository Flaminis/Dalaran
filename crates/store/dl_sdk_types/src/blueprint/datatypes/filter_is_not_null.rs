...
::dl_types_core::macros::impl_into_cow!(FilterIsNotNull);

impl ::dl_types_core::Loggable for FilterIsNotNull {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.blueprint.datatypes.FilterIsNotNull")?;
