...
::dl_types_core::macros::impl_into_cow!(SelectedColumns);

impl ::dl_types_core::Loggable for SelectedColumns {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.blueprint.datatypes.SelectedColumns")?;
                ...
                let time_columns = {
                    ...
                    let arrow_data = &**arrays_by_name["time_columns"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.blueprint.datatypes.SelectedColumns#time_columns",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let component_columns = {
                    ...
                    let arrow_data = &**arrays_by_name["component_columns"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.blueprint.datatypes.SelectedColumns#component_columns",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
