...
#[derive(Clone, Debug, PartialEq, Eq, Hash, ::dl_byte_size::SizeBytes)]
...
::dl_types_core::macros::impl_into_cow!(TimelineColumn);

impl ::dl_types_core::Loggable for TimelineColumn {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.blueprint.datatypes.TimelineColumn")?;
                ...
                let timeline = {
                    ...
                    let arrow_data = &**arrays_by_name["timeline"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.blueprint.datatypes.TimelineColumn#timeline")?;
                    ...
                    opt.map(|(visible, timeline)| {
                        Ok(Self {
                            ...
                            timeline: timeline
                                .ok_or_else(DeserializationError::missing_data)
                                .with_context(
                                    "dalaran.blueprint.datatypes.TimelineColumn#timeline",
                                )?,
                        })
                    })
                    .transpose()
