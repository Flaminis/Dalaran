...
#[derive(Clone, Debug, Default, PartialEq, Eq, Hash, ::dl_byte_size::SizeBytes)]
...
::dl_types_core::macros::impl_into_cow!(ComponentColumnSelector);

impl ::dl_types_core::Loggable for ComponentColumnSelector {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.blueprint.datatypes.ComponentColumnSelector")?;
                ...
                let entity_path = {
                    ...
                    let arrow_data = &**arrays_by_name["entity_path"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.blueprint.datatypes.ComponentColumnSelector#entity_path",
                            )?;
                                ...
                                res_or_opt.map(|res_or_opt| {
                                    res_or_opt.map(|v| {
                                        crate::datatypes::EntityPath(
                                            ::dl_types_core::ArrowString::from(v),
                                        )
                                    })
                                })
                            })
                ...
                let component = {
                    ...
                    let arrow_data = &**arrays_by_name["component"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.blueprint.datatypes.ComponentColumnSelector#component",
                            )?;
                        let arrow_data_buf = arrow_data.values();
                        let offsets = arrow_data.offsets();
                        ZipValidity::new_with_validity(offsets.windows(2), arrow_data.nulls())
