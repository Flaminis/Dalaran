...
impl ::dl_types_core::Component for ColumnOrder {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.blueprint.components.ColumnOrder".into()
    }
}

::dl_types_core::macros::impl_into_cow!(ColumnOrder);

impl ::dl_types_core::Loggable for ColumnOrder {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.blueprint.components.ColumnOrder#entity_paths")
        .with_context("dalaran.blueprint.components.ColumnOrder")?)
    }
}
