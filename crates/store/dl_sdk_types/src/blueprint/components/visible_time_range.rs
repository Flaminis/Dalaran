...
impl ::dl_types_core::WrapperComponent for VisibleTimeRange {
    type Datatype = crate::datatypes::VisibleTimeRange;

    #[inline]
    fn name() -> ComponentType {
        "dalaran.blueprint.components.VisibleTimeRange".into()
    }
...
::dl_types_core::macros::impl_into_cow!(VisibleTimeRange);
