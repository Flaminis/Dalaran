...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/blueprint/components/map_provider.fbs".
...
impl ::dl_types_core::Component for MapProvider {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.blueprint.components.MapProvider".into()
    }
}

::dl_types_core::macros::impl_into_cow!(MapProvider);

impl ::dl_types_core::Loggable for MapProvider {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("dalaran.blueprint.components.MapProvider#enum")?
            .into_iter()
            .map(|typ| match typ {
            ...
            .with_context("dalaran.blueprint.components.MapProvider")?)
    }
}
...
impl ::dl_types_core::reflection::Enum for MapProvider {
    type Repr = u8;
