...
impl ::dl_types_core::WrapperComponent for IncludedContent {
    type Datatype = crate::datatypes::EntityPath;

    #[inline]
    fn name() -> ComponentType {
        "dalaran.blueprint.components.IncludedContent".into()
    }
...
::dl_types_core::macros::impl_into_cow!(IncludedContent);
