...
impl TensorElement {
    ...
    /// Format the value with `dl_format`
    pub fn format(&self) -> String {
        match self {
            Self::U8(val) => dl_format::format_uint(*val),
            Self::U16(val) => dl_format::format_uint(*val),
            Self::U32(val) => dl_format::format_uint(*val),
            Self::U64(val) => dl_format::format_uint(*val),
            Self::I8(val) => dl_format::format_int(*val),
            Self::I16(val) => dl_format::format_int(*val),
            Self::I32(val) => dl_format::format_int(*val),
            Self::I64(val) => dl_format::format_int(*val),
            Self::F16(val) => dl_format::format_f16(*val),
            Self::F32(val) => dl_format::format_f32(*val),
            Self::F64(val) => dl_format::format_f64(*val),
        }
    }
