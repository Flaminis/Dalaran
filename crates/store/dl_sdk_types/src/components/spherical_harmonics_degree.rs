...
impl ::dl_types_core::WrapperComponent for SphericalHarmonicsDegree {
    type Datatype = crate::datatypes::UInt32;

    #[inline]
    fn name() -> ComponentType {
        "dalaran.components.SphericalHarmonicsDegree".into()
    }
...
::dl_types_core::macros::impl_into_cow!(SphericalHarmonicsDegree);
