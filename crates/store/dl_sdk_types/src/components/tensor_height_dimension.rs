...
impl ::dl_types_core::WrapperComponent for TensorHeightDimension {
    type Datatype = crate::datatypes::TensorDimensionSelection;

    #[inline]
    fn name() -> ComponentType {
        "dalaran.components.TensorHeightDimension".into()
    }
...
::dl_types_core::macros::impl_into_cow!(TensorHeightDimension);
