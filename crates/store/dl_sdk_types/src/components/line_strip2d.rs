...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/line_strip2d.fbs".
...
impl ::dl_types_core::Component for LineStrip2D {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.components.LineStrip2D".into()
    }
}

::dl_types_core::macros::impl_into_cow!(LineStrip2D);

impl ::dl_types_core::Loggable for LineStrip2D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.components.LineStrip2D#points")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.components.LineStrip2D#points")
        .with_context("dalaran.components.LineStrip2D")?)
    }
}
