...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/annotation_context.fbs".
...
impl ::dl_types_core::Component for AnnotationContext {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.components.AnnotationContext".into()
    }
}

::dl_types_core::macros::impl_into_cow!(AnnotationContext);

impl ::dl_types_core::Loggable for AnnotationContext {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.components.AnnotationContext#class_map")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.components.AnnotationContext#class_map")
        .with_context("dalaran.components.AnnotationContext")?)
    }
}
