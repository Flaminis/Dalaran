...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/colormap.fbs".
...
impl ::dl_types_core::Component for Colormap {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.components.Colormap".into()
    }
}

::dl_types_core::macros::impl_into_cow!(Colormap);

impl ::dl_types_core::Loggable for Colormap {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("dalaran.components.Colormap#enum")?
            .into_iter()
            .map(|typ| match typ {
            ...
            .with_context("dalaran.components.Colormap")?)
    }
}
...
impl ::dl_types_core::reflection::Enum for Colormap {
    type Repr = u8;
