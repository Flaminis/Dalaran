...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/components/line_strip3d.fbs".
...
impl ::dl_types_core::Component for LineStrip3D {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.components.LineStrip3D".into()
    }
}

::dl_types_core::macros::impl_into_cow!(LineStrip3D);

impl ::dl_types_core::Loggable for LineStrip3D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.components.LineStrip3D#points")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.components.LineStrip3D#points")
        .with_context("dalaran.components.LineStrip3D")?)
    }
}
