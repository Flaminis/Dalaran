...
// Based on "crates/store/dl_sdk_types/definitions/dalaran/archetypes/mcap_message.fbs".
    ...
    pub fn descriptor_data() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.archetypes.McapMessage".into()),
...
impl ::dl_types_core::Archetype for McapMessage {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.archetypes.McapMessage"
        )
    }
...
impl ::dl_types_core::AsComponents for McapMessage {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for McapMessage {}
