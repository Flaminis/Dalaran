    ...
    pub fn descriptor_point_shading() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.PointShading".into()),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for Points3D {
    #[inline]
...
impl ::dl_types_core::AsComponents for Points3D {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for Points3D {}
