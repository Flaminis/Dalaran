...
///
/// Dalaran also supports uncompressed images with the [`archetypes::Image`][crate::archetypes::Image].
    ...
    pub fn descriptor_blob() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.archetypes.EncodedImage".into()),
...
impl ::dl_types_core::Archetype for EncodedImage {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.archetypes.EncodedImage"
        )
    }
...
impl ::dl_types_core::AsComponents for EncodedImage {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for EncodedImage {}
