    ...
    pub fn descriptor_data() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.archetypes.Tensor".into()),
...
impl ::dl_types_core::Archetype for Tensor {
    #[inline]
...
impl ::dl_types_core::AsComponents for Tensor {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for Tensor {}
