    ...
    pub fn descriptor_translation() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.archetypes.Transform3D".into()),
                component: "Transform3D:translation".into(),
                component_type: Some("dalaran.components.Translation3D".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_rotation_axis_angle() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.RotationAxisAngle".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_quaternion() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.RotationQuat".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_scale() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.Scale3D".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_mat3x3() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.TransformMat3x3".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_relation() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.TransformRelation".into()),
            });
        (*DESCRIPTOR).clone()
    }
    ...
    pub fn descriptor_child_frame() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                ...
                component_type: Some("dalaran.components.TransformFrameId".into()),
            });
        (*DESCRIPTOR).clone()
    }
...
impl ::dl_types_core::Archetype for Transform3D {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.archetypes.Transform3D"
        )
    }
...
impl ::dl_types_core::AsComponents for Transform3D {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for Transform3D {}
