...
///
/// Dalaran also supports compressed images (JPEG, PNG, …), using [`archetypes::EncodedImage`][crate::archetypes::EncodedImage].
    ...
    pub fn descriptor_buffer() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.archetypes.Image".into()),
...
impl ::dl_types_core::Archetype for Image {
    #[inline]
...
impl ::dl_types_core::AsComponents for Image {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for Image {}
