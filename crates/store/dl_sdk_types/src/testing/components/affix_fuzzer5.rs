...
impl ::dl_types_core::Component for AffixFuzzer5 {
    #[inline]
    fn name() -> ComponentType {
        "dalaran.testing.components.AffixFuzzer5".into()
    }
}

::dl_types_core::macros::impl_into_cow!(AffixFuzzer5);

impl ::dl_types_core::Loggable for AffixFuzzer5 {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok(
            crate::testing::datatypes::MixedFields::from_arrow_opt(arrow_data)
                .with_context("dalaran.testing.components.AffixFuzzer5#single_optional")?
                .into_iter()
                .map(Ok)
                .map(|res| res.map(|v| Some(Self(v))))
                .collect::<DeserializationResult<Vec<Option<_>>>>()
                .with_context("dalaran.testing.components.AffixFuzzer5#single_optional")
                .with_context("dalaran.testing.components.AffixFuzzer5")?,
        )
    }
}
