...
::dl_types_core::macros::impl_into_cow!(NestedUnion);

impl ::dl_types_core::Loggable for NestedUnion {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.NestedUnion")?;
            if arrow_data.is_empty() {
                ...
                let single_required = {
                    ...
                    crate::testing::datatypes::ScalarUnion::from_arrow_opt(arrow_data)
                        .with_context("dalaran.testing.datatypes.NestedUnion#single_required")?
                        .into_iter()
                        .collect::<Vec<_>>()
                };
                let many_required = {
                            ...
                            Ok(Some(match typ {
                                1i8 => Self::SingleRequired({
                                    if offset as usize >= single_required.len() {
                                        ...
                                        .with_context(
                                            "dalaran.testing.datatypes.NestedUnion#single_required",
                                        );
                                    }
