...
::dl_types_core::macros::impl_into_cow!(FixedSizeBytes);

impl ::dl_types_core::Loggable for FixedSizeBytes {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.FixedSizeBytes")?;
                ...
                let fixed_sized_native = {
                    ...
                    let arrow_data = &**arrays_by_name["fixed_sized_native"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.FixedSizeBytes#fixed_sized_native",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            ...
                            ZipValidity::new_with_validity(offsets, arrow_data.nulls())
                                .map(|elem| {
                                    elem.map(|(start, end): (usize, usize)| {
                                        dl_log::debug_assert!(end - start == 4usize);
