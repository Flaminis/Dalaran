...
::dl_types_core::macros::impl_into_cow!(PrimitiveAndString);

impl ::dl_types_core::Loggable for PrimitiveAndString {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.PrimitiveAndString")?;
