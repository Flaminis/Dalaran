...
::dl_types_core::macros::impl_into_cow!(ManyVec3);

impl ::dl_types_core::Loggable for ManyVec3 {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.ManyVec3#triples")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("dalaran.testing.datatypes.ManyVec3#triples")
        .with_context("dalaran.testing.datatypes.ManyVec3")?)
    }
