...
::dl_types_core::macros::impl_into_cow!(ScalarUnion);

impl ::dl_types_core::Loggable for ScalarUnion {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.ScalarUnion")?;
            if arrow_data.is_empty() {
                ...
                let degrees = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.testing.datatypes.ScalarUnion#degrees")?
                        .into_iter()
                        .collect::<Vec<_>>()
                };
                let craziness = {
                    let arrow_data = arrow_data.child(2).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("dalaran.testing.datatypes.ScalarUnion#craziness")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let fixed_size_shenanigans = {
                    let arrow_data = arrow_data.child(3).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.ScalarUnion#fixed_size_shenanigans",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                                ...
                                .map(|elem| {
                                    elem
                                        .map(|(start, end): (usize, usize)| {
                                            dl_log::debug_assert!(end - start == 3usize);
                                            if arrow_data_inner.len() < end {
                                                return Err(
                                            ...
                                            Self::Degrees({
                                                if offset as usize >= degrees.len() {
                                                    return Err(
                                                        ...
                                                        .with_context(
                                                            "dalaran.testing.datatypes.ScalarUnion#degrees",
                                                        );
                                                }
                                            ...
                                            Self::Craziness({
                                                if offset as usize >= craziness.len() {
                                                    return Err(
                                                        ...
                                                        .with_context(
                                                            "dalaran.testing.datatypes.ScalarUnion#craziness",
                                                        );
                                                }
