...
::dl_types_core::macros::impl_into_cow!(MultiEnum);

impl ::dl_types_core::Loggable for MultiEnum {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.MultiEnum")?;
            if arrow_data.is_empty() {
                ...
                let value1 = {
                    ...
                    crate::testing::datatypes::EnumTest::from_arrow_opt(arrow_data)
                        .with_context("dalaran.testing.datatypes.MultiEnum#value1")?
                        .into_iter()
                };
                let value2 = {
                    ...
                    crate::testing::datatypes::ValuedEnum::from_arrow_opt(arrow_data)
                        .with_context("dalaran.testing.datatypes.MultiEnum#value2")?
                        .into_iter()
                };
