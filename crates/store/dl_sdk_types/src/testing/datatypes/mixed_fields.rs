...
#[derive(Clone, Debug, Default, PartialEq, ::dl_byte_size::SizeBytes)]
pub struct MixedFields {
    pub single_float_optional: Option<f32>,
    pub single_string_required: ::dl_types_core::ArrowString,
    pub single_string_optional: Option<::dl_types_core::ArrowString>,
    pub many_floats_optional: Option<::arrow::buffer::ScalarBuffer<f32>>,
    pub many_strings_required: Vec<::dl_types_core::ArrowString>,
    pub many_strings_optional: Option<Vec<::dl_types_core::ArrowString>>,
    pub flattened_scalar: f32,
    pub almost_flattened_scalar: crate::testing::datatypes::FlattenedScalar,
    pub from_parent: Option<bool>,
}

::dl_types_core::macros::impl_into_cow!(MixedFields);

impl ::dl_types_core::Loggable for MixedFields {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("dalaran.testing.datatypes.MixedFields")?;
            if arrow_data.is_empty() {
                ...
                let single_string_required = {
                    ...
                    let arrow_data = &**arrays_by_name["single_string_required"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.MixedFields#single_string_required",
                            )?;
                        ...
                        ZipValidity::new_with_validity(offsets.windows(2), arrow_data.nulls())
                            ...
                            .map(|res_or_opt| {
                                res_or_opt.map(|res_or_opt| {
                                    res_or_opt.map(|v| ::dl_types_core::ArrowString::from(v))
                                })
                            })
                ...
                let single_string_optional = {
                    ...
                    let arrow_data = &**arrays_by_name["single_string_optional"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.MixedFields#single_string_optional",
                            )?;
                        let arrow_data_buf = arrow_data.values();
                        let offsets = arrow_data.offsets();
                        ZipValidity::new_with_validity(offsets.windows(2), arrow_data.nulls())
                ...
                let many_floats_optional = {
                    ...
                    let arrow_data = &**arrays_by_name["many_floats_optional"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.MixedFields#many_floats_optional",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let many_strings_required = {
                    ...
                    let arrow_data = &**arrays_by_name["many_strings_required"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.MixedFields#many_strings_required",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let many_strings_optional = {
                    ...
                    let arrow_data = &**arrays_by_name["many_strings_optional"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "dalaran.testing.datatypes.MixedFields#many_strings_optional",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let flattened_scalar = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.testing.datatypes.MixedFields#flattened_scalar")?
                        .into_iter()
                };
                let almost_flattened_scalar = {
                    ...
                    crate::testing::datatypes::FlattenedScalar::from_arrow_opt(arrow_data)
                        .with_context(
                            "dalaran.testing.datatypes.MixedFields#almost_flattened_scalar",
                        )?
                        .into_iter()
                };
                let from_parent = {
                    ...
                    arrow_data
                        ...
                        .with_context("dalaran.testing.datatypes.MixedFields#from_parent")?
                        .into_iter()
                };
                ZipValidity::new_with_validity(
                        ::itertools::izip!(
                        ...
                        opt
                            ...
                            Ok(Self {
                                ...
                                flattened_scalar: flattened_scalar
                                    .ok_or_else(DeserializationError::missing_data)
                                    .with_context(
                                        "dalaran.testing.datatypes.MixedFields#flattened_scalar",
                                    )?,
