    ...
    pub fn descriptor_fuzz2101() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.testing.archetypes.AffixFuzzer4".into()),
...
impl ::dl_types_core::Archetype for AffixFuzzer4 {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.testing.archetypes.AffixFuzzer4"
        )
    }
...
impl ::dl_types_core::AsComponents for AffixFuzzer4 {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for AffixFuzzer4 {}
