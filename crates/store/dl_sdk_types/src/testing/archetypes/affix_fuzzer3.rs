    ...
    pub fn descriptor_fuzz2001() -> ComponentDescriptor {
        static DESCRIPTOR: std::sync::LazyLock<ComponentDescriptor> =
            std::sync::LazyLock::new(|| ComponentDescriptor {
                archetype: Some("dalaran.testing.archetypes.AffixFuzzer3".into()),
...
impl ::dl_types_core::Archetype for AffixFuzzer3 {
    #[inline]
    fn name() -> ::dl_types_core::ArchetypeName {
        ::dl_types_core::external::dl_string_interner::intern_static_nonempty!(
            ...
            "dalaran.testing.archetypes.AffixFuzzer3"
        )
    }
...
impl ::dl_types_core::AsComponents for AffixFuzzer3 {
    #[inline]
...
impl ::dl_types_core::ArchetypeReflectionMarker for AffixFuzzer3 {}
