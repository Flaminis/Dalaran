use dl_sdk_types::archetypes::AnnotationContext;
use dl_sdk_types::datatypes::{ClassDescription, KeypointPair, Rgba32};
use dl_sdk_types::{Archetype as _, AsComponents as _, components};
