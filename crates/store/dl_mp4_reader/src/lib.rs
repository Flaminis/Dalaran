...
//! - [`Mode::Asset`] — emit an [`dl_sdk_types::archetypes::AssetVideo`] blob
//!   chunk plus a [`dl_sdk_types::archetypes::VideoFrameReference`] index chunk.
//! - [`Mode::Stream`] — demux the mp4 with [`dl_video`] and emit a static
//!   [`dl_sdk_types::archetypes::VideoStream`] codec chunk followed by per-GOP
