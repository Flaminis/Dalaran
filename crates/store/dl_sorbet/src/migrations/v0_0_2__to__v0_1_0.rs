...
use dl_log::{ResultExt as _, debug_assert};
        ...
        .map(|field| {
            ...
            if field.name().ends_with("Indicator") {
                ...
                let (archetype, component, component_type) = match (
                    ...
                    (Some(archetype), None) => {
                        dl_log::debug!("Encountered archetype {archetype} without archetype field name, duplicating component {component} to archetype field");
