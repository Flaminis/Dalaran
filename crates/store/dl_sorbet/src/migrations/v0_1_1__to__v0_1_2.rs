...
fn migrate_pose_components(batch: RecordBatch) -> RecordBatch {
    ...
    dl_log::debug_once!("Migrating Pose* components to regular transformation components");
...
fn migrate_transform3d_axis_length(batch: RecordBatch) -> RecordBatch {
    ...
    dl_log::debug_once!("Migrating Transform3D:axis_length to TransformAxes3D:axis_length");
...
fn migrate_coordinate_frame(batch: RecordBatch) -> RecordBatch {
    ...
    dl_log::debug_once!("Migrating CoordinateFrame:frame_id to CoordinateFrame:frame");
