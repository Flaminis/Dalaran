...
use dl_types_core::{ArchetypeName, ComponentType};
...
pub enum ColumnError {
    ...
    #[error(transparent)]
    InvalidComponentIdentifier(#[from] dl_types_core::InvalidComponentIdentifierError),
}
...
#[derive(Debug, Clone, PartialEq, Eq, Hash, PartialOrd, Ord, dl_byte_size::SizeBytes)]
...
fn test_schema_over_ipc() {
    ...
    let original_columns = [
        ColumnDescriptor::Time(IndexColumnDescriptor::from_timeline(
            dl_log_types::Timeline::log_time(),
            true,
        )),
        ColumnDescriptor::Component(ComponentColumnDescriptor {
            entity_path: dl_log_types::EntityPath::from("/some/path"),
            archetype: Some("archetype".into()),
            component: "component".into(),
            component_type: Some(dl_types_core::ComponentType::from("component_type")),
