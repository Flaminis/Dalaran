use dl_log_types::{EntityPath, Timeline, TimelineName};
use dl_types_core::{ComponentDescriptor, ComponentIdentifier};
...
pub struct ComponentColumnSelector {
    ...
    /// The string representation of [`dl_types_core::ComponentIdentifier`] associated with this data.
...
impl ComponentColumnSelector {
    ...
    pub fn component_identifier(
        &self,
    ) -> Result<ComponentIdentifier, dl_types_core::InvalidComponentIdentifierError> {
