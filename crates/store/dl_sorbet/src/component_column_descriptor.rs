...
impl From<ComponentColumnDescriptor> for dl_types_core::ComponentDescriptor {
    #[inline]
...
impl ComponentColumnDescriptor {
    ...
    fn metadata(&self, batch_type: BatchType) -> ArrowFieldMetadata {
        ...
        let mut metadata = std::collections::HashMap::from([
            ...
            (
                dl_types_core::FIELD_METADATA_KEY_COMPONENT.to_owned(),
                component.to_string(),
            ),
        ]);
        ...
        if let Some(archetype_name) = archetype_name {
            metadata.insert(
                dl_types_core::FIELD_METADATA_KEY_ARCHETYPE.to_owned(),
        ...
        if let Some(component_type) = component_type {
            metadata.insert(
                dl_types_core::FIELD_METADATA_KEY_COMPONENT_TYPE.to_owned(),
...
impl ComponentColumnDescriptor {
    ...
    pub fn from_arrow_field(
        ...
        let schema = Self {
            ...
            entity_path,
            archetype: field
                .get_opt(dl_types_core::FIELD_METADATA_KEY_ARCHETYPE)
