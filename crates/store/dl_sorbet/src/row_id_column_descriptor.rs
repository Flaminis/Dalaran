...
use dl_types_core::{Loggable as _, RowId};

use crate::MetadataExt as _;

/// Describes the schema of the primary [`RowId`] column.
#[derive(Clone, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, dl_byte_size::SizeBytes)]
    ...
    pub fn to_arrow_field(&self) -> ArrowField {
        ...
        let mut metadata = std::collections::HashMap::from([
            ...
            (
                ...
                dl_tuid::Tuid::ARROW_EXTENSION_NAME.to_owned(),
            ),
            (
