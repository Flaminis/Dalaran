...
- **Reset to Default Blueprint**: Returns to your programmatically specified blueprint (sent from code via `dl.send_blueprint()`) or a loaded blueprint file (`.dbl`). This becomes the "default" whenever you send or load a blueprint.
