...
The Dalaran datastore continuously compacts data as it comes in, in order find a sweet spot between ingestion speed, query performance and memory overhead.
...
Defaults to `DALARAN_CHUNK_MAX_ROWS=1024`.
