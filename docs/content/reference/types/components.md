...
Components are the fundamental unit of logging in Dalaran. This page lists all built-in components.
...
* [`ImageFormat`](components/image_format.md): The metadata describing the contents of a [`components.ImageBuffer`](https://dalaran.dev/docs/reference/types/components/image_buffer).
...
* [`IsKeyframe`](components/is_keyframe.md): Whether a [`components.VideoSample`](https://dalaran.dev/docs/reference/types/components/video_sample) contains a keyframe (also known as a sync sample or IDR).
...
* [`ShowLabels`](components/show_labels.md): Whether the entity's [`components.Text`](https://dalaran.dev/docs/reference/types/components/text) label is shown.
...
* [`VideoCodec`](components/video_codec.md): The codec used to encode video stored in [`components.VideoSample`](https://dalaran.dev/docs/reference/types/components/video_sample).
* [`VideoSample`](components/video_sample.md): Video sample data (also known as "video chunk").
* [`VideoTimestamp`](components/video_timestamp.md): Timestamp inside a [`archetypes.AssetVideo`](https://dalaran.dev/docs/reference/types/archetypes/asset_video).
