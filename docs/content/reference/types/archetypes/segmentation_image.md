...
An image made up of integer [`components.ClassId`](https://dalaran.dev/docs/reference/types/components/class_id)s.

Each pixel corresponds to a [`components.ClassId`](https://dalaran.dev/docs/reference/types/components/class_id) that will be mapped to a color based on [`archetypes.AnnotationContext`](https://dalaran.dev/docs/reference/types/archetypes/annotation_context).

In the case of floating point images, the label will be looked up based on rounding to the nearest
integer value.

Use [`archetypes.AnnotationContext`](https://dalaran.dev/docs/reference/types/archetypes/annotation_context) to associate each class with a color and a label.
...
## API reference links
 * 🌊 [C++ API docs for `SegmentationImage`](https://ref.dalaran.dev/docs/cpp/stable/structdalaran_1_1archetypes_1_1SegmentationImage.html)
 * 🐍 [Python API docs for `SegmentationImage`](https://ref.dalaran.dev/docs/python/stable/common/archetypes#dalaran.archetypes.SegmentationImage)
 * 🦀 [Rust API docs for `SegmentationImage`](https://docs.rs/dalaran/latest/dalaran/archetypes/struct.SegmentationImage.html)
