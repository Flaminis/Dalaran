...
## API reference links
 * 🌊 [C++ API docs for `Clear`](https://ref.dalaran.dev/docs/cpp/stable/structdalaran_1_1archetypes_1_1Clear.html)
 * 🐍 [Python API docs for `Clear`](https://ref.dalaran.dev/docs/python/stable/common/archetypes#dalaran.archetypes.Clear)
 * 🦀 [Rust API docs for `Clear`](https://docs.rs/dalaran/latest/dalaran/archetypes/struct.Clear.html)
