...
## API reference links
 * 🌊 [C++ API docs for `GaussianSplats3D`](https://ref.dalaran.dev/docs/cpp/stable/structdalaran_1_1archetypes_1_1GaussianSplats3D.html?speculative-link)
 * 🐍 [Python API docs for `GaussianSplats3D`](https://ref.dalaran.dev/docs/python/stable/common/archetypes?speculative-link#dalaran.archetypes.GaussianSplats3D)
 * 🦀 [Rust API docs for `GaussianSplats3D`](https://docs.rs/dalaran/latest/dalaran/archetypes/struct.GaussianSplats3D.html?speculative-link)
