...
## API reference links
 * 🌊 [C++ API docs for `SeriesLines`](https://ref.dalaran.dev/docs/cpp/stable/structdalaran_1_1archetypes_1_1SeriesLines.html)
 * 🐍 [Python API docs for `SeriesLines`](https://ref.dalaran.dev/docs/python/stable/common/archetypes#dalaran.archetypes.SeriesLines)
 * 🦀 [Rust API docs for `SeriesLines`](https://docs.rs/dalaran/latest/dalaran/archetypes/struct.SeriesLines.html)
