...
## API reference links
 * 🌊 [C++ API docs for `LineStrips3D`](https://ref.dalaran.dev/docs/cpp/stable/structdalaran_1_1archetypes_1_1LineStrips3D.html)
 * 🐍 [Python API docs for `LineStrips3D`](https://ref.dalaran.dev/docs/python/stable/common/archetypes#dalaran.archetypes.LineStrips3D)
 * 🦀 [Rust API docs for `LineStrips3D`](https://docs.rs/dalaran/latest/dalaran/archetypes/struct.LineStrips3D.html)
