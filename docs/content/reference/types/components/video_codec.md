...
The codec used to encode video stored in [`components.VideoSample`](https://dalaran.dev/docs/reference/types/components/video_sample).
...
## API reference links
 * 🌊 [C++ API docs for `VideoCodec`](https://ref.dalaran.dev/docs/cpp/stable/namespacedalaran_1_1components.html)
 * 🐍 [Python API docs for `VideoCodec`](https://ref.dalaran.dev/docs/python/stable/common/components#dalaran.components.VideoCodec)
 * 🦀 [Rust API docs for `VideoCodec`](https://docs.rs/dalaran/latest/dalaran/components/enum.VideoCodec.html)
