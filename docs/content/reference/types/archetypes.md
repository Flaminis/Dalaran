...
Archetypes are bundles of components for which the Dalaran viewer has first-class
...
* [`SegmentationImage`](archetypes/segmentation_image.md): An image made up of integer [`components.ClassId`](https://dalaran.dev/docs/reference/types/components/class_id)s.
...
* [`TransformAxes3D`](archetypes/transform_axes3d.md): A visual representation of a [`archetypes.Transform3D`](https://dalaran.dev/docs/reference/types/archetypes/transform3d).
