...
Dalaran provides the [`dl.urdf`](https://github.com/Flaminis/Dalaran/tree/main/dalaran_py/dalaran_sdk/dalaran/urdf.py) Python module that can facilitate the handling of URDF models in your code.
