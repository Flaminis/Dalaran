...
Alternatively, you can check out a more full-featured example with multiple plot windows [here](https://github.com/Flaminis/Dalaran/tree/latest/examples/python/live_scrolling_plot).
