...
order: 200
description: Extend the Dalaran Viewer UI using Rust and egui
---

There are three ways to extend the Dalaran Viewer with custom Rust code, depending on how deep you need to go:
...
> [!WARNING]
> The interfaces for extending the Viewer are not yet stable. Expect code implementing custom extensions to break with every release of Dalaran.
...
<picture>
  ...
  <img src="https://static.rerun.io/custom_view/61089d7178b3bd7f9e3de36ee9c00e5fdf1c6f76/full.png" alt="The Dalaran Viewer, extended with a custom View that is shown three times, each time showing points on a colored plane">
</picture>
