...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    // region: init
    let rec = dalaran::RecordingStreamBuilder::new("dalaran_example_dna_abacus")
        .spawn()?;
    // endregion: init
    ...
    rec.log(
        ...
        &dalaran::LineStrips3D::new(lines.iter().copied())
    ...
    for i in 0..400 {
        ...
        rec.log(
            "dna/structure",
            &dalaran::archetypes::Transform3D::from_rotation(
