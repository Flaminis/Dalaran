...
int main(int argc, char* argv[]) {
    ...
    rec.log_static(
        ...
        dalaran::AnnotationContext({dalaran::ClassDescription{
            0,
            {
                dalaran::AnnotationInfo(0, "zero", dalaran::Rgba32(255, 0, 0)),
                dalaran::AnnotationInfo(1, "one", dalaran::Rgba32(0, 255, 0)),
                dalaran::AnnotationInfo(2, "two", dalaran::Rgba32(0, 0, 255)),
                dalaran::AnnotationInfo(3, "three", dalaran::Rgba32(255, 255, 0)),
            },
            {{0, 2}, {1, 2}, {2, 3}},
        }})
    );
    ...
    rec.log(
        "points",
        dalaran::Points3D({{0.0f, 0.0f, 0.0f},
                         {50.0f, 0.0f, 20.0f},
                         {100.0f, 100.0f, 30.0f},
                         {0.0f, 50.0f, 40.0f}})
