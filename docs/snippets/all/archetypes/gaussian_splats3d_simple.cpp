...
int main(int argc, char* argv[]) {
    const auto rec = dalaran::RecordingStream("dalaran_example_gaussian_splats3d");
    ...
    rec.log(
        ...
        dalaran::GaussianSplats3D(
            ...
            .with_colors({
                dalaran::Rgba32(255, 0, 0, 128),
                dalaran::Rgba32(0, 255, 0, 200),
                dalaran::Rgba32(0, 0, 255, 255),
            })
            .with_sh_coefficients({
                dalaran::datatypes::SphericalHarmonics3Rgb(red_sh),
                dalaran::datatypes::SphericalHarmonics3Rgb(green_sh),
                dalaran::datatypes::SphericalHarmonics3Rgb(blue_sh),
            })
    );
}
