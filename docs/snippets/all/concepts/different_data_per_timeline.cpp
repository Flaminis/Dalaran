...
int main(int argc, char* argv[]) {
    const auto rec =
        dalaran::RecordingStream("dalaran_example_different_data_per_timeline");
    ...
    rec.log(
        "points",
        dalaran::Points2D::update_fields().with_colors(dalaran::Color(0xFF0000FF))
    );
    ...
    rec.log(
        "points",
        dalaran::Points2D::update_fields().with_colors(dalaran::Color(0x0000FFFF))
    );
